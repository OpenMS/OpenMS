...
/**
 ...
 <CENTER>
   <table>
    ...
    <tr>
      <td VALIGN="middle" ALIGN="center" ROWSPAN=1> @ref TOPP_IDScoreSwitcher </td>
    </tr>
   </table>
 </CENTER>
 ...
 If the posterior (error) probabilities are stored in user parameters ("UserParam") in the idXML instead of in the score fields, @ref TOPP_IDScoreSwitcher can be used to rewrite the scores. (This may be the case e.g. if @ref TOPP_FalseDiscoveryRate and @ref TOPP_IDFilter were applied for FDR filtering prior to protein inference.)
