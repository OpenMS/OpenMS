...
namespace OpenMS
{
    ...
    */
    class DDAWorkflowCommons
    {
         ...
         * @return <std::map<std::string, std::string>> A map where keys are mzML file paths and values are corresponding id file paths.
         ...
         *
         * @param[in] m2i <const std::map<std::string, std::string>&> The mzML to id file mapping generated by mapMzML2Ids.
         * @return <std::map<std::string, std::string>> A map where keys are id file paths and values are corresponding mzML file paths.
        */
