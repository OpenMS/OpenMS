  ...
  std::string config_template = R"(
{
  ...
  void registerOptionsAndFlags_() override
  {
    ...
    registerDoubleOption_("precursor_tol_left", "<double>", -6.0, "Start (left side) of the precursor tolerance window w.r.t. precursor location. This value is SUBTRACTED from the experimental precursor mass to define the lower bound of the search window. Usually negative (e.g., -6 ppm means 6 ppm below the observed mass). Using positive values here is likely incorrect.", false, false);
    ...
    registerDoubleOption_("fragment_tol_left", "<double>", -20.0, "Start (left side) of the fragment tolerance window w.r.t. fragment location. This value is SUBTRACTED from the experimental fragment mass to define the lower bound of the search window. Usually negative (e.g., -20 ppm means 20 ppm below the observed mass). Using positive values here is likely incorrect.", false, false);
