...
/**
    @page TOPP_FLASHIdent FLASHIdent
...
<CENTER>
    <table>
        <tr>
            ...
            <td VALIGN="middle" ROWSPAN=2> &rarr; FLASHIdent &rarr;</td>
    ...
    @verbinclude TOPP_FLASHIdent.cli
    <B>INI file documentation of this tool:</B>
    @htmlinclude TOPP_FLASHIdent.html
*/
    ...
    public TOPPBase
{
  public:
    FLASHIdent() :
      TOPPBase("FLASHIdent",
        "Annotates Top-Down MS/MS spectra using FLASHIdent.",
        false)
    {
    }
  ...
  protected:
    void registerOptionsAndFlags_() override
    {
      ...
      search_algo_params_with_subsection.insert("Search:", FLASHIdentAlgorithm().getDefaults());
    ...
    ExitCodes main_(int, const char**) override
    {
      ...
      FLASHIdentAlgorithm::ExitCodes e = sse.search(in, database, protein_ids, peptide_ids);
      if (e != FLASHIdentAlgorithm::ExitCodes::EXECUTION_OK)
      {
