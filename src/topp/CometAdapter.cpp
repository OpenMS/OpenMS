...
protected:
  ...
  ExitCodes createParamFile_(ostream& os, const String& comet_version)
  {
    ...
    if (!parseRange_("precursor_charge", precursor_charge_min, precursor_charge_max))
    {
    ...
    if (!parseRange_("digest_mass_range", digest_mass_range_min, digest_mass_range_max))
    {
    ...
    if (!parseRange_("clear_mz_range", clear_mz_range_min, clear_mz_range_max))
    {
