  ...
  public TOPPBase
{
 public:
  ...
  static const std::string param_executable;
  static const std::string param_spectra_files;
  static const std::string param_library_file;
  static const std::string param_sequence_database_file;
  static const std::string param_sequence_database_type;
  static const std::string param_search_file;
  static const std::string param_params_file;
  static const std::string param_precursor_mz_tolerance;
  static const std::string param_use_isotopically_averaged_mass;
  static const std::string param_use_all_charge_states;
  static const std::string param_output_files;
  static const vector<std::string> param_output_file_formats;
  static const vector<std::string> param_input_file_formats;
...
protected:
  ...
  void registerOptionsAndFlags_() override
  {
      ...
      // Handle executable
      registerInputFile_(TOPPSpectraSTSearchAdapter::param_executable, "<path>", "spectrast", "Path to the SpectraST executable to use; may be empty if the executable is globally available.", true, false, ListUtils::create<std::string>("skipexists"));
      ...
      setValidFormats_(TOPPSpectraSTSearchAdapter::param_spectra_files, ListUtils::create<std::string>(TOPPSpectraSTSearchAdapter::param_input_file_formats), false);
      ...
      setValidFormats_(TOPPSpectraSTSearchAdapter::param_library_file, ListUtils::create<std::string>("splib"), false);
      ...
      setValidFormats_(TOPPSpectraSTSearchAdapter::param_sequence_database_file, ListUtils::create<std::string>("fasta"), false);
      ...
      setValidStrings_(TOPPSpectraSTSearchAdapter::param_sequence_database_type, ListUtils::create<std::string>("DNA,AA"));
      ...
      setValidFormats_(TOPPSpectraSTSearchAdapter::param_search_file, ListUtils::create<std::string>("txt, dat"), false);
      ...
      setValidFormats_(TOPPSpectraSTSearchAdapter::param_params_file, ListUtils::create<std::string>("params"), false);
  ...
  ExitCodes main_(int, const char **) override
  {
     ...
     // Executable
     std::string executable = getStringOption_(TOPPSpectraSTSearchAdapter::param_executable);
     if (executable.empty())
     {
     ...
     arguments.push_back("-sM" + StringUtils::toStr(precursor_mz_tolerance));

     // Set the parameter file if present
     std::string params_file = getStringOption_(TOPPSpectraSTSearchAdapter::param_params_file);
     ...
     std::string library_file = getStringOption_(TOPPSpectraSTSearchAdapter::param_library_file);
     std::string index_file = FileHandler::stripExtension(library_file).append(".spidx");
     ...
     std::string sequence_database_file  = getStringOption_(TOPPSpectraSTSearchAdapter::param_sequence_database_file);
     if (! sequence_database_file.empty())
     {
         std::string sequence_database_type = getStringOption_(TOPPSpectraSTSearchAdapter::param_sequence_database_type);
     ...
     arguments.push_back(threads > 1 ? "-sP" + StringUtils::toStr(threads) : "-sP!");

     // Set the search file
     std::string search_file = getStringOption_(TOPPSpectraSTSearchAdapter::param_search_file);
     ...
     // User mod file
     std::string user_mod_file = getStringOption_(TOPPSpectraSTSearchAdapter::param_user_mod_file);
     ...
     std::string first_output_file = output_files[0];
         ...
         it != TOPPSpectraSTSearchAdapter::param_output_file_formats.end(); ++it)
     {
          ...
          if (StringUtils::hasSuffix(first_output_file, format))
          {
              outputFormat = format;
          }
     }
     ...
     {
         std::string output_file = *it;
         if (! StringUtils::hasSuffix(output_file, outputFormat))
         {
     ...
     std::string first_input_file = spectra_files[0];
     ...
     {
          std::string format = *it;
          if (StringUtils::hasSuffix(first_input_file, format))
          {
              inputFormat = format;
          }
     }
     ...
     for (vector<std::string>::const_iterator it = spectra_files.begin(); it != spectra_files.end(); ++it)
     {
      std::string input_file = *it;
      if (! StringUtils::hasSuffix(input_file, inputFormat))
      {
     ...
     {
        std::string spectra_file = spectra_files[i];
...
const std::string TOPPSpectraSTSearchAdapter::param_executable = "executable";
const std::string TOPPSpectraSTSearchAdapter::param_spectra_files = "spectra_files";
const std::string TOPPSpectraSTSearchAdapter::param_library_file = "library_file";
const std::string TOPPSpectraSTSearchAdapter::param_sequence_database_file = "sequence_database_file";
const std::string TOPPSpectraSTSearchAdapter::param_sequence_database_type = "sequence_database_type";
const std::string TOPPSpectraSTSearchAdapter::param_search_file = "search_file";
const std::string TOPPSpectraSTSearchAdapter::param_params_file = "params_file";
const std::string TOPPSpectraSTSearchAdapter::param_precursor_mz_tolerance = "precursor_mz_tolerance";
const std::string TOPPSpectraSTSearchAdapter::param_use_isotopically_averaged_mass = "use_isotopically_averaged_mass";
const std::string TOPPSpectraSTSearchAdapter::param_use_all_charge_states = "use_all_charge_states";
const std::string TOPPSpectraSTSearchAdapter::param_output_files = "output_files";
const std::string TOPPSpectraSTSearchAdapter::param_user_mod_file = "user_mod_file";
const StringList TOPPSpectraSTSearchAdapter::param_output_file_formats = ListUtils::create<std::string>("txt,tsv,xml,pepXML,html");
const StringList TOPPSpectraSTSearchAdapter::param_input_file_formats = ListUtils::create<std::string>("mzML,mzXML,mzData,mgf,dta,msp");
