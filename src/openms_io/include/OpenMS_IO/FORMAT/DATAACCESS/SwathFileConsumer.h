...
// Consumers
#include <OpenMS_IO/FORMAT/DATAACCESS/MSDataCachedConsumer.h>
#include <OpenMS_IO/FORMAT/DATAACCESS/MSDataWritingConsumer.h>
#include <OpenMS_IO/FORMAT/DATAACCESS/MSDataTransformingConsumer.h>
