"""
Nanobind C++ Code Emitter for pyOpenMS (using libclang info)
...
class NanobindEmitter:
    ...
    def _write_module_file(
        ...
        # Header comment
        lines.append("// Auto-generated by pyOpenMS generator (nanobind, libclang)")
        ...
        lines.append(f'NB_MODULE(_pyopenms_{domain_name}, m) {{')
        lines.append(f'    m.doc() = "pyOpenMS {domain_name} bindings";')
        lines.append("")
    ...
    def _write_single_module(
        ...
        lines.append('NB_MODULE(_pyopenms, m) {')
        lines.append('    m.doc() = "pyOpenMS: Python bindings for OpenMS (nanobind)";')
        lines.append("")
    ...
    def _write_main_module(self, output_path: Path) -> None:
        ...
        empty module - the actual classes are in _pyopenms_<domain> modules.
        """
        lines = []

        lines.append("// Auto-generated by pyOpenMS generator (nanobind, libclang)")
        lines.append("// Main module - placeholder, actual bindings in _pyopenms_<domain> modules")
        lines.append("")
