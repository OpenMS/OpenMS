...
runtime.
    ...
    auto brukertimsfile_config = nb::class_<OpenMS::BrukerTimsFile::Config>(brukertimsfile_class, "Config",
        ...
        .def_rw("frame_id_min", &OpenMS::BrukerTimsFile::Config::frame_id_min, "Frame ID range filter: minimum frame ID inclusive (0 = no lower bound)")
        .def_rw("frame_id_max", &OpenMS::BrukerTimsFile::Config::frame_id_max, "Frame ID range filter: maximum frame ID inclusive (UINT32_MAX = no upper bound)")
        .def_rw("rt_min_sec", &OpenMS::BrukerTimsFile::Config::rt_min_sec, "Retention time range filter: minimum RT in seconds (0 = no lower bound)")
        .def_rw("rt_max_sec", &OpenMS::BrukerTimsFile::Config::rt_max_sec, "Retention time range filter: maximum RT in seconds (+inf = no upper bound)")
        .def_rw("ms1_centroid_algo", &OpenMS::BrukerTimsFile::Config::ms1_centroid_algo, "MS1 centroiding algorithm (OFF / GREEDY2D / HILL_BASED)")
        .def_rw("ms2_centroid_algo", &OpenMS::BrukerTimsFile::Config::ms2_centroid_algo, "MS2 centroiding algorithm for DIA-PASEF and DDA-PASEF (OFF / GREEDY2D / HILL_BASED)")
        .def_rw("ms1_centroid_mz_ppm", &OpenMS::BrukerTimsFile::Config::ms1_centroid_mz_ppm, "MS1 centroiding m/z tolerance in ppm (Greedy2D and HillBased; 0 = disabled)")
        .def_rw("ms1_centroid_im_pct", &OpenMS::BrukerTimsFile::Config::ms1_centroid_im_pct, "Greedy2D-only: MS1 ion-mobility tolerance in percent (0 = disabled, suggested: 3.0)")
        .def_rw("ms1_centroid_max_peaks", &OpenMS::BrukerTimsFile::Config::ms1_centroid_max_peaks, "Greedy2D-only: upper bound on centroided peaks per MS1 spectrum")
        .def_rw("ms2_centroid_mz_ppm", &OpenMS::BrukerTimsFile::Config::ms2_centroid_mz_ppm, "HillBased MS2 m/z tolerance in ppm (0 = disable HillBased MS2, default 20 ppm)")
        .def_rw("centroid_valley_factor", &OpenMS::BrukerTimsFile::Config::centroid_valley_factor, "HillBased hill valley factor: ratio threshold for splitting adjacent hills (smaller = more splits)")
        .def_rw("ms1_centroid_min_hill_length", &OpenMS::BrukerTimsFile::Config::ms1_centroid_min_hill_length, "HillBased MS1: minimum number of IM scans a hill must span (default 1)")
        .def_rw("ms2_centroid_min_hill_length", &OpenMS::BrukerTimsFile::Config::ms2_centroid_min_hill_length, "HillBased MS2: minimum number of IM scans a hill must span (default 2; set to 1 for DDA-PASEF)")
        .def_rw("centroid_max_scan_gap", &OpenMS::BrukerTimsFile::Config::centroid_max_scan_gap, "HillBased: max consecutive empty IM scans a hill may bridge (0 = strict consecutive-scan linking)")
        .def_rw("expose_hill_bounds", &OpenMS::BrukerTimsFile::Config::expose_hill_bounds, "HillBased: attach bounding-box FloatDataArrays per centroided spectrum for QC")
        .def_rw("isotopic_prefilter", &OpenMS::BrukerTimsFile::Config::isotopic_prefilter, "MS1/DIA-MS2 isotopic-partner prefilter: drops peaks without a matching isotopic neighbor")
        .def_rw("isotopic_prefilter_tol_ppm", &OpenMS::BrukerTimsFile::Config::isotopic_prefilter_tol_ppm, "Isotopic-partner ppm tolerance for prefilter (default 50 ppm)")
