...
NB_MODULE(_pyopenms_analysis, m)
{
  ...
  nb::class_<OpenMS::OpenSwath_Scores>(m, "OpenSwath_Scores", "OpenSWATH scoring results struct")
    ...
    .def(
      ...
      [](const OpenMS::OpenSwath_Scores& self, const OpenMS::OpenSwath_Scores& scores) { return self.calculate_lda_prescore(scores); }, "scores"_a,
      "Calculate LDA prescore")
    .def(
      "calculate_swath_lda_prescore",
      [](const OpenMS::OpenSwath_Scores& self, const OpenMS::OpenSwath_Scores& scores) { return self.calculate_swath_lda_prescore(scores); },
      "scores"_a, "Calculate SWATH LDA prescore")
    .def(
      "get_quick_lda_score",
      [](const OpenMS::OpenSwath_Scores& self, double library_corr_, double library_norm_manhattan_, double norm_rt_score_,
         double xcorr_coelution_score_, double xcorr_shape_score_, double log_sn_score_) {
        return self.get_quick_lda_score(library_corr_, library_norm_manhattan_, norm_rt_score_, xcorr_coelution_score_, xcorr_shape_score_,
                                        log_sn_score_);
      },
      "library_corr"_a, "library_norm_manhattan"_a, "norm_rt_score"_a, "xcorr_coelution_score"_a, "xcorr_shape_score"_a, "log_sn_score"_a,
      "Get quick LDA score");
...
the transformation model used for concentration calculation
    ...
    .def(
      "__deepcopy__", [](const OpenMS::AbsoluteQuantitationMethod& self, nb::dict) { return OpenMS::AbsoluteQuantitationMethod(self); }, "memo"_a)
    .def(
      "setComponentName",
      [](OpenMS::AbsoluteQuantitationMethod& self, const OpenMS::String& component_name) { return self.setComponentName(component_name); },
      "component_name"_a, "Sets the component name (unique identifier for the analyte)")
    .def(
      "getComponentName", [](const OpenMS::AbsoluteQuantitationMethod& self) { return self.getComponentName(); },
      "Returns the component name (unique identifier for the analyte)")
    .def(
      "setFeatureName",
      [](OpenMS::AbsoluteQuantitationMethod& self, const OpenMS::String& feature_name) { return self.setFeatureName(feature_name); },
      "feature_name"_a, "Sets the feature name (e.g., peak_apex_int or peak_area)")
    .def(
      "getFeatureName", [](const OpenMS::AbsoluteQuantitationMethod& self) { return self.getFeatureName(); },
      "Returns the feature name (e.g., peak_apex_int or peak_area)")
    .def(
      "setISName", [](OpenMS::AbsoluteQuantitationMethod& self, const OpenMS::String& IS_name) { return self.setISName(IS_name); }, "IS_name"_a,
      "Sets the internal standard name used for ratio calculation")
    .def(
      "getISName", [](const OpenMS::AbsoluteQuantitationMethod& self) { return self.getISName(); },
      "Returns the internal standard name used for ratio calculation")
    .def(
      "setLLOD", [](OpenMS::AbsoluteQuantitationMethod& self, double llod) { return self.setLLOD(llod); }, "llod"_a,
      "Sets the lower limit of detection (LLOD)")
    .def(
      "getLLOD", [](const OpenMS::AbsoluteQuantitationMethod& self) { return self.getLLOD(); }, "Returns the lower limit of detection (LLOD)")
    .def(
      "setULOD", [](OpenMS::AbsoluteQuantitationMethod& self, double ulod) { return self.setULOD(ulod); }, "ulod"_a,
      "Sets the upper limit of detection (ULOD)")
    .def(
      "getULOD", [](const OpenMS::AbsoluteQuantitationMethod& self) { return self.getULOD(); }, "Returns the upper limit of detection (ULOD)")
    .def(
      "checkLOD", [](const OpenMS::AbsoluteQuantitationMethod& self, double value) { return self.checkLOD(value); }, "value"_a,
      "Checks if the given value is within the limits of detection (LOD)")
    .def(
      "setLLOQ", [](OpenMS::AbsoluteQuantitationMethod& self, double lloq) { return self.setLLOQ(lloq); }, "lloq"_a,
      "Sets the lower limit of quantitation (LLOQ)")
    .def(
      "getLLOQ", [](const OpenMS::AbsoluteQuantitationMethod& self) { return self.getLLOQ(); }, "Returns the lower limit of quantitation (LLOQ)")
    .def(
      "setULOQ", [](OpenMS::AbsoluteQuantitationMethod& self, double uloq) { return self.setULOQ(uloq); }, "uloq"_a,
      "Sets the upper limit of quantitation (ULOQ)")
    .def(
      "getULOQ", [](const OpenMS::AbsoluteQuantitationMethod& self) { return self.getULOQ(); }, "Returns the upper limit of quantitation (ULOQ)")
    .def(
      "checkLOQ", [](const OpenMS::AbsoluteQuantitationMethod& self, double value) { return self.checkLOQ(value); }, "value"_a,
      "Checks if the given value is within the limits of quantitation (LOQ)")
    .def(
      "setNPoints", [](OpenMS::AbsoluteQuantitationMethod& self, int n_points) { return self.setNPoints(n_points); }, "n_points"_a,
      "Sets the number of points used in the calibration curve")
    .def(
      "getNPoints", [](const OpenMS::AbsoluteQuantitationMethod& self) { return self.getNPoints(); },
      "Returns the number of points used in the calibration curve")
    .def(
      "setCorrelationCoefficient",
      [](OpenMS::AbsoluteQuantitationMethod& self, double correlation_coefficient) {
        return self.setCorrelationCoefficient(correlation_coefficient);
      },
      "correlation_coefficient"_a, "Sets the Pearson correlation coefficient of the calibration curve fit")
    .def(
      "getCorrelationCoefficient", [](const OpenMS::AbsoluteQuantitationMethod& self) { return self.getCorrelationCoefficient(); },
      "Returns the Pearson correlation coefficient of the calibration curve fit")
    .def(
      "setConcentrationUnits",
      [](OpenMS::AbsoluteQuantitationMethod& self, const OpenMS::String& concentration_units) {
        return self.setConcentrationUnits(concentration_units);
      },
      "concentration_units"_a, "Sets the concentration units for the component")
    .def(
      "getConcentrationUnits", [](const OpenMS::AbsoluteQuantitationMethod& self) { return self.getConcentrationUnits(); },
      "Returns the concentration units for the component")
    .def(
      "setTransformationModel",
      [](OpenMS::AbsoluteQuantitationMethod& self, const OpenMS::String& transformation_model) {
        return self.setTransformationModel(transformation_model);
      },
      "transformation_model"_a, "Sets the transformation model type (e.g., linear, b_spline)")
    .def(
      "getTransformationModel", [](const OpenMS::AbsoluteQuantitationMethod& self) { return self.getTransformationModel(); },
      "Returns the transformation model type (e.g., linear, b_spline)")
    .def(
      "setTransformationModelParams",
      [](OpenMS::AbsoluteQuantitationMethod& self, const OpenMS::Param& transformation_model_params) {
        return self.setTransformationModelParams(transformation_model_params);
      },
      "transformation_model_params"_a, "Sets the transformation model parameters")
    .def(
      "getTransformationModelParams", [](const OpenMS::AbsoluteQuantitationMethod& self) { return self.getTransformationModelParams(); },
      "Returns the transformation model parameters");
  ...
  nb::class_<OpenMS::AccurateMassSearchResult>(m, "AccurateMassSearchResult", "OpenMS class AccurateMassSearchResult")
    ...
    .def(
      "__deepcopy__", [](const OpenMS::AccurateMassSearchResult& self, nb::dict) { return OpenMS::AccurateMassSearchResult(self); }, "memo"_a)
    ...
    .def(
      "setObservedRT", [](OpenMS::AccurateMassSearchResult& self, const double& rt) { return self.setObservedRT(rt); }, "rt"_a)
    ...
    .def(
      "getMatchingHMDBids",
      [](const OpenMS::AccurateMassSearchResult& self) -> const std::vector<OpenMS::String>& { return self.getMatchingHMDBids(); },
      nb::rv_policy::reference_internal)
    .def("setMatchingHMDBids",
         [](OpenMS::AccurateMassSearchResult& self, const std::vector<OpenMS::String>& p0) { return self.setMatchingHMDBids(p0); })
    .def(
      "getMasstraceIntensities",
      [](const OpenMS::AccurateMassSearchResult& self) -> const std::vector<double>& { return self.getMasstraceIntensities(); },
      nb::rv_policy::reference_internal)
    .def("setMasstraceIntensities",
         [](OpenMS::AccurateMassSearchResult& self, const std::vector<double>& p0) { return self.setMasstraceIntensities(p0); })
    ...
    .def(
      ...
      [](OpenMS::AccurateMassSearchResult& self, const std::vector<double>& intensities) { self.setIndividualIntensities(intensities); },
      "intensities"_a, "Sets the individual intensities");
  ...
  nb::class_<OpenMS::TargetedExperimentHelper::CV>(m, "CV", "OpenMS class CV")
    ...
    .def(
      "__deepcopy__", [](const OpenMS::TargetedExperimentHelper::CV& self, nb::dict) { return OpenMS::TargetedExperimentHelper::CV(self); }, "memo"_a)
    .def(nb::self == nb::self)
  ...
  nb::class_<OpenMS::ClusterProxyKD>(m, "ClusterProxyKD", "Proxy for a (potential) cluster")
    ...
    .def(
      "__deepcopy__", [](const OpenMS::ClusterProxyKD& self, nb::dict) { return OpenMS::ClusterProxyKD(self); }, "memo"_a)
    .def(nb::self < nb::self)
    .def(nb::self != nb::self)
    .def(nb::self == nb::self)
...
CVTermList
        ...
        .def(
          "__deepcopy__",
          [](const OpenMS::TargetedExperimentHelper::Compound& self, nb::dict) { return OpenMS::TargetedExperimentHelper::Compound(self); }, "memo"_a)
        .def(nb::self == nb::self)
        .def(
          "setChargeState", [](OpenMS::TargetedExperimentHelper::Compound& self, int charge) { return self.setChargeState(charge); }, "charge"_a,
          "Sets the peptide or compound charge state")
        .def(
          "hasCharge", [](const OpenMS::TargetedExperimentHelper::Compound& self) { return self.hasCharge(); },
          "Whether peptide or compound has set charge state")
        .def(
          "getChargeState", [](const OpenMS::TargetedExperimentHelper::Compound& self) { return self.getChargeState(); },
          "Returns the peptide or compound charge state")
        .def(
          "hasRetentionTime", [](const OpenMS::TargetedExperimentHelper::Compound& self) { return self.hasRetentionTime(); },
          "Check whether compound or peptide has an annotated retention time")
        .def(
          "getRetentionTime", [](const OpenMS::TargetedExperimentHelper::Compound& self) { return self.getRetentionTime(); },
          "Gets compound or peptide retention time")
        .def(
          "getRetentionTimeType", [](const OpenMS::TargetedExperimentHelper::Compound& self) { return self.getRetentionTimeType(); },
          "Get compound or peptide retentiontime type")
        .def(
          "getRetentionTimeUnit", [](const OpenMS::TargetedExperimentHelper::Compound& self) { return self.getRetentionTimeUnit(); },
          "Get compound or peptide retentiontime type")
        .def(nb::self != nb::self)
  ...
  // -----------------------------------------------------------------------
  auto consensusmapnormalizeralgorithmmedian_class
    = nb::class_<OpenMS::ConsensusMapNormalizerAlgorithmMedian>(m, "ConsensusMapNormalizerAlgorithmMedian", "Algorithms of ConsensusMapNormalizer *")
        .def(nb::init<>())
        .def_static(
          "normalizeMaps",
          [](OpenMS::ConsensusMap& map, OpenMS::ConsensusMapNormalizerAlgorithmMedian::NormalizationMethod method, const OpenMS::String& acc_filter,
             const OpenMS::String& desc_filter) {
            return OpenMS::ConsensusMapNormalizerAlgorithmMedian::normalizeMaps(map, method, acc_filter, desc_filter);
          },
          "map"_a, "method"_a, "acc_filter"_a, "desc_filter"_a, "Normalizes the maps of the consensusMap")
        .def_static(
          "computeMedians",
          [](const OpenMS::ConsensusMap& map, const OpenMS::String& acc_filter, const OpenMS::String& desc_filter) {
          ...
          "map"_a, "acc_filter"_a, "desc_filter"_a,
          "Computes medians of all maps and returns tuple of (index of map with most features, medians vector)");
  ...
  nb::enum_<OpenMS::ConsensusMapNormalizerAlgorithmMedian::NormalizationMethod>(consensusmapnormalizeralgorithmmedian_class, "NormalizationMethod",
                                                                                nb::is_arithmetic(),
                                                                                "Normalization method for consensus map alignment (scale or shift)")
  ...
  nb::class_<OpenMS::ConsensusMapNormalizerAlgorithmQuantile>(m, "ConsensusMapNormalizerAlgorithmQuantile", "Algorithms of ConsensusMapNormalizer *")
    .def(nb::init<>())
    .def_static(
      "normalizeMaps", [](OpenMS::ConsensusMap& map) { return OpenMS::ConsensusMapNormalizerAlgorithmQuantile::normalizeMaps(map); }, "map"_a)
    .def_static(
      "resample",
      [](const std::vector<double>& data_in, unsigned int n_resampling_points) {
    ...
    .def_static(
      ...
      [](const OpenMS::ConsensusMap& map) {
        std::vector<std::vector<double>> out_intensities;
        OpenMS::ConsensusMapNormalizerAlgorithmQuantile::extractIntensityVectors(map, out_intensities);
        return out_intensities;
      },
      "map"_a, "Extracts the intensities of the features of the different maps")
    .def_static(
      "setNormalizedIntensityValues",
      [](const std::vector<std::vector<double>>& feature_ints, OpenMS::ConsensusMap& map) {
        return OpenMS::ConsensusMapNormalizerAlgorithmQuantile::setNormalizedIntensityValues(feature_ints, map);
      },
      "feature_ints"_a, "map"_a, "Sets the normalized intensity values to the consensus map");

  // -----------------------------------------------------------------------
  // ConsensusMapNormalizerAlgorithmThreshold
  // -----------------------------------------------------------------------
  nb::class_<OpenMS::ConsensusMapNormalizerAlgorithmThreshold>(m, "ConsensusMapNormalizerAlgorithmThreshold",
                                                               "Algorithms of ConsensusMapNormalizer *")
    .def(nb::init<>())
    .def_static(
      "computeCorrelation",
      [](const OpenMS::ConsensusMap& map, const double& ratio_threshold, const OpenMS::String& acc_filter, const OpenMS::String& desc_filter) {
        return OpenMS::ConsensusMapNormalizerAlgorithmThreshold::computeCorrelation(map, ratio_threshold, acc_filter, desc_filter);
      },
      "map"_a, "ratio_threshold"_a, "acc_filter"_a, "desc_filter"_a, "Determines the ratio of all maps to the map with the most features")
    .def_static(
      "normalizeMaps",
      [](OpenMS::ConsensusMap& map, const std::vector<double>& ratios) {
        return OpenMS::ConsensusMapNormalizerAlgorithmThreshold::normalizeMaps(map, ratios);
      },
      "map"_a, "ratios"_a, "Applies the given ratio to the maps of the consensusMap");
...
Constructors
    ...
    .def(
      "__deepcopy__", [](const OpenMS::DeconvolvedSpectrum& self, nb::dict) { return OpenMS::DeconvolvedSpectrum(self); }, "memo"_a)
    .def(
      "toSpectrum",
      [](OpenMS::DeconvolvedSpectrum& self, int to_charge, double tol, bool retain_undeconvolved) {
        return self.toSpectrum(to_charge, tol, retain_undeconvolved);
      },
      "to_charge"_a, "tol"_a = 10.0, "retain_undeconvolved"_a = false)
    .def(
      "getOriginalSpectrum", [](const OpenMS::DeconvolvedSpectrum& self) -> const OpenMS::MSSpectrum& { return self.getOriginalSpectrum(); },
      nb::rv_policy::reference_internal, "Returns the original spectrum")
    .def(
      "getPrecursorPeakGroup", [](const OpenMS::DeconvolvedSpectrum& self) -> const OpenMS::PeakGroup& { return self.getPrecursorPeakGroup(); },
      nb::rv_policy::reference_internal, "Returns the precursor peak group (MSn, n>1)")
    .def(
      "getPrecursorCharge", [](const OpenMS::DeconvolvedSpectrum& self) { return self.getPrecursorCharge(); }, "Returns the precursor charge")
    .def(
      "getPrecursor", [](const OpenMS::DeconvolvedSpectrum& self) -> const OpenMS::Precursor& { return self.getPrecursor(); },
      nb::rv_policy::reference_internal, "Returns the precursor peak")
    .def(
      "getCurrentMaxMass", [](const OpenMS::DeconvolvedSpectrum& self, double max_mass) { return self.getCurrentMaxMass(max_mass); }, "max_mass"_a,
      "Returns the current max mass")
    .def(
      "getCurrentMinMass", [](const OpenMS::DeconvolvedSpectrum& self, double min_mass) { return self.getCurrentMinMass(min_mass); }, "min_mass"_a,
      "Returns the current min mass")
    .def(
      "getCurrentMaxAbsCharge",
      [](const OpenMS::DeconvolvedSpectrum& self, int max_abs_charge) { return self.getCurrentMaxAbsCharge(max_abs_charge); }, "max_abs_charge"_a,
      "Returns the current max charge")
    .def(
      "getScanNumber", [](const OpenMS::DeconvolvedSpectrum& self) { return self.getScanNumber(); }, "Returns the scan number")
    .def(
      "getPrecursorScanNumber", [](const OpenMS::DeconvolvedSpectrum& self) { return self.getPrecursorScanNumber(); },
      "Returns the precursor scan number")
    .def(
      "getQuantities", [](const OpenMS::DeconvolvedSpectrum& self) { return self.getQuantities(); }, "Returns isobaric quantities")
    .def(
      "setQuantities",
      [](OpenMS::DeconvolvedSpectrum& self, const OpenMS::FLASHHelperClasses::IsobaricQuantities& quantities) {
        return self.setQuantities(quantities);
      },
      "quantities"_a, "Sets isobaric quantities")
    .def(
      "setPrecursor", [](OpenMS::DeconvolvedSpectrum& self, const OpenMS::Precursor& precursor) { return self.setPrecursor(precursor); },
      "precursor"_a, "Sets the precursor")
    .def(
      "setPrecursorScanNumber", [](OpenMS::DeconvolvedSpectrum& self, int scan_number) { return self.setPrecursorScanNumber(scan_number); },
      "scan_number"_a, "Sets the precursor scan number")
    .def(
      "setPrecursorPeakGroup", [](OpenMS::DeconvolvedSpectrum& self, const OpenMS::PeakGroup& pg) { return self.setPrecursorPeakGroup(pg); }, "pg"_a,
      "Sets the precursor peak group")
    .def(
      "setOriginalSpectrum", [](OpenMS::DeconvolvedSpectrum& self, const OpenMS::MSSpectrum& spec) { return self.setOriginalSpectrum(spec); },
      "spec"_a, "Sets the original spectrum")
    .def(
      "setPeakGroups", [](OpenMS::DeconvolvedSpectrum& self, std::vector<OpenMS::PeakGroup>& x) { return self.setPeakGroups(x); }, "x"_a,
      "Sets peak groups")
    ...
    .def(
      "push_back", [](OpenMS::DeconvolvedSpectrum& self, const OpenMS::PeakGroup& pg) { return self.push_back(pg); }, "pg"_a, "Adds a peak group")
    .def(
      "pop_back", [](OpenMS::DeconvolvedSpectrum& self) { return self.pop_back(); }, "Removes the last peak group")
    .def(
      "size", [](const OpenMS::DeconvolvedSpectrum& self) { return self.size(); }, "Returns number of peak groups")
    .def(
      "clear", [](OpenMS::DeconvolvedSpectrum& self) { return self.clear(); }, "Clears all peak groups")
    .def(
      "reserve", [](OpenMS::DeconvolvedSpectrum& self, size_t n) { return self.reserve(n); }, "n"_a, "Reserves space for n peak groups")
    .def(
      "empty", [](const OpenMS::DeconvolvedSpectrum& self) { return self.empty(); }, "Returns true if no peak groups")
    .def(
      "isDecoy", [](const OpenMS::DeconvolvedSpectrum& self) { return self.isDecoy(); }, "Returns true if this is a decoy spectrum")
    .def(
      "sort", [](OpenMS::DeconvolvedSpectrum& self) { return self.sort(); }, "Sorts peak groups by monoisotopic mass")
    .def(
      "sortByQscore", [](OpenMS::DeconvolvedSpectrum& self) { return self.sortByQscore(); }, "Sorts peak groups by Qscore")
    .def(nb::self < nb::self)
    .def(nb::self > nb::self)
    .def(nb::self == nb::self)
    .def("__iter__",
         [](OpenMS::DeconvolvedSpectrum& self) {
           return nb::make_iterator<nb::rv_policy::reference_internal>(nb::type<OpenMS::DeconvolvedSpectrum>(), "DeconvolvedSpectrum_iter",
                                                                       self.begin(), self.end());
         })
    .def("__len__", [](OpenMS::DeconvolvedSpectrum& self) { return self.size(); })
    .def(
      "__getitem__",
      [](OpenMS::DeconvolvedSpectrum& self, size_t i) -> OpenMS::PeakGroup& {
    ...
    .def(
      "__setitem__",
      [](OpenMS::DeconvolvedSpectrum& self, size_t i, const OpenMS::PeakGroup& val) {
        if (i >= self.size()) throw nb::index_error();
        self[i] = val;
      },
      "i"_a, "val"_a);
  ...
  nb::class_<OpenMS::ChromatogramExtractorAlgorithm::ExtractionCoordinates>(m, "ExtractionCoordinates",
    ...
    .def("__copy__",
         [](const OpenMS::ChromatogramExtractorAlgorithm::ExtractionCoordinates& self) {
           return OpenMS::ChromatogramExtractorAlgorithm::ExtractionCoordinates(self);
         })
    .def(
      "__deepcopy__",
      [](const OpenMS::ChromatogramExtractorAlgorithm::ExtractionCoordinates& self, nb::dict) {
        return OpenMS::ChromatogramExtractorAlgorithm::ExtractionCoordinates(self);
      },
      "memo"_a)
  ...
  nb::class_<OpenMS::FIAMSScheduler>(m, "FIAMSScheduler", "Scheduler for FIA-MS data processing")
    ...
    .def(
      "__deepcopy__", [](const OpenMS::FIAMSScheduler& self, nb::dict) { return OpenMS::FIAMSScheduler(self); }, "memo"_a)
    .def(
      "run", [](OpenMS::FIAMSScheduler& self) { return self.run(); }, "Run the FIA-MS data analysis for the batch defined in the @filename_")
    .def(
      "getBaseDir", [](OpenMS::FIAMSScheduler& self) { return self.getBaseDir(); },
...
:param keep_matching: Keeps all IDs that match the modified sequence of the best hit in the feature (e.g. keeps all IDs in a ConsensusMap if id'd same across multiple runs)
    ...
    .def_static(
      "resolveBetweenFeatures", [](OpenMS::ConsensusMap& features) { return OpenMS::IDConflictResolverAlgorithm::resolveBetweenFeatures(features); },
      "features"_a,
      R"doc(
Resolves ambiguous annotations of consensus features with peptide identifications\n
The the filtered identifications are added to the vector of unassigned peptides
...
:param keep_matching: Keeps all IDs that match the modified sequence of the best hit in the feature (e.g. keeps all IDs in a ConsensusMap if id'd same across multiple runs)
  ...
  // -----------------------------------------------------------------------
  nb::class_<OpenMS::IDMapper::PeptideIdentificationListState>(m, "IDMapper_PeptideIdentificationListState",
  ...
  // -----------------------------------------------------------------------
  nb::class_<OpenMS::IonIdentityMolecularNetworking>(
    m, "IonIdentityMolecularNetworking",
    ...
    .def_static(
      ...
      [](OpenMS::ConsensusMap& consensus_map) { return OpenMS::IonIdentityMolecularNetworking::annotateConsensusMap(consensus_map); },
      "consensus_map"_a)
    .def_static(
      "writeSupplementaryPairTable",
      [](const OpenMS::ConsensusMap& consensus_map, const OpenMS::String& output_file) {
        return OpenMS::IonIdentityMolecularNetworking::writeSupplementaryPairTable(consensus_map, output_file);
      },
      "consensus_map"_a, "output_file"_a,
      R"doc(
...
isobaric labeling experiments
    ...
    .def(
      "__deepcopy__", [](const OpenMS::IsobaricIsotopeCorrector& self, nb::dict) { return OpenMS::IsobaricIsotopeCorrector(self); }, "memo"_a)
    .def_static(
      "correctIsotopicImpurities",
      [](const OpenMS::ConsensusMap& consensus_map_in, const OpenMS::IsobaricQuantitationMethod* quant_method) {
...
NNLS (non-negative least squares) and naive matrix inversion methods
    ...
    .def(
      "__deepcopy__", [](const OpenMS::IsobaricQuantifierStatistics& self, nb::dict) { return OpenMS::IsobaricQuantifierStatistics(self); }, "memo"_a)
    .def(
      "reset", [](OpenMS::IsobaricQuantifierStatistics& self) { return self.reset(); }, "Resets all statistics counters to zero")
...
Constructors
    ...
    .def(
      "__deepcopy__",
      [](const OpenMS::FLASHHelperClasses::IsobaricQuantities& self, nb::dict) { return OpenMS::FLASHHelperClasses::IsobaricQuantities(self); },
      "memo"_a)
    .def(
      "empty", [](const OpenMS::FLASHHelperClasses::IsobaricQuantities& self) { return self.empty(); }, "Returns true if no quantities stored")
  ...
  // ItraqConstants
  // -----------------------------------------------------------------------
  auto itraqconstants_class
    = nb::class_<OpenMS::ItraqConstants>(m, "ItraqConstants",
                                         R"doc(
...
Constants for iTRAQ experiments and a ChannelInfo structure to store information about a single channel
        ...
        .def(
          "__deepcopy__", [](const OpenMS::ItraqConstants& self, nb::dict) { return OpenMS::ItraqConstants(self); }, "memo"_a)
        .def_static(
          "getIsotopeMatrixAsStringList",
          [](int itraq_type, const std::vector<OpenMS::Matrix<double>>& isotope_corrections) {
            return OpenMS::ItraqConstants::getIsotopeMatrixAsStringList(itraq_type, isotope_corrections);
          },
          "itraq_type"_a, "isotope_corrections"_a)
        .def_static(
          "updateIsotopeMatrixFromStringList",
          [](int itraq_type, const std::vector<OpenMS::String>& channels, std::vector<OpenMS::Matrix<double>> isotope_corrections) {
...
:returns: Updated isotope_corrections
        ...
        .def_static(
          ...
          [](const int& itraq_type, const std::vector<OpenMS::Matrix<double>>& isotope_corrections) {
            return OpenMS::ItraqConstants::translateIsotopeMatrix(itraq_type, isotope_corrections);
          },
          "itraq_type"_a, "isotope_corrections"_a,
          R"doc(
...
:param isotope_corrections: Vector of the two matrices (4plex, 8plex)
  ...
  auto itraq_types_enum
    = nb::enum_<OpenMS::ItraqConstants::ITRAQ_TYPES>(itraqconstants_class, "ITRAQ_TYPES", "Enum for iTRAQ/TMT channel types", nb::is_arithmetic())
  ...
  // -----------------------------------------------------------------------
  nb::class_<OpenMS::ItraqConstants::ChannelInfo>(m, "ChannelInfo", "Information about an iTRAQ/TMT channel")
    .def(nb::init<>())
...
A node of the kD-tree with pointer to corresponding data and index
    ...
    .def(
      "__deepcopy__", [](const OpenMS::KDTreeFeatureNode& self, nb::dict) { return OpenMS::KDTreeFeatureNode(self); }, "memo"_a)
  ...
  nb::class_<OpenSwath::LightCompound>(m, "LightCompound", "OpenMS class LightCompound")
    ...
    .def(
      "__deepcopy__", [](const OpenSwath::LightCompound& self, nb::dict) { return OpenSwath::LightCompound(self); }, "memo"_a)
    .def(
      "setDriftTime", [](OpenSwath::LightCompound& self, double d) { return self.setDriftTime(d); }, "d"_a)
    ...
    .def(
      "setChargeState", [](OpenSwath::LightCompound& self, int ch) { return self.setChargeState(ch); }, "ch"_a)
  ...
  nb::class_<OpenSwath::LightModification>(m, "LightModification", "OpenMS class LightModification")
    ...
    .def(
      "__deepcopy__", [](const OpenSwath::LightModification& self, nb::dict) { return OpenSwath::LightModification(self); }, "memo"_a)
  ...
  nb::class_<OpenSwath::LightProtein>(m, "LightProtein", "OpenMS class LightProtein")
    ...
    .def(
      "__deepcopy__", [](const OpenSwath::LightProtein& self, nb::dict) { return OpenSwath::LightProtein(self); }, "memo"_a)
  ...
  nb::class_<OpenSwath::LightTargetedExperiment>(m, "LightTargetedExperiment", "OpenMS class LightTargetedExperiment")
    ...
    .def(
      "__deepcopy__", [](const OpenSwath::LightTargetedExperiment& self, nb::dict) { return OpenSwath::LightTargetedExperiment(self); }, "memo"_a)
    ...
    .def(
      "getCompoundByRef", [](OpenSwath::LightTargetedExperiment& self, const std::string& ref) { return self.getCompoundByRef(ref); }, "ref"_a)
  ...
  nb::class_<OpenSwath::LightTransition>(m, "LightTransition", "OpenMS class LightTransition")
    ...
    .def(
      "__deepcopy__", [](const OpenSwath::LightTransition& self, nb::dict) { return OpenSwath::LightTransition(self); }, "memo"_a)
    ...
    .def(
      "setLibraryIntensity", [](OpenSwath::LightTransition& self, double l) { return self.setLibraryIntensity(l); }, "l"_a)
    ...
    .def(
      "setDecoy", [](OpenSwath::LightTransition& self, bool d) { return self.setDecoy(d); }, "d"_a)
    .def("getFragmentType", [](const OpenSwath::LightTransition& self) { return self.getFragmentType(); })
    .def(
      "setFragmentType", [](OpenSwath::LightTransition& self, std::string s) { return self.setFragmentType(s); }, "s"_a)
    .def("getAnnotation", [](const OpenSwath::LightTransition& self) { return self.getAnnotation(); })
    .def(
      "setDetectingTransition", [](OpenSwath::LightTransition& self, bool d) { return self.setDetectingTransition(d); }, "d"_a)
    .def("isDetectingTransition", [](const OpenSwath::LightTransition& self) { return self.isDetectingTransition(); })
    .def(
      "setQuantifyingTransition", [](OpenSwath::LightTransition& self, bool q) { return self.setQuantifyingTransition(q); }, "q"_a)
    .def("isQuantifyingTransition", [](const OpenSwath::LightTransition& self) { return self.isQuantifyingTransition(); })
    .def(
      "setIdentifyingTransition", [](OpenSwath::LightTransition& self, bool i) { return self.setIdentifyingTransition(i); }, "i"_a)
    ...
    .def_prop_rw(
      "decoy", [](const OpenSwath::LightTransition& t) { return t.getDecoy(); }, [](OpenSwath::LightTransition& t, bool v) { t.setDecoy(v); })
    .def_prop_rw(
      "detecting_transition", [](const OpenSwath::LightTransition& t) { return t.isDetectingTransition(); },
      [](OpenSwath::LightTransition& t, bool v) { t.setDetectingTransition(v); })
    .def_prop_rw(
      "identifying_transition", [](const OpenSwath::LightTransition& t) { return t.isIdentifyingTransition(); },
      [](OpenSwath::LightTransition& t, bool v) { t.setIdentifyingTransition(v); })
    .def_prop_rw(
      "quantifying_transition", [](const OpenSwath::LightTransition& t) { return t.isQuantifyingTransition(); },
...
Constructors
    ...
    .def(
      "__deepcopy__", [](const OpenMS::FLASHHelperClasses::LogMzPeak& self, nb::dict) { return OpenMS::FLASHHelperClasses::LogMzPeak(self); },
      "memo"_a)
    .def(
      "getUnchargedMass", [](const OpenMS::FLASHHelperClasses::LogMzPeak& self) { return self.getUnchargedMass(); },
    ...
    .def(
      "__init__",
      [](OpenMS::FLASHHelperClasses::LogMzPeak* self, const OpenMS::Peak1D& peak, bool positive) {
  ...
  nb::class_<OpenMS::MRMFeatureQC::ComponentGroupPairQCs>(m, "MRMFQC_ComponentGroupPairQCs", "OpenMS class MRMFQC_ComponentGroupPairQCs")
    ...
    .def(
      "__deepcopy__",
      [](const OpenMS::MRMFeatureQC::ComponentGroupPairQCs& self, nb::dict) { return OpenMS::MRMFeatureQC::ComponentGroupPairQCs(self); }, "memo"_a)
  ...
  nb::class_<OpenMS::MRMFeatureQC::ComponentGroupQCs>(m, "MRMFQC_ComponentGroupQCs", "OpenMS class MRMFQC_ComponentGroupQCs")
    ...
    .def(
      "__deepcopy__", [](const OpenMS::MRMFeatureQC::ComponentGroupQCs& self, nb::dict) { return OpenMS::MRMFeatureQC::ComponentGroupQCs(self); },
      "memo"_a)
  ...
  nb::class_<OpenMS::MRMFeatureQC::ComponentQCs>(m, "MRMFQC_ComponentQCs", "OpenMS class MRMFQC_ComponentQCs")
    ...
    .def(
      "__deepcopy__", [](const OpenMS::MRMFeatureQC::ComponentQCs& self, nb::dict) { return OpenMS::MRMFeatureQC::ComponentQCs(self); }, "memo"_a)
...
components and components groups
  ...
  // -----------------------------------------------------------------------
  nb::class_<OpenMS::MRMFeaturePicker::ComponentParams>(m, "MRMFP_ComponentParams", "Parameters for a single MRM component")
    .def(nb::init<>())
    .def("__copy__", [](const OpenMS::MRMFeaturePicker::ComponentParams& self) { return OpenMS::MRMFeaturePicker::ComponentParams(self); })
    .def(
      "__deepcopy__", [](const OpenMS::MRMFeaturePicker::ComponentParams& self, nb::dict) { return OpenMS::MRMFeaturePicker::ComponentParams(self); },
      "memo"_a)
  ...
  nb::class_<OpenMS::MRMFeaturePicker::ComponentGroupParams>(m, "MRMFP_ComponentGroupParams",
    ...
    .def(
      "__deepcopy__",
      [](const OpenMS::MRMFeaturePicker::ComponentGroupParams& self, nb::dict) { return OpenMS::MRMFeaturePicker::ComponentGroupParams(self); },
      "memo"_a)
...
MRMFeatureFilter
    ...
    .def(
      "__deepcopy__", [](const OpenMS::MRMFeatureQC& self, nb::dict) { return OpenMS::MRMFeatureQC(self); }, "memo"_a)

    .def_prop_rw(
      "component_qcs", [](OpenMS::MRMFeatureQC& self) -> std::vector<OpenMS::MRMFeatureQC::ComponentQCs>& { return self.component_qcs; },
...
selector.selectMRMFeature(features, selected, params)
    ...
    .def(
      "__deepcopy__", [](const OpenMS::MRMFeatureSelectorQMIP& self, nb::dict) { return OpenMS::MRMFeatureSelectorQMIP(self); }, "memo"_a)
    .def(
      "selectMRMFeature",
      [](const OpenMS::MRMFeatureSelectorQMIP& self, const OpenMS::FeatureMap& features, OpenMS::FeatureMap& selected_filtered,
         const OpenMS::MRMFeatureSelector::SelectorParameters& parameters) { return self.selectMRMFeature(features, selected_filtered, parameters); },
      "features"_a, "selected_filtered"_a, "parameters"_a);
...
selector.selectMRMFeature(features, selected, params)
    ...
    .def(
      "__deepcopy__", [](const OpenMS::MRMFeatureSelectorScore& self, nb::dict) { return OpenMS::MRMFeatureSelectorScore(self); }, "memo"_a)
    .def(
      "selectMRMFeature",
      [](const OpenMS::MRMFeatureSelectorScore& self, const OpenMS::FeatureMap& features, OpenMS::FeatureMap& selected_filtered,
         const OpenMS::MRMFeatureSelector::SelectorParameters& parameters) { return self.selectMRMFeature(features, selected_filtered, parameters); },
      "features"_a, "selected_filtered"_a, "parameters"_a);
...
MRMDecoy
    ...
    .def(
      "__deepcopy__", [](const OpenMS::MRMIonSeries& self, nb::dict) { return OpenMS::MRMIonSeries(self); }, "memo"_a)
    .def(
      "annotateTransitionCV",
      [](OpenMS::MRMIonSeries& self, OpenMS::ReactionMonitoringTransition& tr, const OpenMS::String& annotation) {
        return self.annotateTransitionCV(tr, annotation);
      },
      "tr"_a, "annotation"_a)
    .def(
      "annotateTransition",
      [](OpenMS::MRMIonSeries& self, OpenMS::ReactionMonitoringTransition& tr, const OpenMS::TargetedExperiment::Peptide& peptide,
         double precursor_mz_threshold, double product_mz_threshold, bool enable_reannotation, const std::vector<OpenMS::String>& fragment_types,
         const std::vector<size_t>& fragment_charges, bool enable_specific_losses, bool enable_unspecific_losses, int round_decPow) {
        self.annotateTransition(tr, peptide, precursor_mz_threshold, product_mz_threshold, enable_reannotation, fragment_types, fragment_charges,
                                enable_specific_losses, enable_unspecific_losses, round_decPow);
      },
      "tr"_a, "peptide"_a, "precursor_mz_threshold"_a, "product_mz_threshold"_a, "enable_reannotation"_a, "fragment_types"_a, "fragment_charges"_a,
      "enable_specific_losses"_a, "enable_unspecific_losses"_a, "round_decPow"_a = -4, "Annotates a transition with the corresponding fragment ion");
  ...
  nb::class_<OpenMS::MRMRTNormalizer>(m, "MRMRTNormalizer", "The MRMRTNormalizer will find retention time peptides in data")
    ...
    .def(
      "__deepcopy__", [](const OpenMS::MRMRTNormalizer& self, nb::dict) { return OpenMS::MRMRTNormalizer(self); }, "memo"_a)
    .def_static(
      "removeOutliersRANSAC",
      [](const std::vector<std::pair<double, double>>& pairs, double rsq_limit, double coverage_limit, size_t max_iterations, double max_rt_threshold,
         size_t sampling_size) {
        return OpenMS::MRMRTNormalizer::removeOutliersRANSAC(pairs, rsq_limit, coverage_limit, max_iterations, max_rt_threshold, sampling_size);
      },
      "pairs"_a, "rsq_limit"_a, "coverage_limit"_a, "max_iterations"_a, "max_rt_threshold"_a, "sampling_size"_a)
    .def_static(
      ...
      [](const std::vector<std::pair<double, double>>& pairs, double rsq_limit, double coverage_limit, bool use_chauvenet,
        ...
        return OpenMS::MRMRTNormalizer::removeOutliersIterative(pairs, rsq_limit, coverage_limit, use_chauvenet, method);
      },
      "pairs"_a, "rsq_limit"_a, "coverage_limit"_a, "use_chauvenet"_a, "method"_a)
    .def_static(
      "chauvenet_probability",
      [](const std::vector<double>& residuals, int pos) { return OpenMS::MRMRTNormalizer::chauvenet_probability(residuals, pos); }, "residuals"_a,
      "pos"_a)
    .def_static(
      "chauvenet", [](const std::vector<double>& residuals, int pos) { return OpenMS::MRMRTNormalizer::chauvenet(residuals, pos); }, "residuals"_a,
      "pos"_a)
    .def_static(
      "computeBinnedCoverage",
      [](const std::pair<double, double>& rtRange, const std::vector<std::pair<double, double>>& pairs, int nrBins, int minPeptidesPerBin,
         int minBinsFilled) { return OpenMS::MRMRTNormalizer::computeBinnedCoverage(rtRange, pairs, nrBins, minPeptidesPerBin, minBinsFilled); },
      "rtRange"_a, "pairs"_a, "nrBins"_a, "minPeptidesPerBin"_a, "minBinsFilled"_a);
  ...
  nb::class_<OpenSwath::MRMScoring>(m, "MRMScoring", "This class implements different scores for peaks found in SRM/MRM")
    ...
    .def(
      "__deepcopy__", [](const OpenSwath::MRMScoring& self, nb::dict) { return OpenSwath::MRMScoring(self); }, "memo"_a)
    .def(
      "calcXcorrCoelutionScore", [](OpenSwath::MRMScoring& self) { return self.calcXcorrCoelutionScore(); },
    ...
    .def(
      ...
      [](OpenSwath::MRMScoring& self, const std::vector<double>& normalized_library_intensity) {
        return self.calcXcorrCoelutionWeightedScore(normalized_library_intensity);
      },
      "normalized_library_intensity"_a)
    .def(
      "calcSeparateXcorrContrastCoelutionScore", [](OpenSwath::MRMScoring& self) { return self.calcSeparateXcorrContrastCoelutionScore(); },
    ...
    .def(
      "calcXcorrShapeScore", [](OpenSwath::MRMScoring& self) { return self.calcXcorrShapeScore(); },
      R"doc(
...
The score is a distance where zero indicates perfect coelution
    ...
    .def(
      ...
      [](OpenSwath::MRMScoring& self, const std::vector<double>& normalized_library_intensity) {
        return self.calcXcorrShapeWeightedScore(normalized_library_intensity);
      },
      "normalized_library_intensity"_a,
      R"doc(
...
and 0 means no correlation.
    ...
    .def(
      "calcSeparateXcorrContrastShapeScore", [](OpenSwath::MRMScoring& self) { return self.calcSeparateXcorrContrastShapeScore(); },
      "Calculate the separate cross-correlation contrast shape score")
    .def(
      "calcXcorrPrecursorContrastShapeScore", [](OpenSwath::MRMScoring& self) { return self.calcXcorrPrecursorContrastShapeScore(); },
      "Calculate the precursor cross-correlation shape score against the transitions")
    .def_static(
      "calcRTScore",
      [](const OpenSwath::LightCompound& peptide, double normalized_experimental_rt) {
        return OpenSwath::MRMScoring::calcRTScore(peptide, normalized_experimental_rt);
      },
      "peptide"_a, "normalized_experimental_rt"_a)
    .def("calcMIScore", [](OpenSwath::MRMScoring& self) { return self.calcMIScore(); })
    .def(
      "calcMIWeightedScore",
      [](OpenSwath::MRMScoring& self, const std::vector<double>& normalized_library_intensity) {
        return self.calcMIWeightedScore(normalized_library_intensity);
      },
      "normalized_library_intensity"_a)
    ...
    .def(
      "getMIMatrix", [](const OpenSwath::MRMScoring& self) -> const OpenMS::Matrix<double>& { return self.getMIMatrix(); },
      nb::rv_policy::reference_internal, "Returns the MI matrix");
...
private
    ...
    .def(
      "__deepcopy__", [](const OpenMS::MapAlignmentAlgorithmKD& self, nb::dict) { return OpenMS::MapAlignmentAlgorithmKD(self); }, "memo"_a)
    .def(
      "addRTFitData", [](OpenMS::MapAlignmentAlgorithmKD& self, const OpenMS::KDTreeFeatureMaps& kd_data) { return self.addRTFitData(kd_data); },
      "kd_data"_a, "Compute data points needed for RT transformation in the current `kd_data`, add to `fit_data_`")
    .def(
      "fitLOWESS", [](OpenMS::MapAlignmentAlgorithmKD& self) { return self.fitLOWESS(); },
      "Fit LOWESS to fit_data_, store final models in `transformations_`")
    .def(
      "transform", [](const OpenMS::MapAlignmentAlgorithmKD& self, OpenMS::KDTreeFeatureMaps& kd_data) { return self.transform(kd_data); },
      "kd_data"_a, "Transform RTs for `kd_data`");
...
Constructors
    ...
    .def(
      "__deepcopy__", [](const OpenMS::FLASHHelperClasses::MassFeature& self, nb::dict) { return OpenMS::FLASHHelperClasses::MassFeature(self); },
      "memo"_a)
    .def(nb::self < nb::self)
    .def(nb::self > nb::self)
    .def(nb::self == nb::self)
...
metabolomics
    ...
    .def(
      "__deepcopy__", [](const OpenMS::MetaboTargetedAssay& self, nb::dict) { return OpenMS::MetaboTargetedAssay(self); }, "memo"_a)
    ...
    .def_static(
      ...
      [](const OpenMS::MSExperiment& spectra, const OpenMS::FeatureMapping::FeatureToMs2Indices& feature_ms2_index, const double& precursor_rt_tol,
         const double& precursor_mz_distance, const double& cosine_sim_threshold, const double& transition_threshold, const double& min_fragment_mz,
         const double& max_fragment_mz, const bool& method_consensus_spectrum, const bool& exclude_ms2_precursor, const unsigned int& file_counter) {
        return OpenMS::MetaboTargetedAssay::extractMetaboTargetedAssay(spectra, feature_ms2_index, precursor_rt_tol, precursor_mz_distance,
                                                                       cosine_sim_threshold, transition_threshold, min_fragment_mz, max_fragment_mz,
                                                                       method_consensus_spectrum, exclude_ms2_precursor, file_counter);
      },
      "spectra"_a, "feature_ms2_index"_a, "precursor_rt_tol"_a, "precursor_mz_distance"_a, "cosine_sim_threshold"_a, "transition_threshold"_a,
      "min_fragment_mz"_a, "max_fragment_mz"_a, "method_consensus_spectrum"_a, "exclude_ms2_precursor"_a, "file_counter"_a,
      "Extract a vector of MetaboTargetedAssays without using fragment annotation")
    .def_static(
      "extractMetaboTargetedAssayFragmentAnnotation",
      [](const std::vector<OpenMS::MetaboTargetedAssay::CompoundTargetDecoyPair>& v_cmp_spec, const double& transition_threshold,
         const double& min_fragment_mz, const double& max_fragment_mz, const bool& use_exact_mass, const bool& exclude_ms2_precursor) {
        return OpenMS::MetaboTargetedAssay::extractMetaboTargetedAssayFragmentAnnotation(v_cmp_spec, transition_threshold, min_fragment_mz,
                                                                                         max_fragment_mz, use_exact_mass, exclude_ms2_precursor);
      },
      "v_cmp_spec"_a, "transition_threshold"_a, "min_fragment_mz"_a, "max_fragment_mz"_a, "use_exact_mass"_a, "exclude_ms2_precursor"_a,
      "Extract a vector of MetaboTargetedAssays using fragment annotation")
    .def_static(
      "pairCompoundWithAnnotatedTDSpectraPairs",
      [](const std::vector<OpenMS::SiriusMSFile::CompoundInfo>& v_cmpinfo,
         const std::vector<OpenMS::SiriusFragmentAnnotation::SiriusTargetDecoySpectra>& annotated_spectra) {
        return OpenMS::MetaboTargetedAssay::pairCompoundWithAnnotatedTDSpectraPairs(v_cmpinfo, annotated_spectra);
      },
      "v_cmpinfo"_a, "annotated_spectra"_a, "Pair compound information with annotated target and decoy spectra");

  // -----------------------------------------------------------------------
  // MetaboTargetedAssay_CompoundTargetDecoyPair
  // -----------------------------------------------------------------------
  nb::class_<OpenMS::MetaboTargetedAssay::CompoundTargetDecoyPair>(m, "MetaboTargetedAssay_CompoundTargetDecoyPair",
                                                                   "Compound target-decoy pair for metabolite targeted assays")
    .def(nb::init<>())
    .def(nb::init<OpenMS::SiriusMSFile::CompoundInfo, OpenMS::SiriusFragmentAnnotation::SiriusTargetDecoySpectra>())
    .def("__copy__",
         [](const OpenMS::MetaboTargetedAssay::CompoundTargetDecoyPair& self) { return OpenMS::MetaboTargetedAssay::CompoundTargetDecoyPair(self); })
    .def(
      "__deepcopy__",
      [](const OpenMS::MetaboTargetedAssay::CompoundTargetDecoyPair& self, nb::dict) {
        return OpenMS::MetaboTargetedAssay::CompoundTargetDecoyPair(self);
      },
      "memo"_a)
...
specific decoy generation in targeted/pseudo targeted metabolomics
    ...
    .def(
      "__deepcopy__", [](const OpenMS::MetaboTargetedTargetDecoy& self, nb::dict) { return OpenMS::MetaboTargetedTargetDecoy(self); }, "memo"_a)
    .def_static(
      "constructTargetDecoyMassMapping",
      [](const OpenMS::TargetedExperiment& t_exp) { return OpenMS::MetaboTargetedTargetDecoy::constructTargetDecoyMassMapping(t_exp); }, "t_exp"_a)
    .def_static(
      "resolveOverlappingTargetDecoyMassesByDecoyMassShift",
      [](OpenMS::TargetedExperiment& t_exp, std::vector<OpenMS::MetaboTargetedTargetDecoy::MetaboTargetDecoyMassMapping> mappings,
         const double& mass_to_add, const double& mz_tol, const OpenMS::String& mz_tol_unit) {
...
:returns: Updated mappings
  ...
  // -----------------------------------------------------------------------
  nb::class_<OpenMS::MetaboTargetedTargetDecoy::MetaboTargetDecoyMassMapping>(
    m, "MetaboTargetedTargetDecoy_MetaboTargetDecoyMassMapping", ":param mass_to_add: The maximum number of transitions required per assay")
    .def(nb::init<>())
    .def(nb::init<const OpenMS::MetaboTargetedTargetDecoy::MetaboTargetDecoyMassMapping&>())
    .def("__copy__",
         [](const OpenMS::MetaboTargetedTargetDecoy::MetaboTargetDecoyMassMapping& self) {
           return OpenMS::MetaboTargetedTargetDecoy::MetaboTargetDecoyMassMapping(self);
         })
    .def(
      "__deepcopy__",
      [](const OpenMS::MetaboTargetedTargetDecoy::MetaboTargetDecoyMassMapping& self, nb::dict) {
        return OpenMS::MetaboTargetedTargetDecoy::MetaboTargetDecoyMassMapping(self);
      },
      "memo"_a)
  ...
  nb::class_<OpenMS::MorpheusScore>(m, "MorpheusScore", "OpenMS class MorpheusScore")
    ...
    .def(
      "__deepcopy__", [](const OpenMS::MorpheusScore& self, nb::dict) { return OpenMS::MorpheusScore(self); }, "memo"_a)
    .def_static(
      "compute",
      [](double fragment_mass_tolerance, bool fragment_mass_tolerance_unit_ppm, const OpenMS::MSSpectrum& exp_spectrum,
         const OpenMS::MSSpectrum& theo_spectrum) {
        return OpenMS::MorpheusScore::compute(fragment_mass_tolerance, fragment_mass_tolerance_unit_ppm, exp_spectrum, theo_spectrum);
      },
      "fragment_mass_tolerance"_a, "fragment_mass_tolerance_unit_ppm"_a, "exp_spectrum"_a, "theo_spectrum"_a, "Returns Morpheus Score")
    .def_static(
      "compute",
      [](double fragment_mass_tolerance, bool fragment_mass_tolerance_unit_ppm, const OpenMS::MSSpectrum& exp_spectrum,
         const OpenMS::DataArrays::IntegerDataArray& exp_charges, const OpenMS::MSSpectrum& theo_spectrum,
         const OpenMS::DataArrays::IntegerDataArray& theo_charges) {
        return OpenMS::MorpheusScore::compute(fragment_mass_tolerance, fragment_mass_tolerance_unit_ppm, exp_spectrum, exp_charges, theo_spectrum,
                                              theo_charges);
      },
      "fragment_mass_tolerance"_a, "fragment_mass_tolerance_unit_ppm"_a, "exp_spectrum"_a, "exp_charges"_a, "theo_spectrum"_a, "theo_charges"_a,
  ...
  nb::class_<OpenMS::MorpheusScore::Result>(m, "MorpheusScore_Result", "OpenMS class MorpheusScore_Result")
    ...
    .def(
      "__deepcopy__", [](const OpenMS::MorpheusScore::Result& self, nb::dict) { return OpenMS::MorpheusScore::Result(self); }, "memo"_a)
  ...
  // OPXLDataStructs
  // -----------------------------------------------------------------------
  auto opxldatastructs_class
    = nb::class_<OpenMS::OPXLDataStructs>(m, "OPXLDataStructs", "OpenMS class OPXLDataStructs")
        .def(nb::init<>())
  ...
  nb::class_<OpenMS::OPXLDataStructs::XLPrecursor>(m, "XLPrecursor", "Cross-link precursor candidate")
    ...
    .def(
      "__deepcopy__", [](const OpenMS::OPXLDataStructs::XLPrecursor& self, nb::dict) { return OpenMS::OPXLDataStructs::XLPrecursor(self); }, "memo"_a)
  ...
  nb::class_<OpenMS::OPXLDataStructs::AASeqWithMass>(m, "AASeqWithMass", "Amino acid sequence with associated mass")
    ...
    .def(
      "__deepcopy__", [](const OpenMS::OPXLDataStructs::AASeqWithMass& self, nb::dict) { return OpenMS::OPXLDataStructs::AASeqWithMass(self); },
      "memo"_a)
  ...
  nb::class_<OpenMS::OPXLDataStructs::ProteinProteinCrossLink>(m, "ProteinProteinCrossLink", "Represents a cross-link between two peptides")
    .def(nb::init<>())
    .def("__copy__",
         [](const OpenMS::OPXLDataStructs::ProteinProteinCrossLink& self) { return OpenMS::OPXLDataStructs::ProteinProteinCrossLink(self); })
    .def(
      "__deepcopy__",
      [](const OpenMS::OPXLDataStructs::ProteinProteinCrossLink& self, nb::dict) { return OpenMS::OPXLDataStructs::ProteinProteinCrossLink(self); },
      "memo"_a)
    .def_prop_ro("alpha",
                 [](const OpenMS::OPXLDataStructs::ProteinProteinCrossLink& self) { return self.alpha ? *self.alpha : OpenMS::AASequence(); })
    .def_prop_ro("beta", [](const OpenMS::OPXLDataStructs::ProteinProteinCrossLink& self) { return self.beta ? *self.beta : OpenMS::AASequence(); })
  ...
  nb::class_<OpenMS::OPXLDataStructs::CrossLinkSpectrumMatch>(m, "CrossLinkSpectrumMatch", "Result of a cross-link spectrum match")
    .def(nb::init<>())
    .def("__copy__",
         [](const OpenMS::OPXLDataStructs::CrossLinkSpectrumMatch& self) { return OpenMS::OPXLDataStructs::CrossLinkSpectrumMatch(self); })
    .def(
      "__deepcopy__",
      [](const OpenMS::OPXLDataStructs::CrossLinkSpectrumMatch& self, nb::dict) { return OpenMS::OPXLDataStructs::CrossLinkSpectrumMatch(self); },
      "memo"_a)
...
duplicated code
    ...
    .def(
      "__deepcopy__", [](const OpenMS::OPXLHelper& self, nb::dict) { return OpenMS::OPXLHelper(self); }, "memo"_a)
    .def_static(
      "addXLTargetDecoyMV",
      [](std::vector<OpenMS::PeptideIdentification> peptide_ids) {
        OpenMS::OPXLHelper::addXLTargetDecoyMV(peptide_ids);
        return peptide_ids;
      },
      "peptide_ids"_a)
    .def_static(
      "addXLTargetDecoyMV", [](OpenMS::PeptideIdentificationList& peptide_ids) { return OpenMS::OPXLHelper::addXLTargetDecoyMV(peptide_ids); },
      "peptide_ids"_a)
    .def_static(
      "addBetaAccessions",
      [](std::vector<OpenMS::PeptideIdentification> peptide_ids) {
      ...
      "peptide_ids"_a)
    .def_static(
      "addBetaAccessions", [](OpenMS::PeptideIdentificationList& peptide_ids) { return OpenMS::OPXLHelper::addBetaAccessions(peptide_ids); },
      "peptide_ids"_a)
    .def_static(
      ...
      "peptide_ids"_a)
    .def_static(
      "removeBetaPeptideHits", [](OpenMS::PeptideIdentificationList& peptide_ids) { return OpenMS::OPXLHelper::removeBetaPeptideHits(peptide_ids); },
      "peptide_ids"_a)
    .def_static(
      "addPercolatorFeatureList", [](OpenMS::ProteinIdentification& prot_id) { return OpenMS::OPXLHelper::addPercolatorFeatureList(prot_id); },
      "prot_id"_a)
    .def_static("computeDeltaScores",
                []() {
                  std::vector<OpenMS::PeptideIdentification> peptide_ids;
    ...
    .def_static(
      ...
      [](std::vector<OpenMS::PeptideIdentification> peptide_ids, size_t number_top_hits) {
        return OpenMS::OPXLHelper::combineTopRanksFromPairs(peptide_ids, number_top_hits);
      },
      "peptide_ids"_a, "number_top_hits"_a)
    .def_static(
      "combineTopRanksFromPairs",
      [](OpenMS::PeptideIdentificationList& peptide_ids, size_t number_top_hits) {
        return OpenMS::OPXLHelper::combineTopRanksFromPairs(peptide_ids, number_top_hits);
      },
      "peptide_ids"_a, "number_top_hits"_a)
    .def_static(
      "computePrecursorError",
      [](const OpenMS::OPXLDataStructs::CrossLinkSpectrumMatch& csm, double precursor_mz, int precursor_charge) {
        return OpenMS::OPXLHelper::computePrecursorError(csm, precursor_mz, precursor_charge);
      },
      "csm"_a, "precursor_mz"_a, "precursor_charge"_a)
    .def_static(
    ...
    .def_static(
      "addProteinPositionMetaValues",
      [](OpenMS::PeptideIdentificationList& peptide_ids) { return OpenMS::OPXLHelper::addProteinPositionMetaValues(peptide_ids); }, "peptide_ids"_a)
    .def_static(
      "isoPeakMeans",
      [](OpenMS::OPXLDataStructs::CrossLinkSpectrumMatch& csm, const OpenMS::DataArrays::IntegerDataArray& num_iso_peaks_array,
         const std::vector<std::pair<size_t, size_t>>& matched_spec_linear_alpha,
         const std::vector<std::pair<size_t, size_t>>& matched_spec_linear_beta,
         const std::vector<std::pair<size_t, size_t>>& matched_spec_xlinks_alpha,
         const std::vector<std::pair<size_t, size_t>>& matched_spec_xlinks_beta) {
        OpenMS::OPXLHelper::isoPeakMeans(csm, num_iso_peaks_array, matched_spec_linear_alpha, matched_spec_linear_beta, matched_spec_xlinks_alpha,
                                         matched_spec_xlinks_beta);
      },
      "csm"_a, "num_iso_peaks_array"_a, "matched_spec_linear_alpha"_a, "matched_spec_linear_beta"_a, "matched_spec_xlinks_alpha"_a,
      "matched_spec_xlinks_beta"_a, "Computes the mean of alpha, beta, xlinks-alpha and xlinks-beta iso peak counts")
    .def_static(
      "enumerateCrossLinksAndMasses",
      [](const std::vector<OpenMS::OPXLDataStructs::AASeqWithMass>& peptides, double cross_link_mass_light,
         const OpenMS::DoubleList& cross_link_mass_mono_link, const OpenMS::StringList& cross_link_residue1,
         const OpenMS::StringList& cross_link_residue2, const std::vector<double>& spectrum_precursors, double precursor_mass_tolerance,
        ...
        auto result = OpenMS::OPXLHelper::enumerateCrossLinksAndMasses(
          peptides, cross_link_mass_light, cross_link_mass_mono_link, cross_link_residue1, cross_link_residue2, spectrum_precursors,
          precursor_correction_positions, precursor_mass_tolerance, precursor_mass_tolerance_unit_ppm);
        return nb::make_tuple(result, precursor_correction_positions);
      },
      "peptides"_a, "cross_link_mass_light"_a, "cross_link_mass_mono_link"_a, "cross_link_residue1"_a, "cross_link_residue2"_a,
      "spectrum_precursors"_a, "precursor_mass_tolerance"_a, "precursor_mass_tolerance_unit_ppm"_a,
      "Enumerates cross-link candidates and masses, returns (candidates, correction_positions)")
    .def_static(
      "digestDatabase",
      [](std::vector<OpenMS::FASTAFile::FASTAEntry> fasta_db, const OpenMS::EnzymaticDigestion& digestor, size_t min_peptide_length,
         const OpenMS::StringList& cross_link_residue1, const OpenMS::StringList& cross_link_residue2,
         const OpenMS::ModifiedPeptideGenerator::MapToResidueType& fixed_modifications,
         const OpenMS::ModifiedPeptideGenerator::MapToResidueType& variable_modifications, size_t max_variable_mods_per_peptide) {
        return OpenMS::OPXLHelper::digestDatabase(fasta_db, digestor, min_peptide_length, cross_link_residue1, cross_link_residue2,
                                                  fixed_modifications, variable_modifications, max_variable_mods_per_peptide);
      },
      "fasta_db"_a, "digestor"_a, "min_peptide_length"_a, "cross_link_residue1"_a, "cross_link_residue2"_a, "fixed_modifications"_a,
      "variable_modifications"_a, "max_variable_mods_per_peptide"_a, "Digests a FASTA database and returns peptides with masses")
    .def_static(
      "buildCandidates",
      [](const std::vector<OpenMS::OPXLDataStructs::XLPrecursor>& candidates, const std::vector<int>& precursor_corrections,
         const std::vector<int>& precursor_correction_positions, const std::vector<OpenMS::OPXLDataStructs::AASeqWithMass>& peptide_masses,
         const OpenMS::StringList& cross_link_residue1, const OpenMS::StringList& cross_link_residue2, double cross_link_mass,
         const OpenMS::DoubleList& cross_link_mass_mono_link, const std::vector<double>& spectrum_precursor_vector,
         const std::vector<double>& allowed_error_vector, const OpenMS::String& cross_link_name) {
        return OpenMS::OPXLHelper::buildCandidates(candidates, precursor_corrections, precursor_correction_positions, peptide_masses,
                                                   cross_link_residue1, cross_link_residue2, cross_link_mass, cross_link_mass_mono_link,
                                                   spectrum_precursor_vector, allowed_error_vector, cross_link_name);
      },
      "candidates"_a, "precursor_corrections"_a, "precursor_correction_positions"_a, "peptide_masses"_a, "cross_link_residue1"_a,
      "cross_link_residue2"_a, "cross_link_mass"_a, "cross_link_mass_mono_link"_a, "spectrum_precursor_vector"_a, "allowed_error_vector"_a,
      "cross_link_name"_a, "Builds cross-link candidates from precursor candidates")
    .def_static(
      "buildFragmentAnnotations",
      [](const std::vector<std::pair<size_t, size_t>>& matching, const OpenMS::MSSpectrum& theoretical_spectrum,
         const OpenMS::MSSpectrum& experiment_spectrum) {
        std::vector<OpenMS::PeptideHit::PeakAnnotation> frag_annotations;
        OpenMS::OPXLHelper::buildFragmentAnnotations(frag_annotations, matching, theoretical_spectrum, experiment_spectrum);
        return frag_annotations;
      },
      "matching"_a, "theoretical_spectrum"_a, "experiment_spectrum"_a, "Builds fragment annotations from spectrum matching results")
    .def_static(
      "buildPeptideIDs",
      [](std::vector<OpenMS::OPXLDataStructs::CrossLinkSpectrumMatch>& top_csms_spectrum,
         std::vector<std::vector<OpenMS::OPXLDataStructs::CrossLinkSpectrumMatch>>& all_top_csms, size_t all_top_csms_current_index,
         const OpenMS::PeakMap& spectra, size_t scan_index, size_t scan_index_heavy) {
        OpenMS::PeptideIdentificationList peptide_ids;
        OpenMS::OPXLHelper::buildPeptideIDs(peptide_ids, top_csms_spectrum, all_top_csms, all_top_csms_current_index, spectra, scan_index,
                                            scan_index_heavy);
        return peptide_ids;
      },
      "top_csms_spectrum"_a, "all_top_csms"_a, "all_top_csms_current_index"_a, "spectra"_a, "scan_index"_a, "scan_index_heavy"_a,
      "Builds PeptideIdentifications from cross-link spectrum matches")
    .def_static(
      "collectPrecursorCandidates",
      [](const OpenMS::IntList& precursor_correction_steps, double precursor_mass, double precursor_mass_tolerance,
         bool precursor_mass_tolerance_unit_ppm, const std::vector<OpenMS::OPXLDataStructs::AASeqWithMass>& filtered_peptide_masses,
         double cross_link_mass, const OpenMS::DoubleList& cross_link_mass_mono_link, const OpenMS::StringList& cross_link_residue1,
         const OpenMS::StringList& cross_link_residue2, const OpenMS::String& cross_link_name, bool use_sequence_tags,
         const std::vector<std::string>& tags) {
        return OpenMS::OPXLHelper::collectPrecursorCandidates(
          precursor_correction_steps, precursor_mass, precursor_mass_tolerance, precursor_mass_tolerance_unit_ppm, filtered_peptide_masses,
          cross_link_mass, cross_link_mass_mono_link, cross_link_residue1, cross_link_residue2, cross_link_name, use_sequence_tags, tags);
      },
      "precursor_correction_steps"_a, "precursor_mass"_a, "precursor_mass_tolerance"_a, "precursor_mass_tolerance_unit_ppm"_a,
      "filtered_peptide_masses"_a, "cross_link_mass"_a, "cross_link_mass_mono_link"_a, "cross_link_residue1"_a, "cross_link_residue2"_a,
      "cross_link_name"_a, "use_sequence_tags"_a = false, "tags"_a = std::vector<std::string>(),
  ...
  nb::class_<OpenMS::OPXLSpectrumProcessingAlgorithms>(m, "OPXLSpectrumProcessingAlgorithms", "OpenMS class OPXLSpectrumProcessingAlgorithms")
    ...
    .def(
      "__deepcopy__", [](const OpenMS::OPXLSpectrumProcessingAlgorithms& self, nb::dict) { return OpenMS::OPXLSpectrumProcessingAlgorithms(self); },
      "memo"_a)
    .def_static(
      "mergeAnnotatedSpectra",
      [](OpenMS::MSSpectrum& first_spectrum, OpenMS::MSSpectrum& second_spectrum) {
        return OpenMS::OPXLSpectrumProcessingAlgorithms::mergeAnnotatedSpectra(first_spectrum, second_spectrum);
      },
      "first_spectrum"_a, "second_spectrum"_a)
    .def_static(
      "preprocessSpectra",
      [](OpenMS::MSExperiment& exp, double fragment_mass_tolerance, bool fragment_mass_tolerance_unit_ppm, size_t peptide_min_size,
         int min_precursor_charge, int max_precursor_charge, bool deisotope, bool labeled) {
        return OpenMS::OPXLSpectrumProcessingAlgorithms::preprocessSpectra(exp, fragment_mass_tolerance, fragment_mass_tolerance_unit_ppm,
                                                                           peptide_min_size, min_precursor_charge, max_precursor_charge, deisotope,
                                                                           labeled);
      },
      "exp"_a, "fragment_mass_tolerance"_a, "fragment_mass_tolerance_unit_ppm"_a, "peptide_min_size"_a, "min_precursor_charge"_a,
      "max_precursor_charge"_a, "deisotope"_a, "labeled"_a)
    .def_static(
      "getSpectrumAlignmentFastCharge",
      [](double fragment_mass_tolerance, bool fragment_mass_tolerance_unit_ppm, const OpenMS::MSSpectrum& theo_spectrum,
         const OpenMS::MSSpectrum& exp_spectrum, const OpenMS::DataArrays::IntegerDataArray& theo_charges,
        ...
        OpenMS::OPXLSpectrumProcessingAlgorithms::getSpectrumAlignmentFastCharge(alignment, fragment_mass_tolerance, fragment_mass_tolerance_unit_ppm,
                                                                                 theo_spectrum, exp_spectrum, theo_charges, exp_charges,
                                                                                 ppm_error_array, intensity_cutoff);
        return std::make_pair(alignment, ppm_error_array);
      },
      "fragment_mass_tolerance"_a, "fragment_mass_tolerance_unit_ppm"_a, "theo_spectrum"_a, "exp_spectrum"_a, "theo_charges"_a, "exp_charges"_a,
      "intensity_cutoff"_a = 0.0, "Computes a spectrum alignment considering fragment charges, returns (alignment, ppm_error_array)")
    .def_static(
      "getSpectrumAlignmentSimple",
      [](double fragment_mass_tolerance, bool fragment_mass_tolerance_unit_ppm, const std::vector<OpenMS::SimpleTSGXLMS::SimplePeak>& theo_spectrum,
         const OpenMS::MSSpectrum& exp_spectrum, const OpenMS::DataArrays::IntegerDataArray& exp_charges) {
        std::vector<std::pair<size_t, size_t>> alignment;
        OpenMS::OPXLSpectrumProcessingAlgorithms::getSpectrumAlignmentSimple(alignment, fragment_mass_tolerance, fragment_mass_tolerance_unit_ppm,
                                                                             theo_spectrum, exp_spectrum, exp_charges);
        return alignment;
      },
      "fragment_mass_tolerance"_a, "fragment_mass_tolerance_unit_ppm"_a, "theo_spectrum"_a, "exp_spectrum"_a, "exp_charges"_a,
      "Computes a spectrum alignment using SimplePeak for the theoretical spectrum");
...
implement the OpenSWATH interfaces
    ...
    .def(
      "__deepcopy__", [](const OpenMS::OpenSwathDataAccessHelper& self, nb::dict) { return OpenMS::OpenSwathDataAccessHelper(self); }, "memo"_a)
    .def_static(
      "convertToOpenMSSpectrum",
      [](const std::shared_ptr<OpenSwath::OSSpectrum>& sptr, OpenMS::MSSpectrum& spectrum) {
        return OpenMS::OpenSwathDataAccessHelper::convertToOpenMSSpectrum(sptr, spectrum);
      },
      "sptr"_a, "spectrum"_a, "Converts a SpectrumPtr to an OpenMS Spectrum")
    .def_static(
      "convertToOpenMSChromatogram",
      [](const std::shared_ptr<OpenSwath::OSChromatogram>& cptr, OpenMS::MSChromatogram& chromatogram) {
        return OpenMS::OpenSwathDataAccessHelper::convertToOpenMSChromatogram(cptr, chromatogram);
      },
      "cptr"_a, "chromatogram"_a, "Converts a ChromatogramPtr to an OpenMS Chromatogram")
    .def_static(
      "convertToOpenMSChromatogramFilter",
      [](OpenMS::MSChromatogram& chromatogram, const std::shared_ptr<OpenSwath::OSChromatogram>& cptr, double rt_min, double rt_max) {
        return OpenMS::OpenSwathDataAccessHelper::convertToOpenMSChromatogramFilter(chromatogram, cptr, rt_min, rt_max);
      },
      "chromatogram"_a, "cptr"_a, "rt_min"_a, "rt_max"_a)
    .def_static(
      "convertTargetedExp",
      [](const OpenMS::TargetedExperiment& transition_exp_, OpenSwath::LightTargetedExperiment& transition_exp) {
        return OpenMS::OpenSwathDataAccessHelper::convertTargetedExp(transition_exp_, transition_exp);
      },
      "transition_exp_"_a, "transition_exp"_a, "Converts from the OpenMS TargetedExperiment to the OpenMs LightTargetedExperiment")
    .def_static(
      "convertPeptideToAASequence",
      [](const OpenSwath::LightCompound& peptide, OpenMS::AASequence& aa_sequence) {
        return OpenMS::OpenSwathDataAccessHelper::convertPeptideToAASequence(peptide, aa_sequence);
      },
      "peptide"_a, "aa_sequence"_a, "Converts from the LightCompound to an OpenMS AASequence (with correct modifications)")
    .def_static(
      "convertTargetedCompound",
      [](const OpenMS::TargetedExperiment::Peptide& pep) {
    ...
    .def_static(
      "convertToSpectrumPtr", [](const OpenMS::MSSpectrum& spectrum) { return OpenMS::OpenSwathDataAccessHelper::convertToSpectrumPtr(spectrum); },
      "spectrum"_a, "Converts an OpenMS Spectrum to a SpectrumPtr")
    .def_static(
      "convertToChromatogramPtr",
      [](const OpenMS::MSChromatogram& chromatogram) { return OpenMS::OpenSwathDataAccessHelper::convertToChromatogramPtr(chromatogram); },
      "chromatogram"_a, "Converts an OpenMS Chromatogram to a ChromatogramPtr");
  ...
  nb::class_<OpenMS::OpenSwathHelper>(m, "OpenSwathHelper", "A helper class that is used by several OpenSWATH tools")
    ...
    .def(
      "__deepcopy__", [](const OpenMS::OpenSwathHelper& self, nb::dict) { return OpenMS::OpenSwathHelper(self); }, "memo"_a)
    .def_static(
      "computePrecursorId",
      [](const OpenMS::String& transition_group_id, int isotope) {
        return OpenMS::OpenSwathHelper::computePrecursorId(transition_group_id, isotope);
      },
      "transition_group_id"_a, "isotope"_a,
      R"doc(
...
:return: A std `pair` that contains (min,max)
    ...
    .def_static(
      "estimateRTRange", [](const OpenSwath::LightTargetedExperiment& exp) { return OpenMS::OpenSwathHelper::estimateRTRange(exp); }, "exp"_a)
    .def_static(
      "checkSwathMapAndSelectTransitions",
      [](const OpenMS::PeakMap& exp, const OpenMS::TargetedExperiment& targeted_exp, double min_upper_edge_dist) {
      ...
      "exp"_a, "targeted_exp"_a, "min_upper_edge_dist"_a,
      "Checks a swath map and selects appropriate transitions. Returns (success, selected_transitions)");
  ...
  nb::class_<OpenMS::OpenSwathOSWWriter>(m, "OpenSwathOSWWriter", "Class to write out an OpenSwath OSW SQLite output (PyProphet input)")
    ...
    .def(
      "__deepcopy__", [](const OpenMS::OpenSwathOSWWriter& self, nb::dict) { return OpenMS::OpenSwathOSWWriter(self); }, "memo"_a)
    .def("isActive", [](const OpenMS::OpenSwathOSWWriter& self) { return self.isActive(); })
    .def(
      "writeHeader", [](OpenMS::OpenSwathOSWWriter& self) { return self.writeHeader(); }, "Initializes file by generating SQLite tables")
    .def(
      "addRun",
      [](OpenMS::OpenSwathOSWWriter& self, size_t run_id, const OpenMS::String& input_filename) { return self.addRun(run_id, input_filename); },
      "run_id"_a, "input_filename"_a,
      R"doc(
Write data to disk
...
:param to_osw_output: Statements generated by prepareLine
    ...
    .def(
      "setRunId", [](OpenMS::OpenSwathOSWWriter& self, size_t run_id) { return self.setRunId(run_id); }, "run_id"_a)
    .def(
      "writeLines", [](OpenMS::OpenSwathOSWWriter& self, const std::vector<OpenMS::String>& to_osw_output) { return self.writeLines(to_osw_output); },
      "to_osw_output"_a,
      R"doc(
...
:return: A String to be written using writeLines
    ...
    .def(
      "prepareLine",
      [](const OpenMS::OpenSwathOSWWriter& self, const OpenSwath::LightCompound& pep, const OpenSwath::LightTransition& transition,
         const OpenMS::FeatureMap& output, const OpenMS::String& id) { return self.prepareLine(pep, &transition, output, id); },
  ...
  nb::class_<OpenMS::PeakIntegrator::PeakArea>(m, "PI_PeakArea", "OpenMS class PI_PeakArea")
    ...
    .def(
      "__deepcopy__", [](const OpenMS::PeakIntegrator::PeakArea& self, nb::dict) { return OpenMS::PeakIntegrator::PeakArea(self); }, "memo"_a)
  ...
  nb::class_<OpenMS::PeakIntegrator::PeakBackground>(m, "PI_PeakBackground", "OpenMS class PI_PeakBackground")
    ...
    .def(
      "__deepcopy__", [](const OpenMS::PeakIntegrator::PeakBackground& self, nb::dict) { return OpenMS::PeakIntegrator::PeakBackground(self); },
      "memo"_a)
  ...
  nb::class_<OpenMS::PeakIntegrator::PeakShapeMetrics>(m, "PI_PeakShapeMetrics", "OpenMS class PI_PeakShapeMetrics")
    ...
    .def(
      "__deepcopy__", [](const OpenMS::PeakIntegrator::PeakShapeMetrics& self, nb::dict) { return OpenMS::PeakIntegrator::PeakShapeMetrics(self); },
      "memo"_a)
  ...
  nb::class_<OpenMS::PScore>(m, "PScore", "OpenMS class PScore")
    ...
    .def(
      "__deepcopy__", [](const OpenMS::PScore& self, nb::dict) { return OpenMS::PScore(self); }, "memo"_a)
    .def_static(
      "calculateIntensityRankInMZWindow",
      [](const std::vector<double>& mz, const std::vector<double>& intensities, double mz_window) {
        return OpenMS::PScore::calculateIntensityRankInMZWindow(mz, intensities, mz_window);
      },
      "mz"_a, "intensities"_a, "mz_window"_a)
    .def_static(
      "calculateRankMap",
      [](const OpenMS::MSExperiment& peak_map, double mz_window) { return OpenMS::PScore::calculateRankMap(peak_map, mz_window); }, "peak_map"_a,
      "mz_window"_a,
      R"doc(
...
:param mz_window: The window in Thomson centered at each peak
    ...
    .def_static(
      ...
      [](const OpenMS::MSSpectrum& spec, const std::vector<size_t>& ranks, size_t min_level, size_t max_level) {
        return OpenMS::PScore::calculatePeakLevelSpectra(spec, ranks, min_level, max_level);
      },
      "spec"_a, "ranks"_a, "min_level"_a, "max_level"_a,
      R"doc(
...
:param mz_window: Window in Thomson centered at each peak
    ...
    .def_static(
      "computePScore",
      [](double fragment_mass_tolerance, bool fragment_mass_tolerance_unit_ppm, const std::map<size_t, OpenMS::MSSpectrum>& peak_level_spectra,
         const std::vector<OpenMS::MSSpectrum>& theo_spectra, double mz_window) {
        return OpenMS::PScore::computePScore(fragment_mass_tolerance, fragment_mass_tolerance_unit_ppm, peak_level_spectra, theo_spectra, mz_window);
      },
      "fragment_mass_tolerance"_a, "fragment_mass_tolerance_unit_ppm"_a, "peak_level_spectra"_a, "theo_spectra"_a, "mz_window"_a = 100.0,
      "Compute the PScore for a vector of theoretical spectra")
    .def_static(
      "computePScore",
      [](double fragment_mass_tolerance, bool fragment_mass_tolerance_unit_ppm, const std::map<size_t, OpenMS::MSSpectrum>& peak_level_spectra,
         const OpenMS::MSSpectrum& theo_spectrum, double mz_window) {
        return OpenMS::PScore::computePScore(fragment_mass_tolerance, fragment_mass_tolerance_unit_ppm, peak_level_spectra, theo_spectrum, mz_window);
      },
      "fragment_mass_tolerance"_a, "fragment_mass_tolerance_unit_ppm"_a, "peak_level_spectra"_a, "theo_spectrum"_a, "mz_window"_a = 100.0,
      "Compute the PScore for a single theoretical spectrum");

  // -----------------------------------------------------------------------
  // PeakGroup
  // -----------------------------------------------------------------------
  auto peakgroup_class
...
Constructors
        ...
        .def(
          "__deepcopy__", [](const OpenMS::PeakGroup& self, nb::dict) { return OpenMS::PeakGroup(self); }, "memo"_a)
        .def(nb::self < nb::self)
        .def(nb::self > nb::self)
        .def(nb::self == nb::self)
        .def(
          "setScanNumber", [](OpenMS::PeakGroup& self, int scan_number) { return self.setScanNumber(scan_number); }, "scan_number"_a,
          "Sets the scan number")
        .def(
          "setChargeIsotopeCosine", [](OpenMS::PeakGroup& self, int abs_charge, float cos) { return self.setChargeIsotopeCosine(abs_charge, cos); },
          "abs_charge"_a, "cos"_a, "Sets isotope cosine for given charge")
        .def(
          "setIsotopeCosine", [](OpenMS::PeakGroup& self, float cos) { return self.setIsotopeCosine(cos); }, "cos"_a, "Sets the isotope cosine score")
        .def(
          "setRepAbsCharge", [](OpenMS::PeakGroup& self, int max_snr_abs_charge) { return self.setRepAbsCharge(max_snr_abs_charge); },
          "max_snr_abs_charge"_a, "Sets the representative charge")
        .def(
          "setMonoisotopicMass", [](OpenMS::PeakGroup& self, double mono_mass) { return self.setMonoisotopicMass(mono_mass); }, "mono_mass"_a,
          "Sets the monoisotopic mass")
        .def(
          "setQscore", [](OpenMS::PeakGroup& self, double qscore) { return self.setQscore(qscore); }, "qscore"_a, "Sets the quality score")
        .def(
          "setChargeScore", [](OpenMS::PeakGroup& self, float charge_score) { return self.setChargeScore(charge_score); }, "charge_score"_a,
          "Sets the charge fit score")
        .def(
          "setAvgPPMError", [](OpenMS::PeakGroup& self, float error) { return self.setAvgPPMError(error); }, "error"_a, "Sets average ppm error")
        .def(
          "setSNR", [](OpenMS::PeakGroup& self, float snr) { return self.setSNR(snr); }, "snr"_a, "Sets the SNR")
        .def(
          "setChargeSNR", [](OpenMS::PeakGroup& self, int abs_charge, float c_snr) { return self.setChargeSNR(abs_charge, c_snr); }, "abs_charge"_a,
          "c_snr"_a, "Sets SNR for given charge")
        .def(
          "setTargeted", [](OpenMS::PeakGroup& self) { return self.setTargeted(); }, "Marks this peak group as targeted")
        .def(
          "getScanNumber", [](const OpenMS::PeakGroup& self) { return self.getScanNumber(); }, "Returns the scan number")
        .def(
          "getIntensity", [](const OpenMS::PeakGroup& self) { return self.getIntensity(); }, "Returns the summed intensity")
        .def(
          "getChargeSNR", [](const OpenMS::PeakGroup& self, int abs_charge) { return self.getChargeSNR(abs_charge); }, "abs_charge"_a,
          "Returns SNR for given charge")
        .def(
          "getChargeIsotopeCosine", [](const OpenMS::PeakGroup& self, int abs_charge) { return self.getChargeIsotopeCosine(abs_charge); },
          "abs_charge"_a, "Returns isotope cosine for given charge")
        .def(
          "getChargeIntensity", [](const OpenMS::PeakGroup& self, int abs_charge) { return self.getChargeIntensity(abs_charge); }, "abs_charge"_a,
          "Returns intensity for given charge")
        .def(
          "getIsotopeIntensities", [](const OpenMS::PeakGroup& self) -> const std::vector<float>& { return self.getIsotopeIntensities(); },
          nb::rv_policy::reference_internal, "Returns per-isotope intensities")
        .def(
          "getIsotopeCosine", [](const OpenMS::PeakGroup& self) { return self.getIsotopeCosine(); }, "Returns the isotope cosine score")
        .def(
          "getPeakOccupancy", [](const OpenMS::PeakGroup& self) { return self.getPeakOccupancy(); }, "Returns peak occupancy (0-1)")
        .def(
          "getRepAbsCharge", [](const OpenMS::PeakGroup& self) { return self.getRepAbsCharge(); }, "Returns the representative charge")
        .def(
          "getQscore", [](const OpenMS::PeakGroup& self) { return self.getQscore(); }, "Returns the quality score (0-1)")
        .def(
          "getQscore2D", [](const OpenMS::PeakGroup& self) { return self.getQscore2D(); },
          "Returns the 2D quality score incorporating feature-level information")
        .def(
          "getSNR", [](const OpenMS::PeakGroup& self) { return self.getSNR(); }, "Returns the signal-to-noise ratio")
        .def(
          "getChargeScore", [](const OpenMS::PeakGroup& self) { return self.getChargeScore(); }, "Returns the charge fit score")
        .def(
          "getAvgPPMError", [](const OpenMS::PeakGroup& self) { return self.getAvgPPMError(); }, "Returns average ppm error")
        .def(
          "getAvgDaError", [](const OpenMS::PeakGroup& self) { return self.getAvgDaError(); }, "Returns average Da error")
        .def(
          "isPositive", [](const OpenMS::PeakGroup& self) { return self.isPositive(); }, "Returns true if positive ionization mode")
        .def(
          "isTargeted", [](const OpenMS::PeakGroup& self) { return self.isTargeted(); }, "Returns true if this peak group was targeted")
        .def(
          "getTargetDecoyType", [](const OpenMS::PeakGroup& self) { return self.getTargetDecoyType(); }, "Returns target/decoy type")
        .def(
          "setTargetDecoyType", [](OpenMS::PeakGroup& self, OpenMS::PeakGroup::TargetDecoyType index) { return self.setTargetDecoyType(index); },
          "index"_a, "Sets the target/decoy type")
        .def(
          "getQvalue", [](const OpenMS::PeakGroup& self) { return self.getQvalue(); }, "Returns the q-value for FDR")
        .def(
          "setQvalue", [](OpenMS::PeakGroup& self, double q) { return self.setQvalue(q); }, "q"_a, "Sets the q-value")
        .def(
          "setIsotopeDaDistance", [](OpenMS::PeakGroup& self, double d) { return self.setIsotopeDaDistance(d); }, "d"_a, "Sets isotope distance")
        .def(
          "getIsotopeDaDistance", [](const OpenMS::PeakGroup& self) { return self.getIsotopeDaDistance(); },
          "Returns distance between consecutive isotopes")
        .def(
          "getMinNegativeIsotopeIndex", [](const OpenMS::PeakGroup& self) { return self.getMinNegativeIsotopeIndex(); },
          "Returns minimum negative isotope index")
        .def(
          "setIndex", [](OpenMS::PeakGroup& self, unsigned int i) { return self.setIndex(i); }, "i"_a, "Sets the peak group index")
        .def(
          "setQscore2D", [](OpenMS::PeakGroup& self, double fqscore) { return self.setQscore2D(fqscore); }, "fqscore"_a, "Sets the 2D quality score")
        .def(
          "setFeatureIndex", [](OpenMS::PeakGroup& self, unsigned int findex) { return self.setFeatureIndex(findex); }, "findex"_a,
          "Sets the feature index")
        .def(
          "getIndex", [](const OpenMS::PeakGroup& self) { return self.getIndex(); }, "Returns the peak group index")
        .def(
          "getFeatureIndex", [](const OpenMS::PeakGroup& self) { return self.getFeatureIndex(); }, "Returns the feature index")
        .def("begin", [](const OpenMS::PeakGroup& self) { return self.begin(); })
        .def("end", [](const OpenMS::PeakGroup& self) { return self.end(); })
        .def("__getitem__",
             [](OpenMS::PeakGroup& self, size_t i) {
               if (i >= self.size()) throw nb::index_error();
               return self[i];
             })
        .def(
          "getMassErrors", [](const OpenMS::PeakGroup& self, bool ppm) { return self.getMassErrors(ppm); }, "ppm"_a = true,
          "Returns mass errors per isotope")
        .def(
          "push_back", [](OpenMS::PeakGroup& self, const OpenMS::FLASHHelperClasses::LogMzPeak& pg) { return self.push_back(pg); }, "pg"_a,
          "Adds a LogMzPeak")
        .def(
          "size", [](const OpenMS::PeakGroup& self) { return self.size(); }, "Returns number of LogMzPeaks")
        .def(
          "reserve", [](OpenMS::PeakGroup& self, size_t n) { return self.reserve(n); }, "n"_a, "Reserves space for n peaks")
        .def(
          "empty", [](const OpenMS::PeakGroup& self) { return self.empty(); }, "Returns true if no peaks")
        .def(
          "sort", [](OpenMS::PeakGroup& self) { return self.sort(); }, "Sorts peaks by log m/z")
        .def("__iter__",
             [](OpenMS::PeakGroup& self) {
               return nb::make_iterator<nb::rv_policy::reference_internal>(nb::type<OpenMS::PeakGroup>(), "PeakGroup_iter", self.begin(), self.end());
             })
        .def("__len__", [](OpenMS::PeakGroup& self) { return self.size(); })
        .def(
          "__getitem__",
          [](OpenMS::PeakGroup& self, size_t i) -> const OpenMS::FLASHHelperClasses::LogMzPeak& {
            if (i >= self.size()) throw nb::index_error();
            return self[i];
          },
          nb::rv_policy::reference_internal)
  ...
  // -----------------------------------------------------------------------
  nb::class_<OpenMS::TargetedExperimentHelper::Peptide::Modification, OpenMS::CVTermListInterface>(
    m, "TargetedExperiment_Modification", "Modification on a peptide in a targeted experiment")
    .def(nb::init<>())
...
CVTermList
        ...
        .def(
          "__deepcopy__",
          [](const OpenMS::TargetedExperimentHelper::Peptide& self, nb::dict) { return OpenMS::TargetedExperimentHelper::Peptide(self); }, "memo"_a)
        .def(nb::self == nb::self)
        .def(
          "setPeptideGroupLabel",
          [](OpenMS::TargetedExperimentHelper::Peptide& self, const OpenMS::String& label) { return self.setPeptideGroupLabel(label); }, "label"_a,
          "Sets the peptide group label")
        .def(
          "getPeptideGroupLabel", [](const OpenMS::TargetedExperimentHelper::Peptide& self) { return self.getPeptideGroupLabel(); },
          "Get the peptide group label")
        .def(
          "setChargeState", [](OpenMS::TargetedExperimentHelper::Peptide& self, int charge) { return self.setChargeState(charge); }, "charge"_a,
          "Sets the peptide or compound charge states")
        .def(
          "hasCharge", [](const OpenMS::TargetedExperimentHelper::Peptide& self) { return self.hasCharge(); }, "Whether product has set charge state")
        .def(
          "getChargeState", [](const OpenMS::TargetedExperimentHelper::Peptide& self) { return self.getChargeState(); },
          "Returns the peptide or compound charge state")
        .def(
          "hasRetentionTime", [](const OpenMS::TargetedExperimentHelper::Peptide& self) { return self.hasRetentionTime(); },
          "Gets compound or peptide retention time")
        .def(
          "getRetentionTime", [](const OpenMS::TargetedExperimentHelper::Peptide& self) { return self.getRetentionTime(); },
          "Gets compound or peptide retention time")
        .def(
          "getRetentionTimeType", [](const OpenMS::TargetedExperimentHelper::Peptide& self) { return self.getRetentionTimeType(); },
          "Get compound or peptide retentiontime type")
        .def(
          "getRetentionTimeUnit", [](const OpenMS::TargetedExperimentHelper::Peptide& self) { return self.getRetentionTimeUnit(); },
  ...
  nb::class_<OpenMS::PeptideAndProteinQuant::PeptideData>(m, "PeptideAndProteinQuant_PeptideData", "OpenMS class PeptideAndProteinQuant_PeptideData")
    ...
    .def(
      "__deepcopy__",
      [](const OpenMS::PeptideAndProteinQuant::PeptideData& self, nb::dict) { return OpenMS::PeptideAndProteinQuant::PeptideData(self); }, "memo"_a)
  ...
  nb::class_<OpenMS::PeptideAndProteinQuant::ProteinData>(m, "PeptideAndProteinQuant_ProteinData", "OpenMS class PeptideAndProteinQuant_ProteinData")
    ...
    .def(
      "__deepcopy__",
      [](const OpenMS::PeptideAndProteinQuant::ProteinData& self, nb::dict) { return OpenMS::PeptideAndProteinQuant::ProteinData(self); }, "memo"_a)
  ...
  nb::class_<OpenMS::PeptideAndProteinQuant::Statistics>(m, "PeptideAndProteinQuant_Statistics", "OpenMS class PeptideAndProteinQuant_Statistics")
    ...
    .def(
      "__deepcopy__",
      [](const OpenMS::PeptideAndProteinQuant::Statistics& self, nb::dict) { return OpenMS::PeptideAndProteinQuant::Statistics(self); }, "memo"_a)
  ...
  nb::class_<OpenMS::ConnectedComponent>(m, "PeptideProteinResolution_ConnectedComponent",
    ...
    .def(
      "__deepcopy__", [](const OpenMS::ConnectedComponent& self, nb::dict) { return OpenMS::ConnectedComponent(self); }, "memo"_a)
...
groups to output
    ...
    .def(
      "__deepcopy__", [](const OpenMS::PeptideProteinResolution& self, nb::dict) { return OpenMS::PeptideProteinResolution(self); }, "memo"_a)
    .def_static(
      "run",
      [](std::vector<OpenMS::ProteinIdentification> inferred_protein_id, OpenMS::PeptideIdentificationList& inferred_peptide_ids) {
...
static members
    ...
    .def(
      "buildGraph",
      [](OpenMS::PeptideProteinResolution& self, OpenMS::ProteinIdentification& protein, const OpenMS::PeptideIdentificationList& peptides,
         bool skip_sort) { return self.buildGraph(protein, peptides, skip_sort); },
      "protein"_a, "peptides"_a, "skip_sort"_a = false)
    .def(
      "resolveGraph",
      [](OpenMS::PeptideProteinResolution& self, OpenMS::ProteinIdentification& protein, OpenMS::PeptideIdentificationList& peptides) {
        return self.resolveGraph(protein, peptides);
      },
      "protein"_a, "peptides"_a,
      R"doc(
...
:param skip_sort: Skips sorting of groups, nothing is modified then
    ...
    .def(
      ...
      [](OpenMS::PeptideProteinResolution& self, size_t root_prot_grp) { return self.findConnectedComponent(root_prot_grp); }, "root_prot_grp"_a,
      R"doc(
...
:param peptides: vector of ProteinIdentifications with links to the proteins
    ...
    .def(
      ...
      [](OpenMS::PeptideProteinResolution& self, OpenMS::ConnectedComponent& conn_comp, OpenMS::ProteinIdentification& protein,
         OpenMS::PeptideIdentificationList& peptides) { return self.resolveConnectedComponent(conn_comp, protein, peptides); },
      "conn_comp"_a, "protein"_a, "peptides"_a,
      R"doc(
...
percolator result into the set of Identifications
    ...
    .def(
      "__deepcopy__", [](const OpenMS::PercolatorFeatureSetHelper& self, nb::dict) { return OpenMS::PercolatorFeatureSetHelper(self); }, "memo"_a)
    .def_static(
      "concatMULTISEPeptideIds",
      [](OpenMS::PeptideIdentificationList& all_peptide_ids, OpenMS::PeptideIdentificationList& new_peptide_ids,
         const OpenMS::String& search_engine) {
        return OpenMS::PercolatorFeatureSetHelper::concatMULTISEPeptideIds(all_peptide_ids, new_peptide_ids, search_engine);
      },
      "all_peptide_ids"_a, "new_peptide_ids"_a, "search_engine"_a)
    .def_static(
      "mergeMULTISEPeptideIds",
      [](OpenMS::PeptideIdentificationList& all_peptide_ids, OpenMS::PeptideIdentificationList& new_peptide_ids,
         const OpenMS::String& search_engine) {
        return OpenMS::PercolatorFeatureSetHelper::mergeMULTISEPeptideIds(all_peptide_ids, new_peptide_ids, search_engine);
      },
      "all_peptide_ids"_a, "new_peptide_ids"_a, "search_engine"_a,
      R"doc(
...
:param search_engine: Search engine to depend on for feature creation
    ...
    .def_static(
      ...
      [](std::vector<OpenMS::ProteinIdentification> all_protein_ids, std::vector<OpenMS::ProteinIdentification> new_protein_ids) {
...
:returns: Tuple of (updated all_protein_ids, updated new_protein_ids)
    ...
    .def_static(
      "addMSGFFeatures",
      [](OpenMS::PeptideIdentificationList& peptide_ids, std::vector<OpenMS::String> feature_set) {
...
:returns: Updated feature_set
    ...
    .def_static(
      "addMULTISEFeatures",
      [](OpenMS::PeptideIdentificationList& peptide_ids, std::vector<OpenMS::String> search_engines_used, std::vector<OpenMS::String> feature_set,
         bool complete_only, bool limits_imputation) {
...
:returns: Updated feature_set
    ...
    .def_static(
      "addCONCATSEFeatures",
      [](OpenMS::PeptideIdentificationList& peptide_id_list, std::vector<OpenMS::String> search_engines_used,
         std::vector<OpenMS::String> feature_set) {
...
:returns: Updated feature_set
    ...
    .def_static(
      "checkExtraFeatures",
      [](const std::vector<OpenMS::PeptideHit>& psms, std::vector<OpenMS::String> extra_features) {
...
Constructors
    ...
    .def("__copy__",
         [](const OpenMS::FLASHHelperClasses::PrecalculatedAveragine& self) { return OpenMS::FLASHHelperClasses::PrecalculatedAveragine(self); })
    .def(
      "__deepcopy__",
      [](const OpenMS::FLASHHelperClasses::PrecalculatedAveragine& self, nb::dict) {
        return OpenMS::FLASHHelperClasses::PrecalculatedAveragine(self);
      },
      "memo"_a)
    .def(
      "get", [](const OpenMS::FLASHHelperClasses::PrecalculatedAveragine& self, double mass) { return self.get(mass); }, "mass"_a,
      "Get isotope distribution for given mass")
    .def(
      "getMaxIsotopeIndex", [](const OpenMS::FLASHHelperClasses::PrecalculatedAveragine& self) { return self.getMaxIsotopeIndex(); },
      "Get max isotope index")
    .def(
      "setMaxIsotopeIndex", [](OpenMS::FLASHHelperClasses::PrecalculatedAveragine& self, int index) { return self.setMaxIsotopeIndex(index); },
      "index"_a, "Set max isotope index")
    .def(
      "getLeftCountFromApex",
      [](const OpenMS::FLASHHelperClasses::PrecalculatedAveragine& self, double mass) { return self.getLeftCountFromApex(mass); }, "mass"_a,
      "Get isotope count left of apex")
    .def(
      "getRightCountFromApex",
      [](const OpenMS::FLASHHelperClasses::PrecalculatedAveragine& self, double mass) { return self.getRightCountFromApex(mass); }, "mass"_a,
      "Get isotope count right of apex")
    .def(
      "getApexIndex", [](const OpenMS::FLASHHelperClasses::PrecalculatedAveragine& self, double mass) { return self.getApexIndex(mass); }, "mass"_a,
      "Get apex isotope index")
    .def(
      "getLastIndex", [](const OpenMS::FLASHHelperClasses::PrecalculatedAveragine& self, double mass) { return self.getLastIndex(mass); }, "mass"_a,
      "Get last isotope index")
    .def(
      "getAverageMassDelta",
      [](const OpenMS::FLASHHelperClasses::PrecalculatedAveragine& self, double mass) { return self.getAverageMassDelta(mass); }, "mass"_a,
      "Get mass diff between avg and mono")
    .def(
      "getMostAbundantMassDelta",
      [](const OpenMS::FLASHHelperClasses::PrecalculatedAveragine& self, double mass) { return self.getMostAbundantMassDelta(mass); }, "mass"_a,
      "Get mass diff between most abundant and mono")
    .def(
      "getSNRMultiplicationFactor",
      [](const OpenMS::FLASHHelperClasses::PrecalculatedAveragine& self, double mass) { return self.getSNRMultiplicationFactor(mass); }, "mass"_a,
      "Get SNR multiplication factor")

    .def(
      "__init__",
      [](OpenMS::FLASHHelperClasses::PrecalculatedAveragine* self, double min_mass, double max_mass, double delta,
         OpenMS::CoarseIsotopePatternGenerator& generator, bool use_RNA_averagine) {
    ...
    .def(
      "__init__",
      [](OpenMS::FLASHHelperClasses::PrecalculatedAveragine* self, double min_mass, double max_mass, double delta,
         OpenMS::CoarseIsotopePatternGenerator& generator, bool use_RNA_averagine, double decoy_iso_distance) {
...
These metrics are combined over the previous and the next MS1 spectrum
    ...
    .def(
      "__deepcopy__", [](const OpenMS::PrecursorPurity& self, nb::dict) { return OpenMS::PrecursorPurity(self); }, "memo"_a)
    .def_static(
      "computePrecursorPurity",
      [](const OpenMS::MSSpectrum& ms1, const OpenMS::Precursor& pre, double precursor_mass_tolerance, bool precursor_mass_tolerance_unit_ppm) {
        return OpenMS::PrecursorPurity::computePrecursorPurity(ms1, pre, precursor_mass_tolerance, precursor_mass_tolerance_unit_ppm);
      },
      "ms1"_a, "pre"_a, "precursor_mass_tolerance"_a, "precursor_mass_tolerance_unit_ppm"_a,
      R"doc(
)doc");
  ...
  // -----------------------------------------------------------------------
  nb::class_<OpenMS::PrecursorPurity::PurityScores>(m, "PurityScores", "Precursor purity scores for a single precursor")
    .def(nb::init<>())
    .def("__copy__", [](const OpenMS::PrecursorPurity::PurityScores& self) { return OpenMS::PrecursorPurity::PurityScores(self); })
    .def(
      "__deepcopy__", [](const OpenMS::PrecursorPurity::PurityScores& self, nb::dict) { return OpenMS::PrecursorPurity::PurityScores(self); },
      "memo"_a)
  ...
  nb::class_<OpenMS::ProbablePhosphoSites>(m, "ProbablePhosphoSites", "DefaultParamHandler")
    ...
    .def(
      "__deepcopy__", [](const OpenMS::ProbablePhosphoSites& self, nb::dict) { return OpenMS::ProbablePhosphoSites(self); }, "memo"_a)
...
quantitative ConsensusMap prior to this step
    ...
    .def(
      "__deepcopy__", [](const OpenMS::ProteinInference& self, nb::dict) { return OpenMS::ProteinInference(self); }, "memo"_a)
    .def(
      "infer",
      [](OpenMS::ProteinInference& self, OpenMS::ConsensusMap& consensus_map, unsigned int reference_map) {
        return self.infer(consensus_map, reference_map);
      },
      "consensus_map"_a, "reference_map"_a);
...
score types and provides utility methods for score type conversion, comparison, and lookup.
                        ...
                        .def(
                          "__deepcopy__", [](const OpenMS::Scores& self, nb::dict) { return OpenMS::Scores(self); }, "memo"_a)
                        ...
                        .def_static("getAllIDScoreNames", &OpenMS::Scores::getAllIDScoreNames, "Get a vector of all ID score names used in OpenMS")
...
params.select_transition_group = False
    ...
    .def(
      "__deepcopy__",
      [](const OpenMS::MRMFeatureSelector::SelectorParameters& self, nb::dict) { return OpenMS::MRMFeatureSelector::SelectorParameters(self); },
      "memo"_a)
  ...
  nb::class_<OpenMS::SiriusMSFile::AccessionInfo>(m, "SiriusMSFile_AccessionInfo", "OpenMS class SiriusMSFile_AccessionInfo")
    ...
    .def(
      "__deepcopy__", [](const OpenMS::SiriusMSFile::AccessionInfo& self, nb::dict) { return OpenMS::SiriusMSFile::AccessionInfo(self); }, "memo"_a)
  ...
  nb::class_<OpenMS::SiriusMSFile::CompoundInfo>(m, "SiriusMSFile_CompoundInfo", "OpenMS class SiriusMSFile_CompoundInfo")
    ...
    .def(
      "__deepcopy__", [](const OpenMS::SiriusMSFile::CompoundInfo& self, nb::dict) { return OpenMS::SiriusMSFile::CompoundInfo(self); }, "memo"_a)
  ...
  nb::class_<OpenMS::SpectralMatch>(m, "SpectralMatch", "OpenMS class SpectralMatch")
    ...
    .def(
      "__deepcopy__", [](const OpenMS::SpectralMatch& self, nb::dict) { return OpenMS::SpectralMatch(self); }, "memo"_a)
...
a header and will be skipped. *
    ...
    .def(
      "__deepcopy__", [](const OpenMS::SwathWindowLoader& self, nb::dict) { return OpenMS::SwathWindowLoader(self); }, "memo"_a)
    .def_static(
      "annotateSwathMapsFromFile",
      [](const OpenMS::String& filename, std::vector<OpenSwath::SwathMap> swath_maps, bool do_sort, bool force) {
    ...
    .def_static(
      ...
      [](const OpenMS::String& filename) {
        ...
        OpenMS::SwathWindowLoader::readSwathWindows(filename, swath_prec_lower, swath_prec_upper);
        return std::make_tuple(swath_prec_lower, swath_prec_upper);
      },
      "filename"_a);
...
production ions
    ...
    .def(
      "__deepcopy__", [](const OpenMS::TargetedExperiment& self, nb::dict) { return OpenMS::TargetedExperiment(self); }, "memo"_a)
    .def(nb::self == nb::self)
    .def(nb::self != nb::self)
    .def(nb::self + nb::self)
    .def(
      "clear", [](OpenMS::TargetedExperiment& self, bool clear_meta_data) { return self.clear(clear_meta_data); }, "clear_meta_data"_a)
    .def(
      "setCVs", [](OpenMS::TargetedExperiment& self, const std::vector<OpenMS::TargetedExperimentHelper::CV>& cvs) { return self.setCVs(cvs); },
      "cvs"_a)
    .def(
      "getCVs", [](const OpenMS::TargetedExperiment& self) -> const std::vector<OpenMS::TargetedExperimentHelper::CV>& { return self.getCVs(); },
      nb::rv_policy::reference_internal)
    .def(
      "addCV", [](OpenMS::TargetedExperiment& self, const OpenMS::TargetedExperimentHelper::CV& cv) { return self.addCV(cv); }, "cv"_a)
    .def(
      "setTargetCVTerms", [](OpenMS::TargetedExperiment& self, const OpenMS::CVTermList& cv_terms) { return self.setTargetCVTerms(cv_terms); },
      "cv_terms"_a)
    .def(
      "getTargetCVTerms", [](const OpenMS::TargetedExperiment& self) -> const OpenMS::CVTermList& { return self.getTargetCVTerms(); },
      nb::rv_policy::reference_internal)
    .def(
      "addTargetCVTerm", [](OpenMS::TargetedExperiment& self, const OpenMS::CVTerm& cv_term) { return self.addTargetCVTerm(cv_term); }, "cv_term"_a)
    .def(
      "setTargetMetaValue",
      [](OpenMS::TargetedExperiment& self, const OpenMS::String& name, const OpenMS::DataValue& value) {
        return self.setTargetMetaValue(name, value);
      },
      "name"_a, "value"_a)
    .def(
      "setContacts",
      [](OpenMS::TargetedExperiment& self, const std::vector<OpenMS::TargetedExperimentHelper::Contact>& contacts) {
        return self.setContacts(contacts);
      },
      "contacts"_a)
    .def(
      "getContacts",
      [](const OpenMS::TargetedExperiment& self) -> const std::vector<OpenMS::TargetedExperimentHelper::Contact>& { return self.getContacts(); },
      nb::rv_policy::reference_internal)
    .def(
      "addContact",
      [](OpenMS::TargetedExperiment& self, const OpenMS::TargetedExperimentHelper::Contact& contact) { return self.addContact(contact); },
      "contact"_a)
    .def(
      "setPublications",
      [](OpenMS::TargetedExperiment& self, const std::vector<OpenMS::TargetedExperimentHelper::Publication>& publications) {
        return self.setPublications(publications);
      },
      "publications"_a)
    .def(
      "getPublications",
      [](const OpenMS::TargetedExperiment& self) -> const std::vector<OpenMS::TargetedExperimentHelper::Publication>& {
        return self.getPublications();
      },
      nb::rv_policy::reference_internal)
    .def(
      "addPublication",
      [](OpenMS::TargetedExperiment& self, const OpenMS::TargetedExperimentHelper::Publication& publication) {
        return self.addPublication(publication);
      },
      "publication"_a)
    .def(
      "setInstruments",
      [](OpenMS::TargetedExperiment& self, const std::vector<OpenMS::TargetedExperimentHelper::Instrument>& instruments) {
        return self.setInstruments(instruments);
      },
      "instruments"_a)
    .def(
      "getInstruments",
      [](const OpenMS::TargetedExperiment& self) -> const std::vector<OpenMS::TargetedExperimentHelper::Instrument>& {
        return self.getInstruments();
      },
      nb::rv_policy::reference_internal)
    .def(
      "addInstrument",
      [](OpenMS::TargetedExperiment& self, const OpenMS::TargetedExperimentHelper::Instrument& instrument) { return self.addInstrument(instrument); },
      "instrument"_a)
    .def(
      "setSoftware", [](OpenMS::TargetedExperiment& self, const std::vector<OpenMS::Software>& software) { return self.setSoftware(software); },
      "software"_a)
    .def(
      "getSoftware", [](const OpenMS::TargetedExperiment& self) -> const std::vector<OpenMS::Software>& { return self.getSoftware(); },
      nb::rv_policy::reference_internal)
    .def(
      "addSoftware", [](OpenMS::TargetedExperiment& self, const OpenMS::Software& software) { return self.addSoftware(software); }, "software"_a)
    .def(
      "setProteins",
      [](OpenMS::TargetedExperiment& self, const std::vector<OpenMS::TargetedExperimentHelper::Protein>& proteins) {
        return self.setProteins(proteins);
      },
      "proteins"_a)
    .def(
      "setProteins",
      [](OpenMS::TargetedExperiment& self, std::vector<OpenMS::TargetedExperimentHelper::Protein>& proteins) { return self.setProteins(proteins); },
      "proteins"_a)
    .def(
      "getProteins",
      [](const OpenMS::TargetedExperiment& self) -> const std::vector<OpenMS::TargetedExperimentHelper::Protein>& { return self.getProteins(); },
      nb::rv_policy::reference_internal)
    .def(
      "getProteinByRef",
      [](const OpenMS::TargetedExperiment& self, const OpenMS::String& ref) -> const OpenMS::TargetedExperimentHelper::Protein& {
        return self.getProteinByRef(ref);
      },
      "ref"_a, nb::rv_policy::reference_internal)
    .def(
      "hasProtein", [](const OpenMS::TargetedExperiment& self, const OpenMS::String& ref) { return self.hasProtein(ref); }, "ref"_a)
    .def(
      "addProtein",
      [](OpenMS::TargetedExperiment& self, const OpenMS::TargetedExperimentHelper::Protein& protein) { return self.addProtein(protein); },
      "protein"_a)
    .def(
      "setCompounds",
      [](OpenMS::TargetedExperiment& self, const std::vector<OpenMS::TargetedExperimentHelper::Compound>& rhs) { return self.setCompounds(rhs); },
      "rhs"_a)
    .def(
      "getCompounds",
      [](const OpenMS::TargetedExperiment& self) -> const std::vector<OpenMS::TargetedExperimentHelper::Compound>& { return self.getCompounds(); },
      nb::rv_policy::reference_internal)
    .def(
      "addCompound", [](OpenMS::TargetedExperiment& self, const OpenMS::TargetedExperimentHelper::Compound& rhs) { return self.addCompound(rhs); },
      "rhs"_a)
    .def(
      "setPeptides",
      [](OpenMS::TargetedExperiment& self, const std::vector<OpenMS::TargetedExperimentHelper::Peptide>& rhs) { return self.setPeptides(rhs); },
      "rhs"_a)
    .def(
      "setPeptides",
      [](OpenMS::TargetedExperiment& self, std::vector<OpenMS::TargetedExperimentHelper::Peptide>& rhs) { return self.setPeptides(rhs); }, "rhs"_a)
    .def(
      "getPeptides",
      [](const OpenMS::TargetedExperiment& self) -> const std::vector<OpenMS::TargetedExperimentHelper::Peptide>& { return self.getPeptides(); },
      nb::rv_policy::reference_internal)
    .def(
      "hasPeptide", [](const OpenMS::TargetedExperiment& self, const OpenMS::String& ref) { return self.hasPeptide(ref); }, "ref"_a)
    .def(
      "getPeptideByRef",
      [](const OpenMS::TargetedExperiment& self, const OpenMS::String& ref) -> const OpenMS::TargetedExperimentHelper::Peptide& {
        return self.getPeptideByRef(ref);
      },
      "ref"_a, nb::rv_policy::reference_internal)
    .def(
      "hasCompound", [](const OpenMS::TargetedExperiment& self, const OpenMS::String& ref) { return self.hasCompound(ref); }, "ref"_a)
    .def(
      "getCompoundByRef",
      [](const OpenMS::TargetedExperiment& self, const OpenMS::String& ref) -> const OpenMS::TargetedExperimentHelper::Compound& {
        return self.getCompoundByRef(ref);
      },
      "ref"_a, nb::rv_policy::reference_internal)
    .def(
      "addPeptide", [](OpenMS::TargetedExperiment& self, const OpenMS::TargetedExperimentHelper::Peptide& rhs) { return self.addPeptide(rhs); },
      "rhs"_a)
    .def(
      "setTransitions",
      [](OpenMS::TargetedExperiment& self, const std::vector<OpenMS::ReactionMonitoringTransition>& transitions) {
        return self.setTransitions(transitions);
      },
      "transitions"_a)
    .def(
      "setTransitions",
      [](OpenMS::TargetedExperiment& self, std::vector<OpenMS::ReactionMonitoringTransition>& transitions) {
        return self.setTransitions(transitions);
      },
      "transitions"_a)
    .def(
      "getTransitions",
      [](const OpenMS::TargetedExperiment& self) -> const std::vector<OpenMS::ReactionMonitoringTransition>& { return self.getTransitions(); },
      nb::rv_policy::reference_internal)
    .def(
      "addTransition",
      [](OpenMS::TargetedExperiment& self, const OpenMS::ReactionMonitoringTransition& transition) { return self.addTransition(transition); },
      "transition"_a)
    .def(
      "setIncludeTargets",
      [](OpenMS::TargetedExperiment& self, const std::vector<OpenMS::IncludeExcludeTarget>& targets) { return self.setIncludeTargets(targets); },
      "targets"_a)
    .def(
      "getIncludeTargets",
      [](const OpenMS::TargetedExperiment& self) -> const std::vector<OpenMS::IncludeExcludeTarget>& { return self.getIncludeTargets(); },
      nb::rv_policy::reference_internal)
    .def(
      "addIncludeTarget", [](OpenMS::TargetedExperiment& self, const OpenMS::IncludeExcludeTarget& target) { return self.addIncludeTarget(target); },
      "target"_a)
    .def(
      "setExcludeTargets",
      [](OpenMS::TargetedExperiment& self, const std::vector<OpenMS::IncludeExcludeTarget>& targets) { return self.setExcludeTargets(targets); },
      "targets"_a)
    .def(
      "getExcludeTargets",
      [](const OpenMS::TargetedExperiment& self) -> const std::vector<OpenMS::IncludeExcludeTarget>& { return self.getExcludeTargets(); },
      nb::rv_policy::reference_internal)
    .def(
      "addExcludeTarget", [](OpenMS::TargetedExperiment& self, const OpenMS::IncludeExcludeTarget& target) { return self.addExcludeTarget(target); },
      "target"_a)
    .def(
      "setSourceFiles",
      [](OpenMS::TargetedExperiment& self, const std::vector<OpenMS::SourceFile>& source_files) { return self.setSourceFiles(source_files); },
      "source_files"_a)
    .def(
      "getSourceFiles", [](const OpenMS::TargetedExperiment& self) -> const std::vector<OpenMS::SourceFile>& { return self.getSourceFiles(); },
      nb::rv_policy::reference_internal)
    .def(
      "addSourceFile", [](OpenMS::TargetedExperiment& self, const OpenMS::SourceFile& source_file) { return self.addSourceFile(source_file); },
      "source_file"_a)
    ...
    .def(
      "__iadd__",
      [](OpenMS::TargetedExperiment& self, const OpenMS::TargetedExperiment& rhs) -> OpenMS::
                                                                                    TargetedExperiment& {
                                                                                      self += rhs;
                                                                                      return self;
                                                                                    },
  ...
  nb::class_<OpenMS::TransformationModel::DataPoint>(m, "TransformationModel_DataPoint",
    ...
    .def(
      "__deepcopy__", [](const OpenMS::TransformationModel::DataPoint& self, nb::dict) { return OpenMS::TransformationModel::DataPoint(self); },
      "memo"_a)
  ...
  nb::class_<OpenMS::TransformationDescription::TransformationStatistics>(m, "TransformationStatistics",
    ...
    .def("__copy__",
         [](const OpenMS::TransformationDescription::TransformationStatistics& self) {
           return OpenMS::TransformationDescription::TransformationStatistics(self);
         })
    .def(
      "__deepcopy__",
      [](const OpenMS::TransformationDescription::TransformationStatistics& self, nb::dict) {
        return OpenMS::TransformationDescription::TransformationStatistics(self);
      },
      "memo"_a)
  ...
  nb::class_<OpenMS::TransformationDescription>(m, "TransformationDescription", "Generic description of a coordinate transformation")
    ...
    .def(
      "__deepcopy__", [](const OpenMS::TransformationDescription& self, nb::dict) { return OpenMS::TransformationDescription(self); }, "memo"_a)
    .def(
      "getModelType", [](const OpenMS::TransformationDescription& self) { return self.getModelType(); }, "Gets the type of the fitted model")
    .def(
      "getModelParameters", [](const OpenMS::TransformationDescription& self) -> const OpenMS::Param& { return self.getModelParameters(); },
      nb::rv_policy::reference_internal, "Returns the model parameters")
    .def(
      "invert", [](OpenMS::TransformationDescription& self) { return self.invert(); }, "Computes an (approximate) inverse of the transformation")
    .def(
      "getDeviations",
      [](const OpenMS::TransformationDescription& self, bool do_apply, bool do_sort) {
        std::vector<double> diffs;
        self.getDeviations(diffs, do_apply, do_sort);
        return diffs;
      },
      "do_apply"_a = false, "do_sort"_a = true)
    .def(
      "getStatistics", [](const OpenMS::TransformationDescription& self) { return self.getStatistics(); },
      R"doc(
...
:param do_sort: Sort `diffs` before returning?
    ...
    .def(
      "getDataPoints", [](const OpenMS::TransformationDescription& self) { return self.getDataPoints(); },
      "Get the data points used for the transformation")

    .def(
      "setDataPoints",
      [](OpenMS::TransformationDescription& self, const std::vector<std::pair<double, double>>& data) {
    ...
    .def(
      "setDataPoints",
      [](OpenMS::TransformationDescription& self, const std::vector<OpenMS::TransformationModel::DataPoint>& data) { self.setDataPoints(data); },
      "data"_a, "Set the data points for the transformation (from DataPoint objects)")

    .def(
      "apply", [](const OpenMS::TransformationDescription& self, double value) { return self.apply(value); }, "value"_a,
      "Apply the transformation to a value")

    .def(
      "fitModel",
      [](OpenMS::TransformationDescription& self, const OpenMS::String& model_type, const OpenMS::Param& params) {
...
TransformationModel
    ...
    .def(
      "evaluate", [](const OpenMS::TransformationModelLinear& self, double value) { return self.evaluate(value); }, "value"_a)
    .def("invert", [](OpenMS::TransformationModelLinear& self) { return self.invert(); })
    .def(
      "weightData",
      [](OpenMS::TransformationModelLinear& self, std::vector<OpenMS::TransformationModel::DataPoint> data) {
    ...
    .def(
      "checkValidWeight",
      [](const OpenMS::TransformationModelLinear& self, const OpenMS::String& weight, const std::vector<OpenMS::String>& valid_weights) {
        return self.checkValidWeight(weight, valid_weights);
      },
      "weight"_a, "valid_weights"_a, "Check for a valid weighting function string")
    .def(
      "checkDatumRange",
      [](OpenMS::TransformationModelLinear& self, const double& datum, const double& datum_min, const double& datum_max) {
        return self.checkDatumRange(datum, datum_min, datum_max);
      },
      "datum"_a, "datum_min"_a, "datum_max"_a, "Check that the datum is within the valid min and max bounds")
    .def(
      "weightDatum",
      [](const OpenMS::TransformationModelLinear& self, const double& datum, const OpenMS::String& weight) {
        return self.weightDatum(datum, weight);
      },
      "datum"_a, "weight"_a, "Weight the data according to the weighting function")
    .def(
      "unWeightDatum",
      [](const OpenMS::TransformationModelLinear& self, const double& datum, const OpenMS::String& weight) {
        return self.unWeightDatum(datum, weight);
      },
      "datum"_a, "weight"_a, "Apply the reverse of the weighting function to the data")
    .def(
      "getValidXWeights", [](const OpenMS::TransformationModelLinear& self) { return self.getValidXWeights(); },
      "Returns a list of valid x weight function stringss")
    .def(
      "getValidYWeights", [](const OpenMS::TransformationModelLinear& self) { return self.getValidYWeights(); },
      "Returns a list of valid y weight function strings")
    .def(
      "getParameters", [](const OpenMS::TransformationModelLinear& self) -> const OpenMS::Param& { return self.getParameters(); },
      nb::rv_policy::reference_internal, "Gets the (actual) parameters")

    .def_static(
      "getDefaultParameters", [](OpenMS::Param& params) { OpenMS::TransformationModelLinear::getDefaultParameters(params); }, "params"_a,
...
cross-linked peptides from large sequence databases")
    ...
    .def(
      "__deepcopy__", [](const OpenMS::XQuestScores& self, nb::dict) { return OpenMS::XQuestScores(self); }, "memo"_a)
    .def_static(
      "preScore",
      [](size_t matched_alpha, size_t ions_alpha, size_t matched_beta, size_t ions_beta) {
        return OpenMS::XQuestScores::preScore(matched_alpha, ions_alpha, matched_beta, ions_beta);
      },
      "matched_alpha"_a, "ions_alpha"_a, "matched_beta"_a, "ions_beta"_a)
    .def_static(
      "preScore", [](size_t matched_alpha, size_t ions_alpha) { return OpenMS::XQuestScores::preScore(matched_alpha, ions_alpha); },
      "matched_alpha"_a, "ions_alpha"_a,
      R"doc(
...
:param ions_beta: Number of theoretical ions from the beta peptide
    ...
    .def_static(
      "matchOddsScore",
      [](const OpenMS::MSSpectrum& theoretical_spec, size_t matched_size, double fragment_mass_tolerance, bool fragment_mass_tolerance_unit_ppm,
         bool is_xlink_spectrum, size_t n_charges) {
        return OpenMS::XQuestScores::matchOddsScore(theoretical_spec, matched_size, fragment_mass_tolerance, fragment_mass_tolerance_unit_ppm,
                                                    is_xlink_spectrum, n_charges);
      },
      "theoretical_spec"_a, "matched_size"_a, "fragment_mass_tolerance"_a, "fragment_mass_tolerance_unit_ppm"_a, "is_xlink_spectrum"_a, "n_charges"_a,
      R"doc(
...
:param ions_alpha: Number of theoretical ions from the alpha peptide
    ...
    .def_static(
      "logOccupancyProb",
      [](const OpenMS::MSSpectrum& theoretical_spec, size_t matched_size, double fragment_mass_tolerance, bool fragment_mass_tolerance_unit_ppm) {
        return OpenMS::XQuestScores::logOccupancyProb(theoretical_spec, matched_size, fragment_mass_tolerance, fragment_mass_tolerance_unit_ppm);
      },
...
:param n_charges: Number of considered charges in the theoretical spectrum
    ...
    .def_static(
      ...
      [](size_t alpha_size, size_t beta_size, double intsum_alpha, double intsum_beta, double total_current, bool type_is_cross_link) {
        return OpenMS::XQuestScores::weightedTICScoreXQuest(alpha_size, beta_size, intsum_alpha, intsum_beta, total_current, type_is_cross_link);
      },
      "alpha_size"_a, "beta_size"_a, "intsum_alpha"_a, "intsum_beta"_a, "total_current"_a, "type_is_cross_link"_a,
      R"doc(
...
:param fragment_mass_tolerance_unit: The tolerance unit of the alignment, true = ppm, false = Da
    ...
    .def_static(
      "weightedTICScore",
      [](size_t alpha_size, size_t beta_size, double intsum_alpha, double intsum_beta, double total_current, bool type_is_cross_link) {
        return OpenMS::XQuestScores::weightedTICScore(alpha_size, beta_size, intsum_alpha, intsum_beta, total_current, type_is_cross_link);
      },
      "alpha_size"_a, "beta_size"_a, "intsum_alpha"_a, "intsum_beta"_a, "total_current"_a, "type_is_cross_link"_a)
    .def_static(
      "xCorrelation",
      [](const OpenMS::MSSpectrum& spec1, const OpenMS::MSSpectrum& spec2, int maxshift, double tolerance) {
        return OpenMS::XQuestScores::xCorrelation(spec1, spec2, maxshift, tolerance);
      },
      "spec1"_a, "spec2"_a, "maxshift"_a, "tolerance"_a)
    .def_static(
      "xCorrelationPrescore",
      [](const OpenMS::MSSpectrum& spec1, const OpenMS::MSSpectrum& spec2, double tolerance) {
        return OpenMS::XQuestScores::xCorrelationPrescore(spec1, spec2, tolerance);
      },
      "spec1"_a, "spec2"_a, "tolerance"_a)
    .def_static(
      "matchedCurrentChain",
      [](const std::vector<std::pair<size_t, size_t>>& matched_spec_linear, const std::vector<std::pair<size_t, size_t>>& matched_spec_xlinks,
         const OpenMS::MSSpectrum& spectrum_linear_peaks, const OpenMS::MSSpectrum& spectrum_xlink_peaks) {
        return OpenMS::XQuestScores::matchedCurrentChain(matched_spec_linear, matched_spec_xlinks, spectrum_linear_peaks, spectrum_xlink_peaks);
      },
      "matched_spec_linear"_a, "matched_spec_xlinks"_a, "spectrum_linear_peaks"_a, "spectrum_xlink_peaks"_a,
      "Computes sum of peak intensities of matched peaks for either alpha or beta peptide")
    .def_static(
      "totalMatchedCurrent",
      [](const std::vector<std::pair<size_t, size_t>>& matched_spec_linear_alpha,
         const std::vector<std::pair<size_t, size_t>>& matched_spec_linear_beta,
         const std::vector<std::pair<size_t, size_t>>& matched_spec_xlinks_alpha,
         const std::vector<std::pair<size_t, size_t>>& matched_spec_xlinks_beta, const OpenMS::MSSpectrum& spectrum_linear_peaks,
         const OpenMS::MSSpectrum& spectrum_xlink_peaks) {
        return OpenMS::XQuestScores::totalMatchedCurrent(matched_spec_linear_alpha, matched_spec_linear_beta, matched_spec_xlinks_alpha,
                                                         matched_spec_xlinks_beta, spectrum_linear_peaks, spectrum_xlink_peaks);
      },
      "matched_spec_linear_alpha"_a, "matched_spec_linear_beta"_a, "matched_spec_xlinks_alpha"_a, "matched_spec_xlinks_beta"_a,
      "spectrum_linear_peaks"_a, "spectrum_xlink_peaks"_a, "Computes sum of peak intensities of all matched peaks");
  ...
  nb::class_<OSBDA>(m, "OSBinaryDataArray", "OpenMS class OSBinaryDataArray")
    ...
    .def(
      "__deepcopy__", [](const OSBDA& self, nb::dict) { return OSBDA(self); }, "memo"_a)
    .def_rw("data", &OSBDA::data)
    .def_rw("description", &OSBDA::description)
    .def(
      "get_data", [](const OSBDA& self) { return self.data; }, "Access to a copy of the underlying data")
    .def(
      "get_data_view",
  ...
  nb::class_<OpenSwath::OSSpectrumMeta>(m, "OSSpectrumMeta", "Identifying information for a spectrum")
    ...
    .def(
      "__deepcopy__", [](const OpenSwath::OSSpectrumMeta& self, nb::dict) { return OpenSwath::OSSpectrumMeta(self); }, "memo"_a)
  ...
  // -----------------------------------------------------------------------
  nb::class_<OpenMS::ChromExtractParams>(m, "OSW_ChromExtractParams", "Parameters for chromatogram extraction in OpenSWATH workflow")
    .def(nb::init<>())
    .def("__copy__", [](const OpenMS::ChromExtractParams& self) { return OpenMS::ChromExtractParams(self); })
    .def(
      "__deepcopy__", [](const OpenMS::ChromExtractParams& self, nb::dict) { return OpenMS::ChromExtractParams(self); }, "memo"_a)
  ...
  nb::class_<OpenSwath::OSChromatogramMeta>(m, "OSChromatogramMeta", "Identifying information for a chromatogram")
    ...
    .def(
      "__deepcopy__", [](const OpenSwath::OSChromatogramMeta& self, nb::dict) { return OpenSwath::OSChromatogramMeta(self); }, "memo"_a)
  ...
  nb::class_<OSSpec>(m, "OSSpectrum", "OpenMS class OSSpectrum")
    ...
    .def(
      "__deepcopy__", [](const OSSpec& self, nb::dict) { return OSSpec(self); }, "memo"_a)
    ...
    .def(
      "set_mz_array",
      [](OSSpec& self, std::vector<double> data) {
    ...
    .def(
      "set_data_arrays",
      [](OSSpec& self, std::vector<std::shared_ptr<OSBDA>> arrays) {
  ...
  nb::class_<OSChrom>(m, "OSChromatogram", "OpenMS class OSChromatogram")
    ...
    .def(
      "__deepcopy__", [](const OSChrom& self, nb::dict) { return OSChrom(self); }, "memo"_a)
    ...
    .def(
      "set_time_array",
      [](OSChrom& self, std::vector<double> data) {
    ...
    .def(
      "set_data_arrays",
      [](OSChrom& self, std::vector<std::shared_ptr<OSBDA_C>> arrays) {
  ...
  nb::class_<ICI>(m, "IsobaricChannelInformation", "OpenMS class IsobaricChannelInformation")
    .def(
      "__init__",
      [](ICI* self, const std::string& name, int id, const std::string& description, double center, std::vector<int> affected_channels) {
    ...
    .def(
      "__deepcopy__", [](const ICI& self, nb::dict) { return ICI(self); }, "memo"_a)
  ...
  nb::class_<OpenMS::TransformationModelBSpline>(m, "TransformationModelBSpline", "B-spline model for transformations")
    ...
    .def(
      "evaluate", [](const OpenMS::TransformationModelBSpline& self, double value) { return self.evaluate(value); }, "value"_a)
    .def(
      "getParameters", [](const OpenMS::TransformationModelBSpline& self) -> const OpenMS::Param& { return self.getParameters(); },
      nb::rv_policy::reference_internal, "Gets the (actual) parameters")
    .def(
      "weightData",
      [](OpenMS::TransformationModelBSpline& self, std::vector<OpenMS::TransformationModel::DataPoint> data) {
        self.weightData(data);
        return data;
      },
      "data"_a, "Weight the data by the given weight function, returns weighted data")
    ...
    .def(
      "checkValidWeight",
      [](const OpenMS::TransformationModelBSpline& self, const OpenMS::String& weight, const std::vector<OpenMS::String>& valid_weights) {
        return self.checkValidWeight(weight, valid_weights);
      },
      "weight"_a, "valid_weights"_a, "Check for a valid weighting function string")
    .def(
      "checkDatumRange",
      [](OpenMS::TransformationModelBSpline& self, const double& datum, const double& datum_min, const double& datum_max) {
        return self.checkDatumRange(datum, datum_min, datum_max);
      },
      "datum"_a, "datum_min"_a, "datum_max"_a, "Check that the datum is within the valid min and max bounds")
    .def(
      "weightDatum",
      [](const OpenMS::TransformationModelBSpline& self, const double& datum, const OpenMS::String& weight) {
        return self.weightDatum(datum, weight);
      },
      "datum"_a, "weight"_a, "Weight the data according to the weighting function")
    .def(
      ...
      "datum"_a, "weight"_a, "Apply the reverse of the weighting function to the data")
    .def(
      "getValidXWeights", [](const OpenMS::TransformationModelBSpline& self) { return self.getValidXWeights(); },
      "Returns a list of valid x weight function strings")
    .def(
      "getValidYWeights", [](const OpenMS::TransformationModelBSpline& self) { return self.getValidYWeights(); },
      "Returns a list of valid y weight function strings")
    .def_static(
      "getDefaultParameters", [](OpenMS::Param& params) { OpenMS::TransformationModelBSpline::getDefaultParameters(params); }, "params"_a,
      "Get default parameters");
  ...
  nb::class_<OpenMS::TransformationModelLowess>(m, "TransformationModelLowess", "Lowess model for transformations")
    .def(nb::init<const std::vector<OpenMS::TransformationModel::DataPoint>&, const OpenMS::Param&>(), "data"_a, "params"_a)
    .def(
      "evaluate", [](const OpenMS::TransformationModelLowess& self, double value) { return self.evaluate(value); }, "value"_a)
    .def(
      "getParameters", [](const OpenMS::TransformationModelLowess& self) -> const OpenMS::Param& { return self.getParameters(); },
      nb::rv_policy::reference_internal, "Gets the (actual) parameters")
    .def(
      "weightData",
      [](OpenMS::TransformationModelLowess& self, std::vector<OpenMS::TransformationModel::DataPoint> data) {
        self.weightData(data);
        return data;
      },
      "data"_a, "Weight the data by the given weight function, returns weighted data")
    ...
    .def(
      "checkValidWeight",
      [](const OpenMS::TransformationModelLowess& self, const OpenMS::String& weight, const std::vector<OpenMS::String>& valid_weights) {
        return self.checkValidWeight(weight, valid_weights);
      },
      "weight"_a, "valid_weights"_a, "Check for a valid weighting function string")
    .def(
      "checkDatumRange",
      [](OpenMS::TransformationModelLowess& self, const double& datum, const double& datum_min, const double& datum_max) {
        return self.checkDatumRange(datum, datum_min, datum_max);
      },
      "datum"_a, "datum_min"_a, "datum_max"_a, "Check that the datum is within the valid min and max bounds")
    .def(
      "weightDatum",
      [](const OpenMS::TransformationModelLowess& self, const double& datum, const OpenMS::String& weight) {
        return self.weightDatum(datum, weight);
      },
      "datum"_a, "weight"_a, "Weight the data according to the weighting function")
    .def(
      ...
      "datum"_a, "weight"_a, "Apply the reverse of the weighting function to the data")
    .def(
      "getValidXWeights", [](const OpenMS::TransformationModelLowess& self) { return self.getValidXWeights(); },
      "Returns a list of valid x weight function strings")
    .def(
      "getValidYWeights", [](const OpenMS::TransformationModelLowess& self) { return self.getValidYWeights(); },
      "Returns a list of valid y weight function strings")
    .def_static(
      "getDefaultParameters", [](OpenMS::Param& params) { OpenMS::TransformationModelLowess::getDefaultParameters(params); }, "params"_a,
      "Get default parameters");
  ...
  nb::class_<OpenMS::IsobaricNormalizer>(m, "IsobaricNormalizer", "OpenMS class IsobaricNormalizer")
    ...
    .def(
      "__deepcopy__", [](const OpenMS::IsobaricNormalizer& self, nb::dict) { return OpenMS::IsobaricNormalizer(self); }, "memo"_a)
  ...
  nb::class_<OpenMS::SpectrumAccessOpenMS>(m, "SpectrumAccessOpenMS", "OpenMS class SpectrumAccessOpenMS")
    ...
    .def(
      "__deepcopy__", [](const OpenMS::SpectrumAccessOpenMS& self, nb::dict) { return OpenMS::SpectrumAccessOpenMS(self); }, "memo"_a)
    .def(nb::init<std::shared_ptr<OpenMS::MSExperiment>>(), "ms_experiment"_a)
    .def(
      "getNrSpectra", [](const OpenMS::SpectrumAccessOpenMS& self) { return self.getNrSpectra(); }, "Get number of spectra")
    .def(
      "getNrChromatograms", [](const OpenMS::SpectrumAccessOpenMS& self) { return self.getNrChromatograms(); }, "Get number of chromatograms")
    .def(
      "getSpectrumById", [](OpenMS::SpectrumAccessOpenMS& self, int id) { return self.getSpectrumById(id); }, "id"_a, "Get spectrum by index")
    .def(
      "getChromatogramById", [](OpenMS::SpectrumAccessOpenMS& self, int id) { return self.getChromatogramById(id); }, "id"_a,
      "Get chromatogram by index")
    .def(
      "getChromatogramNativeID", [](const OpenMS::SpectrumAccessOpenMS& self, int id) { return self.getChromatogramNativeID(id); }, "id"_a,
      "Returns the native ID of the chromatogram")
    .def(
      "getSpectraByRT", [](const OpenMS::SpectrumAccessOpenMS& self, double RT, double deltaRT) { return self.getSpectraByRT(RT, deltaRT); }, "RT"_a,
      "deltaRT"_a, "Returns spectra indices within RT range");
  ...
  nb::class_<OpenMS::SpectrumAccessOpenMSInMemory>(m, "SpectrumAccessOpenMSInMemory", "OpenMS class SpectrumAccessOpenMSInMemory")
    ...
    .def(
      "__deepcopy__", [](const OpenMS::SpectrumAccessOpenMSInMemory& self, nb::dict) { return OpenMS::SpectrumAccessOpenMSInMemory(self); }, "memo"_a)
    .def(
      "__init__",
      [](OpenMS::SpectrumAccessOpenMSInMemory* self, OpenMS::SpectrumAccessOpenMS& other) { new (self) OpenMS::SpectrumAccessOpenMSInMemory(other); },
      "other"_a)
    ...
    .def(
      "getSpectrumById", [](OpenMS::SpectrumAccessOpenMSInMemory& self, int id) { return self.getSpectrumById(id); }, "id"_a, "Get spectrum by index")
    .def(
      "getChromatogramById", [](OpenMS::SpectrumAccessOpenMSInMemory& self, int id) { return self.getChromatogramById(id); }, "id"_a,
      "Get chromatogram by index")
    .def(
      "getChromatogramNativeID", [](const OpenMS::SpectrumAccessOpenMSInMemory& self, int id) { return self.getChromatogramNativeID(id); }, "id"_a,
      "Returns the native ID of the chromatogram")
    .def(
      "getSpectraByRT", [](const OpenMS::SpectrumAccessOpenMSInMemory& self, double RT, double deltaRT) { return self.getSpectraByRT(RT, deltaRT); },
      "RT"_a, "deltaRT"_a, "Returns spectra indices within RT range");
  ...
  nb::class_<OpenSwath::SwathMap>(m, "SwathMap", "OpenMS class SwathMap")
    ...
    .def(
      "__deepcopy__", [](const OpenSwath::SwathMap& self, nb::dict) { return OpenSwath::SwathMap(self); }, "memo"_a)
    ...
    .def(
      "setSpectrumPtr", [](OpenSwath::SwathMap& self, std::shared_ptr<OpenMS::SpectrumAccessOpenMS> sa) { self.sptr = sa; }, "spectrum_access"_a,
      "Set spectrum access pointer (SpectrumAccessOpenMS)")
    .def(
      "setSpectrumPtr", [](OpenSwath::SwathMap& self, std::shared_ptr<OpenMS::SpectrumAccessOpenMSInMemory> sa) { self.sptr = sa; },
      "spectrum_access"_a, "Set spectrum access pointer (SpectrumAccessOpenMSInMemory)")
    .def(
      "getSpectrumPtr",
      [](OpenSwath::SwathMap& self) -> nb::object {
  ...
  nb::class_<OpenMS::OpenSwathScoring>(m, "OpenSwathScoring", "OpenMS class OpenSwathScoring")
    ...
    .def(
      "__deepcopy__", [](const OpenMS::OpenSwathScoring& self, nb::dict) { return OpenMS::OpenSwathScoring(self); }, "memo"_a)
    .def("initialize", &OpenMS::OpenSwathScoring::initialize, "rt_normalization_factor"_a, "add_up_spectra"_a, "spacing_for_spectra_resampling"_a,
         "merge_spectra_by_peak_width_fraction"_a, "drift_extra"_a, "su"_a, "spectrum_addition_method"_a, "spectrum_merge_method_type"_a,
         "use_ms1_ion_mobility"_a, "apply_im_peak_picking"_a);
...
TransformationModel
    ...
    .def(nb::init<const std::vector<OpenMS::TransformationModel::DataPoint>&, const OpenMS::Param&>(), "data"_a, "params"_a)
    .def(
      "evaluate", [](const OpenMS::TransformationModelInterpolated& self, double value) { return self.evaluate(value); }, "value"_a)
    .def(
      "getParameters", [](const OpenMS::TransformationModelInterpolated& self) -> const OpenMS::Param& { return self.getParameters(); },
      nb::rv_policy::reference_internal, "Gets the (actual) parameters")
    .def(
      "weightData",
      [](OpenMS::TransformationModelInterpolated& self, std::vector<OpenMS::TransformationModel::DataPoint> data) {
        self.weightData(data);
        return data;
      },
      "data"_a, "Weight the data by the given weight function, returns weighted data")
    ...
    .def(
      "checkValidWeight",
      [](const OpenMS::TransformationModelInterpolated& self, const OpenMS::String& weight, const std::vector<OpenMS::String>& valid_weights) {
        return self.checkValidWeight(weight, valid_weights);
      },
      "weight"_a, "valid_weights"_a, "Check for a valid weighting function string")
    .def(
      "checkDatumRange",
      [](OpenMS::TransformationModelInterpolated& self, const double& datum, const double& datum_min, const double& datum_max) {
        return self.checkDatumRange(datum, datum_min, datum_max);
      },
      "datum"_a, "datum_min"_a, "datum_max"_a, "Check that the datum is within the valid min and max bounds")
    .def(
      "weightDatum",
      [](const OpenMS::TransformationModelInterpolated& self, const double& datum, const OpenMS::String& weight) {
        return self.weightDatum(datum, weight);
      },
      "datum"_a, "weight"_a, "Weight the data according to the weighting function")
    .def(
      ...
      "datum"_a, "weight"_a, "Apply the reverse of the weighting function to the data")
    .def(
      "getValidXWeights", [](const OpenMS::TransformationModelInterpolated& self) { return self.getValidXWeights(); },
      "Returns a list of valid x weight function strings")
    .def(
      "getValidYWeights", [](const OpenMS::TransformationModelInterpolated& self) { return self.getValidYWeights(); },
      "Returns a list of valid y weight function strings")
    .def_static(
  ...
  // ILPDCWrapper
  // -----------------------------------------------------------------------
  nb::class_<OpenMS::ILPDCWrapper>(m, "ILPDCWrapper", "Integer linear programming wrapper for decharging")
    .def(nb::init<>())
    .def(
      "compute",
      [](const OpenMS::ILPDCWrapper& self, const OpenMS::FeatureMap& fm, std::vector<OpenMS::ChargePair>& pairs, OpenMS::Size verbose_level) {
