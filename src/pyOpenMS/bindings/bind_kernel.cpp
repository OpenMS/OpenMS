...
NB_MODULE(_pyopenms_kernel, m) {
    ...
    nb::class_<OpenMS::BinnedSpectrum>(m, "BinnedSpectrum", "This is a binned representation of a PeakSpectrum")
        ...
        .def("getBinLowerMZ", [](const OpenMS::BinnedSpectrum& self, unsigned long i) { return self.getBinLowerMZ(i); }, "i"_a, "Returns the lower m/z of a bin given its index")
    ...
    nb::class_<OpenMS::ChromatogramPeak>(m, "ChromatogramPeak", "A 1-dimensional raw data point or peak for chromatograms")
        ...
        .def(nb::init<OpenMS::DPosition<1>, double>())
        .def("getIntensity", [](const OpenMS::ChromatogramPeak& self) { return self.getIntensity(); }, "Returns the intensity")
        .def("setIntensity", [](OpenMS::ChromatogramPeak& self, double intensity) { return self.setIntensity(intensity); }, "intensity"_a, "Sets the intensity")
...
- RangeMZ is the third parameter
    ...
    nb::class_<OpenMS::MRMTransitionGroup<OpenMS::MSChromatogram, OpenMS::ReactionMonitoringTransition>>(m, "MRMTransitionGroupCP", "OpenMS class MRMTransitionGroupCP")
        ...
        .def("getTransitionsMuteable", [](OpenMS::MRMTransitionGroup<OpenMS::MSChromatogram, OpenMS::ReactionMonitoringTransition>& self) { return self.getTransitionsMuteable(); })
        ...
        .def("getChromatograms", [](OpenMS::MRMTransitionGroup<OpenMS::MSChromatogram, OpenMS::ReactionMonitoringTransition>& self) { return self.getChromatograms(); })
        ...
        .def("getPrecursorChromatograms", [](OpenMS::MRMTransitionGroup<OpenMS::MSChromatogram, OpenMS::ReactionMonitoringTransition>& self) { return self.getPrecursorChromatograms(); })
        ...
        .def("getFeaturesMuteable", [](OpenMS::MRMTransitionGroup<OpenMS::MSChromatogram, OpenMS::ReactionMonitoringTransition>& self) { return self.getFeaturesMuteable(); })
    ...
    nb::class_<OpenMS::MRMTransitionGroup<OpenMS::MSChromatogram, OpenSwath::LightTransition>>(m, "LightMRMTransitionGroupCP", "OpenMS class LightMRMTransitionGroupCP")
        ...
        .def("getTransitionsMuteable", [](OpenMS::MRMTransitionGroup<OpenMS::MSChromatogram, OpenSwath::LightTransition>& self) { return self.getTransitionsMuteable(); })
        ...
        .def("getChromatograms", [](OpenMS::MRMTransitionGroup<OpenMS::MSChromatogram, OpenSwath::LightTransition>& self) { return self.getChromatograms(); })
        ...
        .def("getPrecursorChromatograms", [](OpenMS::MRMTransitionGroup<OpenMS::MSChromatogram, OpenSwath::LightTransition>& self) { return self.getPrecursorChromatograms(); })
        ...
        .def("getFeaturesMuteable", [](OpenMS::MRMTransitionGroup<OpenMS::MSChromatogram, OpenSwath::LightTransition>& self) { return self.getFeaturesMuteable(); })
    ...
    nb::class_<OpenMS::MapConversion>(m, "MapConversion", "OpenMS class MapConversion")
        ...
        .def_static("convert", [](unsigned long input_map_index, const OpenMS::FeatureMap& input_map, OpenMS::ConsensusMap& output_map, unsigned long n) { return OpenMS::MapConversion::convert(input_map_index, input_map, output_map, n); }, "input_map_index"_a, "input_map"_a, "output_map"_a, "n"_a)
        ;
...
about an LC-MS/MS injection.
    ...
    // Instrument
    // -----------------------------------------------------------------------
    auto instrument_class = nb::class_<OpenMS::TargetedExperimentHelper::Instrument, OpenMS::CVTermList>(m, "Instrument", 
        R"doc(
MetaInfoInterface
...
mz, intensities = spectrum.get_peaks()
        ...
        .def("resize", [](OpenMS::MSExperiment& self, unsigned long n) { return self.resize(n); }, "n"_a, "Resizes the spectrum container to the specified number of spectra")
        .def("empty", [](const OpenMS::MSExperiment& self) { return self.empty(); }, "Returns True if the experiment contains no spectra")
        .def("reserve", [](OpenMS::MSExperiment& self, unsigned long n) { return self.reserve(n); }, "n"_a, "Reserves space for the specified number of spectra")
        .def("begin", [](const OpenMS::MSExperiment& self) { return self.begin(); })
        .def("end", [](const OpenMS::MSExperiment& self) { return self.end(); })
        .def("reserveSpaceSpectra", [](OpenMS::MSExperiment& self, unsigned long s) { return self.reserveSpaceSpectra(s); }, "s"_a, "Reserves space for the specified number of spectra")
        .def("reserveSpaceChromatograms", [](OpenMS::MSExperiment& self, unsigned long s) { return self.reserveSpaceChromatograms(s); }, "s"_a, "Reserves space for the specified number of chromatograms")
...
mobility, intensities = mobilogram.get_peaks()
        ...
        .def("resize", [](OpenMS::Mobilogram& self, unsigned long new_size) { return self.resize(new_size); }, "new_size"_a, "Resize the peak array")
        .def("reserve", [](OpenMS::Mobilogram& self, unsigned long new_size) { return self.reserve(new_size); }, "new_size"_a)
...
Sorts the peaks according to ascending intensity. Meta data arrays will be sorted accordingly
    ...
    nb::class_<OpenMS::OnDiscMSExperiment>(m, "OnDiscMSExperiment", "Representation of a mass spectrometry experiment on disk.")
        ...
        .def("getSpectrum", [](OpenMS::OnDiscMSExperiment& self, unsigned long id) { return self.getSpectrum(id); }, "id"_a)
        .def("getChromatogram", [](OpenMS::OnDiscMSExperiment& self, unsigned long id) { return self.getChromatogram(id); }, "id"_a, 
            R"doc(
...
MzMLFile().store("testfile.mzML", exp)
        ...
        .def("getType", [](const OpenMS::MSSpectrum& self, bool query_data) { return self.getType(query_data); }, "query_data"_a, "Returns the spectrum type (centroided, profile or unknown). If SpectrumSettings and DataProcessing information are not sufficient and query_data is True, the data will be queried (potentially expensive)")
...
unique id
        ...
        .def_static("isValid", [](unsigned long unique_id) { return OpenMS::UniqueIdInterface::isValid(unique_id); }, "unique_id"_a, "Returns true if the unique_id is valid, false otherwise")
        ...
        .def("setUniqueId", [](OpenMS::UniqueIdInterface& self, unsigned long rhs) { return self.setUniqueId(rhs); }, "rhs"_a, "Assigns a new, valid unique id.  Always returns 1")
...
This class supports direct iteration in Python.
        ...
        .def_static("isValid", [](unsigned long unique_id) { return OpenMS::ConsensusMap::isValid(unique_id); }, "unique_id"_a, "Returns true if the unique_id is valid, false otherwise")
...
UniqueIdInterface
        ...
        .def(nb::init<>())
        .def(nb::init<unsigned long, OpenMS::Peak2D, unsigned long>())
        .def(nb::init<unsigned long, OpenMS::BaseFeature>())
        ...
        .def("setMapIndex", [](OpenMS::FeatureHandle& self, unsigned long i) { return self.setMapIndex(i); }, "i"_a, "Sets the map index")
...
After calling this, the map will be empty (size() returns 0)
        ...
        .def_static("isValid", [](unsigned long unique_id) { return OpenMS::FeatureMap::isValid(unique_id); }, "unique_id"_a, "Returns true if the unique_id is valid, false otherwise")
...
MetaInfoInterface
        ...
        .def_static("isValid", [](unsigned long unique_id) { return OpenMS::RichPeak2D::isValid(unique_id); }, "unique_id"_a, "Returns true if the unique_id is valid, false otherwise")
...
RichPeak2D
        ...
        .def(nb::init<const OpenMS::BaseFeature &, unsigned long>())
        .def(nb::init<OpenMS::Peak2D>())
        ...
        .def_static("isValid", [](unsigned long unique_id) { return OpenMS::BaseFeature::isValid(unique_id); }, "unique_id"_a, "Returns true if the unique_id is valid, false otherwise")
...
Get access to the underlying features through getFeatureList()
        ...
        .def("insert", [](OpenMS::ConsensusFeature& self, unsigned long map_index, const OpenMS::Peak2D& element, unsigned long element_index) { return self.insert(map_index, element, element_index); }, "map_index"_a, "element"_a, "element_index"_a, "Inserts a feature handle from a peak with map index and element index")
        .def("insert", [](OpenMS::ConsensusFeature& self, unsigned long map_index, const OpenMS::BaseFeature& element) { return self.insert(map_index, element); }, "map_index"_a, "element"_a, "Inserts a feature handle from a base feature with map index")
        ...
        .def_static("isValid", [](unsigned long unique_id) { return OpenMS::ConsensusFeature::isValid(unique_id); }, "unique_id"_a, "Returns true if the unique_id is valid, false otherwise")
...
:param q: Charge state (e.g., 2 for doubly charged ions)
        ...
        .def_static("isValid", [](unsigned long unique_id) { return OpenMS::Feature::isValid(unique_id); }, "unique_id"_a, "Returns true if the unique_id is valid, false otherwise")
