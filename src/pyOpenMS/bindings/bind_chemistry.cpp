...
instance primarily contains a sequence of residues.
        ...
        .def("setModification", [](OpenMS::AASequence& self, unsigned long index, const OpenMS::String& modification) { return self.setModification(index, modification); }, "index"_a, "modification"_a, "Sets the modification of the residue at position index. If an empty string is passed replaces the residue with its unmodified version")
        .def("setModification", [](OpenMS::AASequence& self, unsigned long index, OpenMS::Residue * modification) { return self.setModification(index, modification); }, "index"_a, "modification"_a, "Sets the modification of the residue at position index. If an empty string is passed replaces the residue with its unmodified version")
        .def("setModification", [](OpenMS::AASequence& self, unsigned long index, OpenMS::ResidueModification * modification) { return self.setModification(index, modification); }, "index"_a, "modification"_a, "Sets the modification of the residue at position index. If an empty string is passed replaces the residue with its unmodified version")
        .def("setModification", [](OpenMS::AASequence& self, unsigned long index, const OpenMS::ResidueModification& modification) { return self.setModification(index, modification); }, "index"_a, "modification"_a, "Sets the modification of the residue at position index. If an empty string is passed replaces the residue with its unmodified version")
        .def("setModificationByDiffMonoMass", [](OpenMS::AASequence& self, unsigned long index, double diffMonoMass) { return self.setModificationByDiffMonoMass(index, diffMonoMass); }, "index"_a, "diffMonoMass"_a, "Modifies the residue at index in the sequence and potentially in the ResidueDB")
...
Sets the C-terminal modification by the monoisotopic mass difference it introduces (creates a "user-defined" mod if not present)
        ...
        .def("getSuffix", [](const OpenMS::AASequence& self, unsigned long index) { return self.getSuffix(index); }, "index"_a, "Returns a peptide sequence of the last index residues")
        .def("getSubsequence", [](const OpenMS::AASequence& self, unsigned long index, unsigned int number) { return self.getSubsequence(index, number); }, "index"_a, "number"_a, "Returns a peptide sequence of number residues, beginning at position index")
...
Thus no random selection of just n specific missed cleavage sites is performed.
        ...
        .def("setMissedCleavages", [](OpenMS::EnzymaticDigestion& self, unsigned long missed_cleavages) { return self.setMissedCleavages(missed_cleavages); }, "missed_cleavages"_a, "Sets the max. number of allowed missed cleavages for the digestion (default is 0). This setting is ignored when log model is used")
...
Folding with itself is done using Russian Multiplication Scheme
        ...
        .def(nb::self == nb::self)
        .def(nb::self != nb::self)
        .def("getMass", [](const OpenMS::ims::IMSIsotopeDistribution& self, unsigned long i) { return self.getMass(i); }, "i"_a)
        .def("getAbundance", [](const OpenMS::ims::IMSIsotopeDistribution& self, unsigned long i) { return self.getAbundance(i); }, "i"_a)
...
e.g. used as input parameters in search engines.
        ...
        .def("setMaxModifications", [](OpenMS::ModificationDefinitionsSet& self, unsigned long max_mod) { return self.setMaxModifications(max_mod); }, "max_mod"_a, "Sets the maximal number of modifications allowed per peptide")
...
print(len(result_digest_unmodified)) # 42 peptides
        ...
        .def("setMissedCleavages", [](OpenMS::ProteaseDigestion& self, unsigned long missed_cleavages) { return self.setMissedCleavages(missed_cleavages); }, "missed_cleavages"_a, "Sets the max. number of allowed missed cleavages for the digestion (default is 0). This setting is ignored when log model is used")
...
print (fragment)
        ...
        .def("setMissedCleavages", [](OpenMS::RNaseDigestion& self, unsigned long missed_cleavages) { return self.setMissedCleavages(missed_cleavages); }, "missed_cleavages"_a, "Sets the max. number of allowed missed cleavages for the digestion (default is 0). This setting is ignored when log model is used")
