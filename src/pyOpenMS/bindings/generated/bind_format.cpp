// Auto-generated by pyOpenMS generator (nanobind, libclang)
// Domain: format
...
NB_MODULE(_pyopenms_format, m) {
    ...
    auto base64_class = nb::class_<OpenMS::Base64>(m, "Base64", "Class to encode and decode Base64")
        .def(nb::init<>())
        .def_static("encodeStrings", [](const std::vector<OpenMS::String>& in, OpenMS::String& out, bool zlib_compression, bool append_null_byte) { return OpenMS::Base64::encodeStrings(in, out, zlib_compression, append_null_byte); }, "in"_a, "out"_a, "zlib_compression"_a, "append_null_byte"_a, "Encodes a vector of strings to a Base64 string")
        .def_static("decodeStrings", [](const OpenMS::String& in, std::vector<OpenMS::String>& out, bool zlib_compression) { return OpenMS::Base64::decodeStrings(in, out, zlib_compression); }, "in"_a, "out"_a, "zlib_compression"_a, "Decodes a Base64 string to a vector of (null-terminated) strings")
        ;
...
Exception: FileEmpty is thrown if the given file is empty
        ...
        .def("getLabels", [](OpenMS::InspectOutfile& self, const OpenMS::String& source_database_filename, OpenMS::String& ac_label, OpenMS::String& sequence_start_label, OpenMS::String& sequence_end_label, OpenMS::String& comment_label, OpenMS::String& species_label) { return self.getLabels(source_database_filename, ac_label, sequence_start_label, sequence_end_label, comment_label, species_label); }, "source_database_filename"_a, "ac_label"_a, "sequence_start_label"_a, "sequence_end_label"_a, "comment_label"_a, "species_label"_a, "Retrieve the labels of a given database (at the moment FASTA and Swissprot)")
        .def("getSequences", [](OpenMS::InspectOutfile& self, const OpenMS::String& database_filename, const std::map<unsigned long, unsigned long>& wanted_records, std::vector<OpenMS::String>& sequences) { return self.getSequences(database_filename, wanted_records, sequences); }, "database_filename"_a, "wanted_records"_a, "sequences"_a, "Retrieve sequences from a trie database")
...
FullSwathFileConsumer
    ...
    nb::class_<OpenMS::SequestOutfile>(m, "SequestOutfile", "Representation of a Sequest output file")
        ...
        .def(nb::self == nb::self)
        .def("load", [](OpenMS::SequestOutfile& self, const OpenMS::String& result_filename, OpenMS::PeptideIdentificationList& peptide_identifications, OpenMS::ProteinIdentification& protein_identification, double p_value_threshold, std::vector<double>& pvalues, const OpenMS::String& database, bool ignore_proteins_per_peptide) { return self.load(result_filename, peptide_identifications, protein_identification, p_value_threshold, pvalues, database, ignore_proteins_per_peptide); }, "result_filename"_a, "peptide_identifications"_a, "protein_identification"_a, "p_value_threshold"_a, "pvalues"_a, "database"_a, "ignore_proteins_per_peptide"_a)
        .def("getColumns", [](OpenMS::SequestOutfile& self, const OpenMS::String& line, std::vector<OpenMS::String>& substrings, unsigned long number_of_columns, unsigned long reference_column) { return self.getColumns(line, substrings, number_of_columns, reference_column); }, "line"_a, "substrings"_a, "number_of_columns"_a, "reference_column"_a, "Retrieves columns from a Sequest outfile line")
