...
This Class is supposed to internally collect the data for the qcML File
        ...
        .def("error", [](OpenMS::QcMLFile& self, const xercesc_3_2::SAXParseException& exception) { return self.error(exception); }, "exception"_a)
        .def("warning", [](OpenMS::QcMLFile& self, const xercesc_3_2::SAXParseException& exception) { return self.warning(exception); }, "exception"_a)
