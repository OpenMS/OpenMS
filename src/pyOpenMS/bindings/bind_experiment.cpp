...
mz, intensities = spectrum.get_peaks()
        ...
        .def("aggregateFromMatrixWithIM", [](const OpenMS::MSExperiment& self, const OpenMS::Matrix<double>& ranges, unsigned int ms_level, const OpenMS::String& mz_agg) { return self.aggregateFromMatrixWithIM(ranges, ms_level, mz_agg); }, "ranges"_a, "ms_level"_a, "mz_agg"_a, "Aggregates intensity values for multiple m/z, RT and ion mobility ranges specified in a 6-column matrix [mz_min, mz_max, rt_min, rt_max, im_min, im_max]. Per-row im_min > im_max disables IM filtering for that row.")
        .def("extractXICsFromMatrixWithIM", [](const OpenMS::MSExperiment& self, const OpenMS::Matrix<double>& ranges, unsigned int ms_level, const OpenMS::String& mz_agg) { return self.extractXICsFromMatrixWithIM(ranges, ms_level, mz_agg); }, "ranges"_a, "ms_level"_a, "mz_agg"_a, "Extracts XIC chromatograms for multiple m/z, RT and ion mobility ranges specified in a 6-column matrix [mz_min, mz_max, rt_min, rt_max, im_min, im_max]. Per-row im_min > im_max disables IM filtering for that row.")
        .def("aggregateFromMatrixWithIMAndPrecursor", [](const OpenMS::MSExperiment& self, const OpenMS::Matrix<double>& ranges, unsigned int ms_level, const OpenMS::String& mz_agg) { return self.aggregateFromMatrixWithIMAndPrecursor(ranges, ms_level, mz_agg); }, "ranges"_a, "ms_level"_a, "mz_agg"_a, "Aggregates intensity values for multiple m/z, RT, ion mobility and precursor m/z ranges specified in an 8-column matrix [mz_min, mz_max, rt_min, rt_max, im_min, im_max, prec_mz_min, prec_mz_max] (for DIA/SWATH). Per-row min > max disables filtering for that dimension.")
        .def("extractXICsFromMatrixWithIMAndPrecursor", [](const OpenMS::MSExperiment& self, const OpenMS::Matrix<double>& ranges, unsigned int ms_level, const OpenMS::String& mz_agg) { return self.extractXICsFromMatrixWithIMAndPrecursor(ranges, ms_level, mz_agg); }, "ranges"_a, "ms_level"_a, "mz_agg"_a, "Extracts XIC chromatograms for multiple m/z, RT, ion mobility and precursor m/z ranges specified in an 8-column matrix [mz_min, mz_max, rt_min, rt_max, im_min, im_max, prec_mz_min, prec_mz_max] (for DIA/SWATH). Per-row min > max disables filtering for that dimension.")
