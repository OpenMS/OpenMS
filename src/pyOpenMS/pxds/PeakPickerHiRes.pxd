...
cdef extern from "<OpenMS/FILTERING/CENTROIDING/PeakPickerHiRes.h>" namespace "OpenMS":
...
cdef extern from "<OpenMS/FILTERING/CENTROIDING/PeakPickerHiRes.h>" namespace "OpenMS::PeakPickerHiRes":
