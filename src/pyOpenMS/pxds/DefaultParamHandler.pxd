...
cdef extern from "<OpenMS/DATASTRUCTURES/DefaultParamHandler.h>" namespace "OpenMS":
    ...
    cdef cppclass DefaultParamHandler:
        ...
        Param getParameters()  nogil except + # wrap-doc:Access to the parameters
        Param getDefaults()  nogil except + # wrap-doc:Access to the default parameters
        String getName()  nogil except + # wrap-doc:Access to the name
        void setName(const String&)  nogil except + # wrap-doc:Access to the name
