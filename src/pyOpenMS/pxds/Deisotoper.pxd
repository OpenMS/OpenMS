...
cdef extern from "<OpenMS/PROCESSING/DATAREDUCTION/Deisotoper.h>" namespace "OpenMS":
    cdef cppclass Deisotoper:
        Deisotoper() except + nogil  # compiler
        Deisotoper(Deisotoper &) except + nogil  # compiler

# COMMENT: wrap static methods
cdef extern from "<OpenMS/PROCESSING/DATAREDUCTION/Deisotoper.h>" namespace "OpenMS::Deisotoper":
