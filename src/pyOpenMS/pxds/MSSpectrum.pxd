...
cdef extern from "<OpenMS/KERNEL/MSSpectrum.h>" namespace "OpenMS":
    ...
    cdef cppclass MSSpectrum(SpectrumSettings, RangeManager1):
        ...
        double getTIC() nogil except + #wrap-doc:Returns the total ion current (=sum) of peak intensities in the spectrum
        ...
        libcpp_vector[FloatDataArray] getFloatDataArrays() nogil except + #wrap-doc:Get the additional float data arrays to store e.g. meta data
        libcpp_vector[IntegerDataArray] getIntegerDataArrays() nogil except + #wrap-doc:Get the additional int data arrays to store e.g. meta data
        libcpp_vector[StringDataArray] getStringDataArrays() nogil except + #wrap-doc:Get the additional string data arrays to store e.g. meta data

        void setFloatDataArrays(libcpp_vector[FloatDataArray] fda) nogil except + #wrap-doc:Set the additional float data arrays to store e.g. meta data
        void setIntegerDataArrays(libcpp_vector[IntegerDataArray] ida) nogil except + #wrap-doc:Set the additional int data arrays to store e.g. meta data
        void setStringDataArrays(libcpp_vector[StringDataArray] sda) nogil except + #wrap-doc:Set the additional string data arrays to store e.g. meta data
