...
cdef extern from "<OpenMS/METADATA/CVTermListInterface.h>" namespace "OpenMS":
    ...
    cdef cppclass CVTermListInterface(MetaInfoInterface) :
        ...
        void replaceCVTerms(cpp_map[ String, libcpp_vector[ CVTerm ] ] & cv_terms) nogil except +
        ...
        void consumeCVTerms(cpp_map[ String, libcpp_vector[ CVTerm ] ] & cv_term_map) nogil except + # wrap-doc:Merges the given map into the member map, no duplicate checking
