...
cdef extern from "<OpenMS/MATH/MISC/CubicSpline2d.h>" namespace "OpenMS":
    ...
    cdef cppclass CubicSpline2d "OpenMS::CubicSpline2d":
        ...
        double eval(double x) nogil except + # wrap-doc:Evaluates the spline at position x
        double derivatives(double x, unsigned order) nogil except + # wrap-doc:Evaluates derivative of spline at position x
