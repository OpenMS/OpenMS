...
cdef extern from "<OpenMS/TRANSFORMATIONS/RAW2PEAK/TwoDOptimization.h>" namespace "OpenMS":
    ...
    cdef cppclass TwoDOptimization(DefaultParamHandler) :
        ...
        double getMZTolerance() nogil except + # wrap-doc:\n Returns the matching epsilon
        void setMZTolerance(double tolerance_mz) nogil except + # wrap-doc:\n Sets the matching epsilon
        double getMaxPeakDistance() nogil except + # wrap-doc:\n Returns the maximal peak distance in a cluster
        void setMaxPeakDistance(double max_peak_distance) nogil except + # wrap-doc:\n Sets the maximal peak distance in a cluster
        UInt getMaxIterations() nogil except + # wrap-doc:\n Returns the maximal number of iterations
        void setMaxIterations(UInt max_iteration) nogil except + # wrap-doc:\n Sets the maximal number of iterations
