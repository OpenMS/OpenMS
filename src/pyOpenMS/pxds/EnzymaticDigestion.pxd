...
=======
                            bool ignore_missed_cleavages) nogil except +
                # wrap-doc:
                #    Is the peptide fragment starting at position @p pos with length @p length within the sequence @p sequence generated by the current enzyme?
                #
                #    Checks if peptide is a valid digestion product of the enzyme, taking into account specificity and the MC flag provided here.
                #
                #    Param protein Protein sequence
...
>>>>>>> 28f3bd0c6e2629348ec055d9502d7932a512c52b
