...
cdef extern from "<OpenMS/ML/SVM/SimpleSVM.h>" namespace "OpenMS":
    ...
    ctypedef libcpp_map[libcpp_string, libcpp_vector[double]] SimpleSVM_PredictorMap "OpenMS::SimpleSVM::PredictorMap"
    ctypedef libcpp_map[libcpp_string, libcpp_pair[double, double]] SimpleSVM_ScaleMap "OpenMS::SimpleSVM::ScaleMap"
    ...
    cdef cppclass SimpleSVM(DefaultParamHandler):
        ...
        void getFeatureWeights(libcpp_map[libcpp_string, double]& feature_weights) except + nogil
