...
cdef extern from "<OpenMS/FILTERING/CALIBRATION/PrecursorCorrection.h>" namespace "OpenMS::PrecursorCorrection":
    ...
    void getPrecursors(MSExperiment & exp, libcpp_vector[ Precursor ] & precursors, libcpp_vector[ double ] & precursors_rt, libcpp_vector[ size_t ] & precursor_scan_index) nogil except + # wrap-attach:PrecursorCorrection

    void writeHist(String & out_csv, libcpp_vector[ double ] & delta_mzs, libcpp_vector[ double ] & mzs, libcpp_vector[ double ] & rts) nogil except + # wrap-attach:PrecursorCorrection
