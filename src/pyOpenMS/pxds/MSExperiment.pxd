...
cdef extern from "<OpenMS/KERNEL/MSExperiment.h>" namespace "OpenMS":
    ...
    cdef cppclass MSExperiment(ExperimentalSettings, RangeManagerRtMzInt):
        ...
        void get2DPeakDataIon(double min_rt, double max_rt, double min_mz, double max_mz, libcpp_vector[float] & rt, libcpp_vector[float] & mz, libcpp_vector[float] & intensity, libcpp_vector[float] & ion) nogil except + # wrap-ignore
