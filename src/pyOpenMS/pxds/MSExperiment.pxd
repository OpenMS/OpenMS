...
cdef extern from "<OpenMS/KERNEL/MSExperiment.h>" namespace "OpenMS":
    ...
    cdef cppclass MSExperiment(ExperimentalSettings):
        ...
        void rasterize2D(float* output, Size rt_bins, Size mz_bins, double min_rt, double max_rt, double min_mz, double max_mz, unsigned int ms_level, RasterAggregation aggregation) except + nogil  # wrap-ignore
