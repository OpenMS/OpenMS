...
cdef extern from "<OpenMS/FORMAT/MascotInfile.h>" namespace "OpenMS":
    ...
    cdef cppclass MascotInfile(ProgressLogger) :
        ...
        void setInstrument(const String & instrument) nogil except + # wrap-doc:Sets the instrument type (Default: Default). Possible instruments: ESI-QUAD-TOF, MALDI-TOF-PSD, ESI-TRAP, ESI-QUAD, ESI-FTICR, MALDI-TOF-TOF, ESI-4SECTOR, FTMS-ECD, MALDI-QUAD-TOF, MALDI-QIT-TOF
