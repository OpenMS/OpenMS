...
cdef extern from "<OpenMS/COMPARISON/SPECTRA/BinnedSpectrum.h>" namespace "OpenMS":
    ...
    cdef cppclass BinnedSpectrum:
        ...
        UInt getBinIndex(float mz) nogil except + # wrap-doc:Return the bin index of a given m/z position
        float getBinLowerMZ(size_t i) nogil except + # wrap-doc:Return the lower m/z of a bin given its index
        ...
        float getOffset() nogil except + # wrap-doc:Return offset
