...
cdef extern from "<OpenMS/ANALYSIS/QUANTITATION/AbsoluteQuantitationMethod.h>" namespace "OpenMS":
    ...
    cdef cppclass AbsoluteQuantitationMethod:
        ...
        void setComponentName(component_name) nogil except +
        void setISName(IS_name) nogil except +
        void setFeatureName(feature_name) nogil except +
        ...
        Param getTransformationModel() nogil except +

        void setActualConcentration(double actual_concentration) nogil except +
        double getActualConcentration() nogil except +

        void setNPoints(n_points) nogil except +
        void setCorrelationCoefficient(correlation_coefficient) nogil except +
