...
cdef extern from "<OpenMS/FORMAT/PercolatorOutfile.h>" namespace "OpenMS":
    ...
    cdef cppclass PercolatorOutfile "OpenMS::PercolatorOutfile":
        ...
        ScoreType getScoreType(String score_type_name) except + nogil  # wrap-doc:Returns a score type given its name

        void load(const String & filename, ProteinIdentification & proteins,
                  PeptideIdentificationList & peptides,
                  SpectrumMetaDataLookup & lookup,
                  ScoreType output_score) except + nogil  # wrap-doc:Loads a Percolator output file

cdef extern from "<OpenMS/FORMAT/PercolatorOutfile.h>" namespace "OpenMS::PercolatorOutfile":
    cdef enum class ScoreType "OpenMS::PercolatorOutfile::ScoreType":
        # wrap-attach:
        #    PercolatorOutfile
        QVALUE
        POSTERRPROB
