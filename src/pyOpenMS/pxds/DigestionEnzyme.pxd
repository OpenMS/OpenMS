...
cdef extern from "<OpenMS/CHEMISTRY/DigestionEnzyme.h>" namespace "OpenMS":
    ...
    cdef cppclass DigestionEnzyme "OpenMS::DigestionEnzyme":
        ...
        DigestionEnzyme(String name, String cleavage_regex, libcpp_set[ String ] & synonyms, String regex_description) nogil except +
        ...
        void setRegEx(String cleavage_regex) nogil except +
        String getRegEx() nogil except +
        void setRegExDescription(String value) nogil except +
