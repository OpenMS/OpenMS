...
cdef extern from "<OpenMS/CHEMISTRY/DigestionEnzyme.h>" namespace "OpenMS":
    ...
    cdef cppclass DigestionEnzyme "OpenMS::DigestionEnzyme":
        DigestionEnzyme(DigestionEnzyme) nogil except + # TODO
        DigestionEnzyme(const String & name, const String & cleavage_regex, libcpp_set[ String ] & synonyms, String regex_description) nogil except + # TODO
