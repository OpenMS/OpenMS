...
cdef extern from "<OpenMS/FORMAT/MzQuantMLFile.h>" namespace "OpenMS":
    ...
    cdef cppclass MzQuantMLFile:
        MzQuantMLFile() except + nogil 
        MzQuantMLFile(MzQuantMLFile &) except + nogil 

        void load(String filename, MSQuantifications & msq) except + nogil 
            # wrap-doc:
        ...
        void store(String filename, MSQuantifications & msq) except + nogil 
            # wrap-doc:
