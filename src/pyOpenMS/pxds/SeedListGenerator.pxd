...
cdef extern from "<OpenMS/TRANSFORMATIONS/FEATUREFINDER/SeedListGenerator.h>" namespace "OpenMS":
    ...
    cdef cppclass SeedListGenerator:
        ...
        void generateSeedList(ConsensusMap & consensus, libcpp_map[UInt64, libcpp_vector[DPosition2] ] & seeds) nogil except +  # wrap-ignore

        # TODO nested STL
        # void generateSeedLists(ConsensusMap & consensus, libcpp_map[ UInt64, libcpp_vector[ DPosition2] ] & seed_lists) nogil except + # wrap-doc:Generates seed lists based on a consensus map
