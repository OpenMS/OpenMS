    ...
    def load(self, filename, protein_identification, peptide_ids, mod_def_set):
        """
        load(self, filename, protein_identification, peptide_ids, mod_def_set)
        ...
        :param filename: Path to the X! Tandem XML file to load
        ...
        :param mod_def_set: Modification definitions set
        :type mod_def_set: ModificationDefinitionsSet
        ...
        Example::
            ...
            mod_def_set = pyopenms.ModificationDefinitionsSet()
            pyopenms.XTandemXMLFile().load("test.xml", protein_id, peptide_ids, mod_def_set)
