...
namespace OpenMS
{
                                                        ...
                                                        double intensity) const
  {
    ...
    for (const auto& it : dist)
    {
      ...
      spectrum.emplace_back(it.getMZ() / charge, static_cast<Peak1D::IntensityType>(intensity * it.getIntensity()));
    }
  }
                         ...
                         int charge) const
  {
    ...
    {
      spectrum.emplace_back((mz - formula.getMonoWeight()) / (double)charge, static_cast<Peak1D::IntensityType>(intensity));
    ...
    for (const auto& it : losses)
    {
      ...
      if (add_isotopes_)
      {
        ...
        for (const auto& iso : dist)
        {
          ...
          spectrum.emplace_back(iso.getMZ() / (double)charge, static_cast<Peak1D::IntensityType>(intensity * rel_loss_intensity_ * iso.getIntensity()));
        }
      }
      else
      {
        ...
        spectrum.emplace_back(loss_pos / (double)charge, static_cast<Peak1D::IntensityType>(intensity * rel_loss_intensity_));
      }
    }
  }
                                               ...
                                               Int charge) const
  {
    ...
    for (Size l = 1; l < peptide.size() - 1 - 2; ++l) // start at a2/b2, stop at n-1 a/b ion with min length of 2
    {
      ...
      for (size_t i = l; i < peptide.size() - 1; ++i)
      {
        ...
        spectrum.emplace_back(pos, static_cast<Peak1D::IntensityType>(intensity));
        if (add_metainfo_)
        {
                                                        ...
                                                        Int charge) const
  {
    ...
    if (add_isotopes_)
    {
      ...
      for (IsotopeDistribution::ConstIterator it = dist.begin(); it != dist.end(); ++it)
      {
        ...
        spectrum.emplace_back(it->getMZ() / (double)charge, static_cast<Peak1D::IntensityType>(pre_int_ * it->getIntensity()));
      }
    }
    else
    {
      ...
      spectrum.emplace_back(mono_pos / (double)charge, static_cast<Peak1D::IntensityType>(pre_int_));
    }
    ...
    if (add_isotopes_)
    {
      ...
      for (IsotopeDistribution::ConstIterator it = dist.begin(); it != dist.end(); ++it)
      {
        ...
        spectrum.emplace_back(it->getMZ() / charge, static_cast<Peak1D::IntensityType>(pre_int_H2O_ * it->getIntensity()));
      }
    }
    else
    {
      ...
      spectrum.emplace_back(mono_pos / (double)charge, static_cast<Peak1D::IntensityType>(pre_int_H2O_));
    }
    ...
    if (add_isotopes_)
    {
      ...
      for (IsotopeDistribution::ConstIterator it = dist.begin(); it != dist.end(); ++it)
      {
        ...
        spectrum.emplace_back(it->getMZ() / (double)charge, static_cast<Peak1D::IntensityType>(pre_int_NH3_ * it->getIntensity()));
      }
    }
    else
    {
      ...
      spectrum.emplace_back(mono_pos / (double)charge, static_cast<Peak1D::IntensityType>(pre_int_NH3_));
    }
  }
