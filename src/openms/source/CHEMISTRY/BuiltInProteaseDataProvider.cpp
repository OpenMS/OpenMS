...
vector<unique_ptr<DigestionEnzymeProtein>> BuiltInProteaseDataProvider::loadEnzymes()
{
  ...
  // PepsinA
  enzymes.push_back(make_unique<DigestionEnzymeProtein>("PepsinA", "(?<=[FLJX])", set<String> {"pepsin"}, "PepsinA cuts after F or L(or J).",
  ...
  // Trypsin/P
  enzymes.push_back(make_unique<DigestionEnzymeProtein>("Trypsin/P", "(?<=[KRX])", set<String> {"trypsinp"}, "Trypsin/P cuts after K or R.",
  ...
  // leukocyte elastase
  enzymes.push_back(make_unique<DigestionEnzymeProtein>("leukocyte elastase", "(?<=[ALIJVX])(?!P)", set<String> {"elastase"},
  ...
  // Thermolysin
  enzymes.push_back(
    make_unique<DigestionEnzymeProtein>("Thermolysin", "(?<![DE])(?=[AFILMV])|(?<=R)(?=G)", set<String>(),
                                        "Thermolysin cleaves before A, F, I, L, M or V (not preceded by D or E), and also cleaves R-G bonds.",
                                        EmpiricalFormula("H"), EmpiricalFormula("OH"), "", "{DE}|[AFILMV]",
                                        -1, // CometID
                                        -1, // MSGFID
                                        -1  // OMSSAID
                                        ));
  ...
  enzymes.push_back(make_unique<DigestionEnzymeProtein>("Proteinase K", "(?<=[AEFILTVWY])", set<String> {"proteinasek"},
                                                        "Proteinase K cleaves after A, E, F, I, L, T, V, W or Y.", EmpiricalFormula("H"),
                                                        EmpiricalFormula("OH"), "", "[AEFILTVWY]|[X]",
                                                        -1, // CometID
                                                        -1, // MSGFID
                                                        -1  // OMSSAID
                                                        ));
