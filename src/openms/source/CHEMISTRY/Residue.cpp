...
namespace OpenMS
{
  ...
  {     
    ...
    static const double scales[7][26] = 
    {
      ...
      {
      //    A,     B,     C,     D,     E,     F,     G,     H,     I,     J,     K,     L,     M,    
        0.620,   999, 0.290, -0.90, -0.85, 1.190, 0.480, -0.40, 1.380,   999, -1.50, 1.088, 0.640, 
      //    N,     O,     P,     Q,     R,     S,     T,     U,     V,     W,     X,     Y,     Z
        -0.780,  999, 0.120, -0.74, -2.53, -0.18, -0.05,   999, 1.080, -0.81,   999, 0.260,   999
      },
      // HoppWoods scale
      {
      //    A,     B,     C,     D,     E,     F,     G,     H,     I,     J,     K,     L,     M,    
        -0.50,   999, -1.00, 3.000, 0.200, -2.50, 0.000, -0.50, -1.80,   999, 3.000, -1.80, -1.30, 
      //    N,     O,     P,     Q,     R,     S,     T,     U,     V,     W,     X,     Y,     Z
        0.200,   999, 0.000, 3.000, 3.000, 0.300, -0.40,   999, -1.50, -3.40,   999, -2.30,   999
      },
      // BullBreese scale
      {
      //    A,     B,     C,     D,     E,     F,     G,     H,     I,     J,     K,     L,     M,    
        0.610,   999, 0.360, 0.610, 0.970, -1.52, 0.810, 0.690, -1.45,   999, 0.460, -1.65, -0.66, 
      //    N,     O,     P,     Q,     R,     S,     T,     U,     V,     W,     X,     Y,     Z
        0.890,   999, -0.17, 0.510, 0.690, 0.420, 0.290,   999, -0.75, -1.20,   999, -1.43,   999
      },
      // BlackMould scale
      {
      //    A,     B,     C,     D,     E,     F,     G,     H,     I,     J,     K,     L,     M,    
        0.616,   999, 0.680, 0.028, 0.251, 1.000, 0.501, 0.165, 0.943,   999, 0.283, 0.943, 0.738, 
      //    N,     O,     P,     Q,     R,     S,     T,     U,     V,     W,     X,     Y,     Z
        0.236,   999, 0.711, 0.043, 0.000, 0.359, 0.450,   999, 0.825, 0.878,   999, 0.880,   999
      },
      // Guy scale
      {
      //    A,     B,     C,     D,     E,     F,     G,     H,     I,     J,     K,     L,     M,    
        0.100,   999, -1.42, 0.780, 0.95, -2.12, 0.330, -0.500, -1.13,   999, 1.400, -1.18, -1.59, 
      //    N,     O,     P,     Q,     R,     S,     T,     U,     V,     W,     X,     Y,     Z
        0.480,   999, 0.730, 0.830, 1.910, 0.520, 0.070,   999, -1.27, -0.51,   999, -0.21,   999
      },
