...
#define DEF_EXCEPTION(a, b)                                                                                   \
  a::a(const char* file, int line, const char* function) noexcept: BaseException(file, line, function, #a, b) \
  {                                                                                                           \
  }
...
namespace Exception
{
  ...
  BaseException::BaseException() noexcept: std::runtime_error("unknown error"), file_("?"), line_(-1), function_("?"), name_("Exception")
  {
