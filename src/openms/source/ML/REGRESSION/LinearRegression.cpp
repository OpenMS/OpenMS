...
namespace OpenMS::Math
{
        ...
        bool compute_goodness)
    {
      ...
      if (!pass)
      {
        throw Exception::UnableToFit(__FILE__, __LINE__, OPENMS_PRETTY_FUNCTION, "UnableToFit-LinearRegression",std::string("Could not fit a linear model to the data (") + points.size() + " points).");
      }
