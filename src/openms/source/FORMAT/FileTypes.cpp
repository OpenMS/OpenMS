...
namespace OpenMS
{
  ...
  static const std::array<TypeNameBinding, FileTypes::SIZE_OF_TYPE> type_with_annotation__ =
  {
    ...
    TypeNameBinding(FileTypes::DTA, "dta", "dta raw data file", {PROP::PROVIDES_EXPERIMENT, PROP::PROVIDES_SPECTRUM, PROP::PROVIDES_MS2, PROP::READABLE, PROP::WRITEABLE}),
    TypeNameBinding(FileTypes::DTA2D, "dta2d", "dta2d raw data file", {PROP::PROVIDES_EXPERIMENT, PROP::PROVIDES_MS1, PROP::READABLE, PROP::WRITEABLE}),
    TypeNameBinding(FileTypes::MZDATA, "mzData", "mzData raw data file", {PROP::PROVIDES_EXPERIMENT, PROP::PROVIDES_MS1, PROP::PROVIDES_MS2, PROP::READABLE, PROP::WRITEABLE}),
    TypeNameBinding(FileTypes::MZXML, "mzXML", "mzXML raw data file", {PROP::PROVIDES_EXPERIMENT, PROP::PROVIDES_MS1, PROP::PROVIDES_MS2, PROP::READABLE, PROP::WRITEABLE}),
    ...
    TypeNameBinding(FileTypes::MGF, "mgf", "mascot generic format file", {PROP::PROVIDES_EXPERIMENT, PROP::PROVIDES_MS1, PROP::PROVIDES_MS2, PROP::READABLE, PROP::WRITEABLE}),
    ...
    TypeNameBinding(FileTypes::MZML, "mzML", "mzML raw data file", {PROP::PROVIDES_EXPERIMENT, PROP::PROVIDES_MS1, PROP::PROVIDES_MS2, PROP::READABLE, PROP::WRITEABLE}),
    ...
    TypeNameBinding(FileTypes::MS2, "ms2", "ms2 file", {PROP::PROVIDES_EXPERIMENT, PROP::READABLE, PROP::PROVIDES_MS2}),
    ...
    TypeNameBinding(FileTypes::MSP, "msp", "NIST spectra library file format", {PROP::PROVIDES_EXPERIMENT, PROP::PROVIDES_MS1, PROP::PROVIDES_MS2, PROP::READABLE, PROP::WRITEABLE}),
    ...
    TypeNameBinding(FileTypes::XMASS, "fid", "XMass analysis file", {PROP::PROVIDES_EXPERIMENT, PROP::PROVIDES_SPECTRUM, PROP::PROVIDES_MS2, PROP::PROVIDES_MS1, PROP::READABLE, PROP::WRITEABLE}),
