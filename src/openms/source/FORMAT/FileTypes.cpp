...
namespace OpenMS
{
  ...
  static const std::array<TypeNameBinding, FileTypes::SIZE_OF_TYPE> type_with_annotation__ =
  {
    ...
    TypeNameBinding(FileTypes::DTA, "dta", "dta raw data file", {PROP::PROVIDES_LOADEXPERIMENT, PROP::PROVIDES_LOADSPECTRUM, PROP::PROVIDES_STOREEXPERIMENT, PROP::PROVIDES_STORESPECTRUM, PROP::PROVIDES_MS2, PROP::READABLE, PROP::WRITEABLE}),
    TypeNameBinding(FileTypes::DTA2D, "dta2d", "dta2d raw data file", {PROP::PROVIDES_LOADEXPERIMENT, PROP::PROVIDES_STOREEXPERIMENT, PROP::PROVIDES_MS1, PROP::READABLE, PROP::WRITEABLE}),
    TypeNameBinding(FileTypes::MZDATA, "mzData", "mzData raw data file", {PROP::PROVIDES_LOADEXPERIMENT, PROP::PROVIDES_STOREEXPERIMENT, PROP::PROVIDES_MS1, PROP::PROVIDES_MS2, PROP::READABLE, PROP::WRITEABLE}),
    TypeNameBinding(FileTypes::MZXML, "mzXML", "mzXML raw data file", {PROP::PROVIDES_LOADEXPERIMENT, PROP::PROVIDES_STOREEXPERIMENT, PROP::PROVIDES_MS1, PROP::PROVIDES_MS2, PROP::READABLE, PROP::WRITEABLE}),
    TypeNameBinding(FileTypes::FEATUREXML, "featureXML", "OpenMS feature map", {PROP::PROVIDES_LOADFEATURES, PROP::PROVIDES_STOREFEATURES, PROP::READABLE, PROP::WRITEABLE}),
    TypeNameBinding(FileTypes::IDXML, "idXML", "OpenMS peptide identification file", {PROP::PROVIDES_LOADIDENTIFICATIONS, PROP::PROVIDES_STOREIDENTIFICATIONS, PROP::READABLE, PROP::WRITEABLE}),
    TypeNameBinding(FileTypes::CONSENSUSXML, "consensusXML", "OpenMS consensus feature map", {PROP::PROVIDES_LOADCONSENSUSFEATURES, PROP::PROVIDES_STORECONSENSUSFEATURES, PROP::READABLE, PROP::WRITEABLE}),
    TypeNameBinding(FileTypes::MGF, "mgf", "mascot generic format file", {PROP::PROVIDES_LOADEXPERIMENT, PROP::PROVIDES_STOREEXPERIMENT, PROP::PROVIDES_MS1, PROP::PROVIDES_MS2, PROP::READABLE, PROP::WRITEABLE}),
    ...
    TypeNameBinding(FileTypes::TRANSFORMATIONXML, "trafoXML", "RT transformation file", {PROP::PROVIDES_LOADTRANSFORMATIONS, PROP::PROVIDES_STORETRANSFORMATIONS, PROP::READABLE, PROP::WRITEABLE}),
    TypeNameBinding(FileTypes::MZML, "mzML", "mzML raw data file", {PROP::PROVIDES_LOADEXPERIMENT, PROP::PROVIDES_STOREEXPERIMENT, PROP::PROVIDES_MS1, PROP::PROVIDES_MS2, PROP::READABLE, PROP::WRITEABLE}),
    //TODO: Add support for cachedMZML as a first class file type
    TypeNameBinding(FileTypes::CACHEDMZML, "cachedMzML", "cachedMzML raw data file", {PROP::PROVIDES_MS1, PROP::PROVIDES_MS2, PROP::READABLE, PROP::WRITEABLE}),
    TypeNameBinding(FileTypes::MS2, "ms2", "ms2 file", {PROP::PROVIDES_LOADEXPERIMENT, PROP::READABLE, PROP::PROVIDES_MS2}),
    ...
    TypeNameBinding(FileTypes::PROTXML, "protXML", "protXML file", {PROP::PROVIDES_LOADIDENTIFICATIONS, PROP::READABLE}),
    TypeNameBinding(FileTypes::MZIDENTML, "mzid", "mzIdentML file", {PROP::PROVIDES_LOADIDENTIFICATIONS, PROP::PROVIDES_STOREIDENTIFICATIONS, PROP::READABLE, PROP::WRITEABLE}),
    TypeNameBinding(FileTypes::MZQUANTML, "mzq", "mzQuantML file", {PROP::PROVIDES_LOADQUANTIFICATIONS, PROP::PROVIDES_STOREQUANTIFICATIONS, PROP::READABLE, PROP::WRITEABLE}),
    TypeNameBinding(FileTypes::QCML, "qcml", "quality control file", {PROP::PROVIDES_STOREQC, PROP::WRITEABLE}), //TODO add load functions for QC
    TypeNameBinding(FileTypes::MZQC, "mzqc", "quality control file in json format", {PROP::PROVIDES_STOREQC, PROP::WRITEABLE}),
    TypeNameBinding(FileTypes::GELML, "gelML", "gelML file", {}),
    TypeNameBinding(FileTypes::TRAML, "traML", "transition file", {PROP::PROVIDES_LOADTRANSITIONS, PROP::PROVIDES_STORETRANSITIONS, PROP::READABLE, PROP::WRITEABLE}),
    TypeNameBinding(FileTypes::MSP, "msp", "NIST spectra library file format", {PROP::PROVIDES_LOADEXPERIMENT, PROP::PROVIDES_STOREEXPERIMENT, PROP::PROVIDES_MS1, PROP::PROVIDES_MS2, PROP::READABLE, PROP::WRITEABLE}),
    TypeNameBinding(FileTypes::OMSSAXML, "omssaXML", "omssaXML file", {PROP::PROVIDES_LOADIDENTIFICATIONS, PROP::READABLE}),
    ...
    TypeNameBinding(FileTypes::XMASS, "fid", "XMass analysis file", {PROP::PROVIDES_LOADEXPERIMENT, PROP::PROVIDES_LOADSPECTRUM, PROP::PROVIDES_STOREEXPERIMENT, PROP::PROVIDES_STORESPECTRUM, PROP::PROVIDES_MS2, PROP::PROVIDES_MS1, PROP::READABLE, PROP::WRITEABLE}),
    TypeNameBinding(FileTypes::TSV, "tsv", "tab-separated file", {PROP::PROVIDES_LOADFEATURES, PROP::PROVIDES_STOREFEATURES, PROP::READABLE, PROP::WRITEABLE}),
    TypeNameBinding(FileTypes::MZTAB, "mzTab", "mzTab file", {}), //TODO add filehandler support for MZTAB
    TypeNameBinding(FileTypes::PEPLIST, "peplist", "SpecArray file", {PROP::PROVIDES_LOADFEATURES, PROP::PROVIDES_STOREFEATURES, PROP::READABLE, PROP::WRITEABLE}),
    TypeNameBinding(FileTypes::HARDKLOER, "hardkloer", "hardkloer file", {}),
    TypeNameBinding(FileTypes::KROENIK, "kroenik", "kroenik file", {PROP::PROVIDES_LOADFEATURES, PROP::PROVIDES_STOREFEATURES, PROP::READABLE, PROP::WRITEABLE}),
    TypeNameBinding(FileTypes::FASTA, "fasta", "FASTA file", {PROP::READABLE, PROP::WRITEABLE}),
    TypeNameBinding(FileTypes::EDTA, "edta", "enhanced dta file", {PROP::PROVIDES_STOREFEATURES, PROP::PROVIDES_LOADCONSENSUSFEATURES, PROP::PROVIDES_STORECONSENSUSFEATURES, PROP::READABLE, PROP::WRITEABLE}),
    ...
    TypeNameBinding(FileTypes::XQUESTXML, "xquest.xml", "xquest.xml file", {PROP::PROVIDES_LOADIDENTIFICATIONS, PROP::PROVIDES_STOREIDENTIFICATIONS, PROP::READABLE, PROP::WRITEABLE}),
    ...
    TypeNameBinding(FileTypes::OMS, "oms", "OpenMS SQLite file", {PROP::PROVIDES_LOADIDENTIFICATIONS, PROP::PROVIDES_LOADFEATURES, PROP::PROVIDES_LOADCONSENSUSFEATURES, PROP::PROVIDES_STOREIDENTIFICATIONS, PROP::PROVIDES_STOREFEATURES, PROP::PROVIDES_STORECONSENSUSFEATURES }),
