  ...
  const FeatureMap& feature_map)
{
  ...
  auto schema = arrow::schema({
    ...
    arrow::field("rt_start", arrow::float64(), /*nullable=*/true),
    arrow::field("rt_end", arrow::float64(), /*nullable=*/true),
    arrow::field("mz_start", arrow::float64(), /*nullable=*/true),
    arrow::field("mz_end", arrow::float64(), /*nullable=*/true),
