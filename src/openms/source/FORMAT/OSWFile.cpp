                     ...
                     const double ipf_min_transition_sn)
  {
      ...
      while (sqlite3_column_type( stmt, 0 ) != SQLITE_NULL)
      {
        ...
        for (int i = 0; i < cols; i++)
        {
          ...
          {
            auto it = std::find(group_id_index.begin(), group_id_index.end(), reinterpret_cast<const char*>(sqlite3_column_text(stmt, i)));
            ...
            else
            {
              ...
              group_id_index.emplace_back(reinterpret_cast<const char*>(sqlite3_column_text(stmt, i)));
            }
          }
