...
namespace OpenMS
{
  ...
  void SavitzkyGolayFilter::updateMembers_()
  {
    ...
    {
      throw Exception::InvalidValue(__FILE__, __LINE__, OPENMS_PRETTY_FUNCTION, "The degree of the polynomial has to be less than the frame length.",StringUtils::toStr(order_));
    }
