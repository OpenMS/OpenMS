...
namespace OpenMS
{
  ...
  void IsobaricChannelExtractor::setDefaultParams_()
  {
    ...
    activation_list.insert(activation_list.end(), Precursor::NamesOfActivationMethod, Precursor::NamesOfActivationMethod + Precursor::ActivationMethod::SIZE_OF_ACTIVATIONMETHOD - 1);
