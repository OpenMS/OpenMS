...
void NuXLFragmentIonGenerator::addSpecialLysImmonumIons(
  ...
  PeakSpectrum::StringDataArray &spectrum_annotation)
{
   if (StringUtils::has(unmodified_sequence, 'K'))
   {
...
void NuXLFragmentIonGenerator::addShiftedImmoniumIons(const std::string &unmodified_sequence,
...
{
  if (StringUtils::hasSubstring(unmodified_sequence, "Y"))
  {
  ...
  if (StringUtils::hasSubstring(unmodified_sequence, "W"))
  {
  ...
  if (StringUtils::hasSubstring(unmodified_sequence, "F"))
  {
  ...
  if (StringUtils::hasSubstring(unmodified_sequence, "H"))
  {
  ...
  if (StringUtils::hasSubstring(unmodified_sequence, "C"))
  {
  ...
  if (StringUtils::hasSubstring(unmodified_sequence, "P"))
  {
  ...
  if (StringUtils::hasSubstring(unmodified_sequence, "L") || StringUtils::hasSubstring(unmodified_sequence, "I"))
  {
  ...
  if (StringUtils::hasSubstring(unmodified_sequence, "K"))
  {
  ...
  */
void NuXLFragmentIonGenerator::generatePartialLossSpectrum(const std::string &unmodified_sequence,
                                                                         ...
                                                                         PeakSpectrum &partial_loss_spectrum)
{
  ...
  for (Size i = 0; i != partial_loss_modification.size(); ++i)
  {
    ...
    const std::string& fragment_shift_name = partial_loss_modification[i].name; // e.g. U-H2O
