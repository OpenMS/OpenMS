...
#       define SQLITECPP_HAVE_STD_EXPERIMENTAL_FILESYSTEM 0
...
#   if SQLITECPP_HAVE_STD_EXPERIMENTAL_FILESYSTEM
// Include it
...
#endif // #ifndef SQLITECPP_HAVE_STD_EXPERIMENTAL_FILESYSTEM
