...
template <typename VARIABLE_KEY, typename FUNCTION>
void node_bfs(std::initializer_list<MessagePasser<VARIABLE_KEY>* > queued_mps_il, FUNCTION function) {
  node_bfs(std::list<MessagePasser<VARIABLE_KEY>* >(queued_mps_il), function);
}
