...
namespace OpenMS
{
    ...
    */
    ...
    protected:
        ...
        /// allows for the iterative computation of intensity weighted of a mass trace's centroid m/z or ion mobility using Kahan summation
        static void updateIterativeWeightedMean_(double& centroid_value,
