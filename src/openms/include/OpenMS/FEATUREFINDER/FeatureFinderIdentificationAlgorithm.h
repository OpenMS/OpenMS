...
protected:
  ...
  double seed_apex_rt_tolerance_{0.0}; ///< max allowed RT deviation (s) between seed apex and detected feature apex; seed-derived features exceeding this are removed (0 = disabled)
