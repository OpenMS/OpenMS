...
public:
  ...
  double getObservedPrecursorCCS() const;
  void setObservedPrecursorCCS(const double&);
...
private:
  ...
  double observed_precursor_ccs_;
...
class OPENMS_DLLAPI MetaboliteSpectralMatching : public DefaultParamHandler, public ProgressLogger
{
public:
  /// Default constructor
