...
public:
    ...
    static void convertTargetedPeptide(const TargetedExperiment::Peptide& pep, OpenSwath::LightPeptideNuctideCompound& comp);

    /// convert from the OpenMS TargetedExperiment Nuctide to the LightTargetedExperiment Peptide
    static void convertTargetedNuctide(const TargetedExperiment::Nuctide& nuc, OpenSwath::LightPeptideNuctideCompound & n);

    /// convert from the OpenMS TargetedExperiment Compound to the LightTargetedExperiment Compound
    static void convertTargetedCompound(const TargetedExperiment::Compound& compound, OpenSwath::LightPeptideNuctideCompound& comp);
