...
namespace OpenMS
{
    ...
    */
    class OPENMS_DLLAPI DDAWorkflowCommons
    {
         ...
         * @return <std::map<std::string, String>> A map where keys are mzML file paths and values are corresponding id file paths.
         ...
         */
        static std::map<std::string, String> mapMzML2Ids(StringList & in, StringList & in_ids);
         ...
         *
         * @param[in] m2i <const std::map<std::string, String>&> The mzML to id file mapping generated by mapMzML2Ids.
         * @return <std::map<std::string, String>> A map where keys are id file paths and values are corresponding mzML file paths.
        */
        static std::map<std::string, String> mapId2MzMLs(const std::map<std::string, String>& m2i);
