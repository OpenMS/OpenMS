...
protected:
  ...
  /**
    ...
    It provides all the functionality of PeptideIdentificationList
    while maintaining type safety and allowing for future extensions.
    
    The class is designed to replace direct usage of PeptideIdentificationList
    throughout the OpenMS codebase to provide better type safety and 
    potential for future enhancements.
    
    @ingroup Metadata
  */
  class OPENMS_DLLAPI PeptideIdentificationList : public std::vector<PeptideIdentification>
  {
  public:
    /// Base type definition
    typedef std::vector<PeptideIdentification> Base;
    ...
    PeptideIdentificationList(const Base& base) : Base(base) {}
    
    /// Move constructor from base vector
    PeptideIdentificationList(Base&& base) : Base(std::move(base)) {}
    
    /// Constructor with size
    explicit PeptideIdentificationList(size_type count) : Base(count) {}
    
    /// Constructor with size and value
    PeptideIdentificationList(size_type count, const PeptideIdentification& value) : Base(count, value) {}
    
    /// Constructor from iterators
    template<class InputIt>
    PeptideIdentificationList(InputIt first, InputIt last) : Base(first, last) {}
    
    /// Constructor from initializer list
    PeptideIdentificationList(std::initializer_list<PeptideIdentification> init) : Base(init) {}
    
    /// Copy constructor
    PeptideIdentificationList(const PeptideIdentificationList&) = default;
    
    /// Move constructor
    PeptideIdentificationList(PeptideIdentificationList&&) noexcept = default;
    
    /// Destructor
    virtual ~PeptideIdentificationList() noexcept = default;
    //@}
    
    /// @name Assignment operators
    //@{
    /// Copy assignment
    PeptideIdentificationList& operator=(const PeptideIdentificationList&) = default;
    
    /// Move assignment
    PeptideIdentificationList& operator=(PeptideIdentificationList&&) noexcept = default;
    
    /// Assignment from base vector
    PeptideIdentificationList& operator=(const Base& base)
    {
      Base::operator=(base);
      return *this;
    }
    ...
    PeptideIdentificationList& operator=(Base&& base)
    {
