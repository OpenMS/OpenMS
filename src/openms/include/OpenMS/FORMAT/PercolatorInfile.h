...
public:
  ...
  */
  ...
  static String getScanIdentifier(const String& path_to_spectrum_file, const String& spectrum_native_id);
...
protected:
  ...
  static bool isEnz_(const char& n, const char& c, const ProteaseDigestion& digest);

  static Size countEnzymatic_(const String& peptide, const ProteaseDigestion& digest);
};
} // namespace OpenMS
