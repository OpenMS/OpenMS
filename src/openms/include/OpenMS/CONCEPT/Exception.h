...
namespace Exception
{
  ...
  */
  ...
  /**
    ...
    Throw this exception to indicate that a feature is not implemented or missing.

    @param[in] message Details about what's missing
  ...
  */
  ...
  {
  public:
    MissingFeature(const char* file, int line, const char* function, const std::string& message) noexcept;
  };
