...
namespace OpenMS
{
  ...
  /**
    ...
    For full functionality a PeakMap/MSRun with original m/z-values before m/z calibration generated by InternalCalibration has to be given.
  ...
  public:
     ...
     * @throws Exception::MissingInformation Meta value 'mz_raw' missing from MSRun
     **/
    void compute(FeatureMap& features, const MSRun& exp, const QCBase::SpectraMap& map_to_spectrum);
  ...
  private:
    ...
    void addMzMetaValues_(PeptideIdentification& peptide_ID, const MSRun& exp, const QCBase::SpectraMap& map_to_spectrum);
