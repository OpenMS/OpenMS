...
START_SECTION((TextFile(const std::string& filename, bool trim_lines = false, Int first_n = -1, bool skip_empty_lines = false) ))
...
START_SECTION((void load(const std::string& filename, bool trim_lines = false, Int first_n = -1, bool skip_empty_lines = false) ))
  TextFile file;
