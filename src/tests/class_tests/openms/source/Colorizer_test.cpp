...
START_SECTION(Colorizer(const ConsoleColor color))
{
  ...
  stringstream s;
  s << "-" << test("test") << "-";
  TEST_EQUAL(s.str(),std::string("-") + blueANSI + "test" + resetColorANSI + "-")
}
END_SECTION
...
START_SECTION(Colorizer& operator()())
{
  ...
  TEST_EQUAL(s.str(),std::string("-") + blueANSI + "test-" + test_int)
}
END_SECTION
...
START_SECTION(template<typename T> Colorizer& operator()(T s))
{
  ...
  TEST_EQUAL(s.str(),std::string("-") + magentaANSI + test_int + resetColorANSI + "test-" + test_int)
}
END_SECTION
...
START_SECTION(Colorizer& undo())
{
  Colorizer test(ConsoleColor::CYAN);
  {
    ...
    TEST_EQUAL(s.str(),std::string("-") + cyanANSI + "test" + test_int + resetColorANSI + "nocol")
  }
  ...
  TEST_EQUAL(s.str(),std::string("-") + cyanANSI + "test" + yellowANSI + test_int + resetColorANSI + "nocol")
}
END_SECTION
