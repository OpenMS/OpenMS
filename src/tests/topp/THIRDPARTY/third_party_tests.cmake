...
if (NOT (${SIRIUS_BINARY} STREQUAL "SIRIUS_BINARY-NOTFOUND"))
  ...
  if (ENABLE_SIRIUS_TEST)
    ...
    if ("${OS}" STREQUAL "Ubuntu") # mzMLs were created on Ubuntu. Since Sirius is nondeterministic we can only test there.
    ...
    if ("${OS}" STREQUAL "Ubuntu") # mzTabs were created on Ubuntu
    ...
    if ("${OS}" STREQUAL "Ubuntu") # mzTabs were created on Ubuntu
      add_test("TOPP_SiriusAdapter_9_out" ${DIFF} -in1 SiriusAdapter_9_output.tmp -in2 ${DATA_DIR_TOPP}/THIRDPARTY/SiriusAdapter_9_output.mzTab -whitelist "MTD" "373.041532365868022") # ranks of the compound at "522.38651805643201" m/z shifts depending on OS (Linux C28H49N7O or windows/macOS C25H47N9O3))
    ...
    if ("${OS}" STREQUAL "Ubuntu") # mzTabs were created on Ubuntu
      add_test("TOPP_SiriusAdapter_10_out" ${DIFF} -in1 SiriusAdapter_10_output.tmp -in2 ${DATA_DIR_TOPP}/THIRDPARTY/SiriusAdapter_10_output.mzTab -whitelist "MTD") # ranks of the compound at "522.38651805643201" m/z shifts depending on OS (Linux C28H49N7O or windows/macOS C25H47N9O3))
