...
if (NOT (${SIRIUS_BINARY} STREQUAL "SIRIUS_BINARY-NOTFOUND"))
  ...
  if (ENABLE_SIRIUS_TEST)
    ...
    if (APPLE) # mzMLs were created on macOS. Since Sirius is nondeterministic we can only test there.
      add_test("TOPP_SiriusAdapter_1_out_spec" ${DIFF} -in1 SiriusAdapter_1_output_spec.tmp -in2 ${DATA_DIR_TOPP}/THIRDPARTY/SiriusAdapter_1_ann_out.mzML -whitelist "annotated_sumformula" "annotated_adduct" "<binary>" "binaryDataArray" "dataProcessingList")
    ...
    if (APPLE)  # mzMLs were created on macOS. Since Sirius is nondeterministic we can only test there.
      add_test("TOPP_SiriusAdapter_3_out_spec" ${DIFF} -in1 SiriusAdapter_3_output_spec.tmp -in2 ${DATA_DIR_TOPP}/THIRDPARTY/SiriusAdapter_3_feat_only_ann_out.mzML -whitelist "annotated_sumformula" "annotated_adduct" "<binary>" "binaryDataArray")
    ...
    add_test("TOPP_SiriusAdapter_8_out" ${DIFF} -in1 SiriusAdapter_8_output.tmp -in2 ${DATA_DIR_TOPP}/THIRDPARTY/SiriusAdapter_8_output.mzTab -whitelist "MTD" "373.041532365868022" "330.995669248795025" "C10H7N2O9P" "C14H17IN2O2")
    ...
    add_test("TOPP_SiriusAdapter_9_out" ${DIFF} -in1 SiriusAdapter_9_output.tmp -in2 ${DATA_DIR_TOPP}/THIRDPARTY/SiriusAdapter_9_output.mzTab -whitelist "MTD" "522.38651805643201" "373.041532365868022" "468.391411753410011" "213.074829537142989" "C6H8N6O3" "C9H10N4O" "C25H49N5O3" "C14H17IN2O2") # ranks of the compound at "522.38651805643201" m/z shifts depending on OS (Linux C28H49N7O or windows/macOS C25H47N9O3))
    ...
    add_test("TOPP_SiriusAdapter_10_out" ${DIFF} -in1 SiriusAdapter_10_output.tmp -in2 ${DATA_DIR_TOPP}/THIRDPARTY/SiriusAdapter_10_output.mzTab -whitelist "MTD" "522.38651805643201" "213.074829537142989" "373.040157682534982" "614.173999999979969" "C6H8N6O3" "C9H10N4O") # ranks of the compound at "522.38651805643201" m/z shifts depending on OS (Linux C28H49N7O or windows/macOS C25H47N9O3))
