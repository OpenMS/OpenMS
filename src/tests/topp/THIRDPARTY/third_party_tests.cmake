...
## distinct from EXTERNAL_PROGRAM_NOTFOUND (14) above (issue #9460 §1, L41). /bin/false exists and exits 1,
## so the adapter runs it and maps the non-zero exit to code 9. Unix-only (no portable always-failing exe on Windows).
if (NOT WIN32)
  add_test("TOPP_CometAdapter_failing" ${TOPP_BIN_PATH}/CometAdapter -test -database ${DATA_DIR_TOPP}/THIRDPARTY/proteins.fasta -in ${DATA_DIR_TOPP}/THIRDPARTY/spectra.mzML -out Comet_failing_out.tmp.idXML -comet_executable "/bin/false")
