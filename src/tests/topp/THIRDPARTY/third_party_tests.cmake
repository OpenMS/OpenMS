...
if (NOT (${SIRIUS_BINARY} STREQUAL "SIRIUS_BINARY-NOTFOUND"))
  ...
  if (ENABLE_SIRIUS_TEST)
    ...
    if (LINUX) # mzMLs were created on Linux. Since Sirius is nondeterministic we can only test there.
    ...
    add_test("TOPP_SiriusAdapter_8_out" ${DIFF} -in1 SiriusAdapter_8_output.tmp -in2 ${DATA_DIR_TOPP}/THIRDPARTY/SiriusAdapter_8_output.mzTab -whitelist "MTD" "373.041532365868022" "330.995669248795025" "C10H7N2O9P" "C14H17IN2O2" "C25H49N5O3" "468.391411753410011")
