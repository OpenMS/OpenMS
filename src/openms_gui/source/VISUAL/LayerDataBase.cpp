...
*/
  ...
  bool LayerAnnotatorBase::annotateWithFileDialog(LayerDataBase& layer, LogWindow& log, const String& current_path) const
  {
    ...
    QString fname = QFileDialog::getOpenFileName(nullptr,
                                                 QString::fromStdString(file_dialog_text_),
                                                 QString::fromStdString(current_path),
                                                 QString::fromStdString(supported_types_.toFileDialogFilter(FilterLayout::BOTH, true)));
  ...
  bool LayerAnnotatorBase::annotateWithFilename(LayerDataBase& layer, LogWindow& log, const String& fname) const
  {
    ...
    {
      log.appendNewHeader(LogWindow::LogState::NOTICE, "Error", QString::fromStdString(String("Filename '" + fname + "' has unsupported file type. No annotation performed.")));
      return false;
    }
  ...
  bool LayerAnnotatorAMS::annotateWorker_(LayerDataBase& layer, const String& filename, LogWindow& log) const
  {
    ...
    QMessageBox::warning(nullptr, "Error", (QString::fromStdString(String("FeatureXML is currently only supported for files generated by the AccurateMassSearch tool (got '") + engine + "', expected 'AccurateMassSearch'.")));
    return false;
  }
