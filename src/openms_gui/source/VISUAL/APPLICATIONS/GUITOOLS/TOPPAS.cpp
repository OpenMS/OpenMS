...
int main(int argc, const char** argv)
{
  ...
  if (param.exists("unknown"))
  {
    ...
    // in Param.h
    if (!(StringUtils::hasSubstring(StringUtils::toStr(param.getValue("unknown").toString()), "-psn") && !StringUtils::hasSubstring(StringUtils::toStr(param.getValue("unknown").toString()), ", ")))
    {
