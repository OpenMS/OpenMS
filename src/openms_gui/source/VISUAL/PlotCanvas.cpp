...
namespace OpenMS
{
  ...
  void PlotCanvas::saveCurrentLayer(bool visible)
  {
    ...
    QString file_name = GUIHelpers::getSaveFilename(this, "Save file", QString::fromStdString(proposed_name), formats, true, formats.getTypes().front());
  ...
  void setBaseLayerParameters(LayerDataBase* new_layer, const Param& param, const String& filename, const String& caption)
  {
    ...
    {
      new_layer->setName(QFileInfo(QString::fromStdString(filename)).completeBaseName());
    }
  }
