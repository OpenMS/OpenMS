...
namespace OpenMS
{
  ...
  {
    ChromatogramPeak peak_lt(area.getMinRT(), static_cast<ChromatogramPeak::IntensityType>(area.getMinIntensity()));
    ChromatogramPeak peak_rb(area.getMaxRT(), static_cast<ChromatogramPeak::IntensityType>(area.getMaxIntensity()));
