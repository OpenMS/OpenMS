...
namespace OpenMS
{
                        ...
                        const String& filename)
  {
    ...
    for (const auto& index : indices)
    {
      ...
      if (chrom_exp_sptr->getMSExperiment().metaValueExists("transition_group_name"))
      {
        basename_suffix = String(chrom_exp_sptr->getMSExperiment().getMetaValue("transition_group_name"));
      }
