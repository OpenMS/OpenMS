...
namespace OpenMS
{
    ...
    canvas_3d_(canvas_3d)
  {
    ...
    x_label_ = toQString(StringUtils::toStr(Peak2D::shortDimensionName(Peak2D::MZ)) + " [" + StringUtils::toStr(Peak2D::shortDimensionUnit(Peak2D::MZ)) + "]");
    y_label_ = toQString(StringUtils::toStr(Peak2D::shortDimensionName(Peak2D::RT)) + " [" + StringUtils::toStr(Peak2D::shortDimensionUnit(Peak2D::RT)) + "]");
  ...
  void Plot3DOpenGLCanvas::initializeGL()
  {
    ...
    QColor color(toQString(StringUtils::toStr(canvas_3d_.param_.getValue("background_color").toString())));
