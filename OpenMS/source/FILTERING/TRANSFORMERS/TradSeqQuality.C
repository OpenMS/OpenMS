...
namespace OpenMS{
    ...
    :FilterFunctor()
  {
    ...
    defaults_.setValue("xcorr_1+", 1.9, "min XCorr for charge state 1", false);
    defaults_.setValue("xcorr_2+", 2.2, "min XCorr for charge state 2", false);
    defaults_.setValue("xcorr_3+", 3.75, "min XCorr for charge state 3", false);

    defaults_.setValue("dCn_1+", 0.08, "min deltaCN for charge state 1", false);
    defaults_.setValue("dCn_2+", 0.08, "min deltaCN for charge state 2", false);
    defaults_.setValue("dCn_3+", 0.08, "min deltaCN for charge state 3", false);
		defaultsToParam_();
  }
