                ...
                if nextline.startswith(">"):
                    ...
                    if len(bounds) >= 1:
                        ...
                        if descr_upper_index != -1:
                            ...
                            os_upper_index = protein_declaration.find(
                                "(", descr_upper_index
                            )
                        ...
                        if os_upper_index == -1:
                            ...
                            if descr_upper_index != -1:
                                stringFrom_OS_TillEndOfLine = protein_declaration[
                                    descr_upper_index + 3 :
                                ]
                                listOfAllWordsTillEndOfLine = (
                                    stringFrom_OS_TillEndOfLine.split()
                                )
                                os = (
                                    listOfAllWordsTillEndOfLine[0]
                                    + " "
                                    + listOfAllWordsTillEndOfLine[1]
                                )
                        ...
                        if descr_upper_index != -1:
                            if len(bounds) == 1:
                                name = protein_declaration[
                                    bounds[0] + 1 : descr_upper_index
                                ]
                            else:
                                name = protein_declaration[
                                    bounds[1] + 1 : descr_upper_index
                                ]
                        ...
                        if (
                            protein_declaration.startswith(">DECOY")
                            or check_if_reverse != -1
                            or check_for_extra_pattern != -1
                        ):
                            ...
                            if os_upper_index == -1 or descr_upper_index == -1:
                                ...
                                proteinOSListDECOY.append(
                                    (
                                        protein_declaration[
                                            descr_upper_index + 3 : os_upper_index
                                        ]
                                    )
                                )
...
def main():
    ...
    (
        ...
        proteinNameListDECOY,
        proteinOSListDECOY,
    ) = LoadFasta_FastaViewer.protein_dictionary(
