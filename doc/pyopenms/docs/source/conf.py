...
# if not built from release branch or version tag (e.g. "v3.5.0", "3.5.0")
elif (
    not rtd_branch.startswith("release")
    and not rtd_branch.startswith("Release")
    and not rtd_branch.lstrip("vV")[:1].isdigit()
):
    release += "dev"
...
latex_documents = [
    (master_doc, "pyOpenMS.tex", "pyOpenMS Documentation", "OpenMS Team", "manual"),
]
...
man_pages = [(master_doc, "pyopenms", "pyOpenMS Documentation", [author], 1)]
