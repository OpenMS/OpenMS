...
Also, TOPPAS can only chain OpenMS TOPP tools; it no longer supports calling external (non-OpenMS) executables as workflow nodes. We generally recommend to run only OpenMS-specific tools in TOPPAS
