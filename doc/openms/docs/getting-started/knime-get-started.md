...
Read through an introduction to OpenMS in KNIME [user tutorial](/tutorials/knime-user-tutorial.md) containing hands-on training material covering also basic
...
Follow the guide to [create your own minimal KNIME workflow](knime/minimal-workflow.md).
