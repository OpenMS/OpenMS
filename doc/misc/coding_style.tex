...
macros.  {\tt \_\_PRETTY\_FUNCTION\_\_} is filled in by the GNU compiler and
\verb|#define|d to \verb|"<unknown>"| on other platforms. {\bf GeneralException} provides two
methods ({\tt getFile} and {\tt getLine}) that allow the localization of the
exception's cause.
