...
if(WM5_FOUND)
  ...
  if(NOT TARGET WM5::WM5)
    ...
    set_property(TARGET WM5::WM5 PROPERTY INCLUDE_DIRECTORIES "${WM5_INCLUDE_DIR}")
    set_property(TARGET WM5::WM5 PROPERTY INTERFACE_INCLUDE_DIRECTORIES "${WM5_INCLUDE_DIR}")
    set_property(TARGET WM5::WM5 PROPERTY COMPILE_DEFINITIONS "${WM5_DEFINITIONS}")
  endif()
