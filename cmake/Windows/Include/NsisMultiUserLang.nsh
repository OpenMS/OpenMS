!ifdef LANG_ENGLISH
	...
	LangString MULTIUSER_ALL_USERS ${LANG_ENGLISH} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_ENGLISH} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_ENGLISH} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_AFRIKAANS
	...
	LangString MULTIUSER_ALL_USERS ${LANG_AFRIKAANS} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_AFRIKAANS} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_AFRIKAANS} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_ALBANIAN
	...
	LangString MULTIUSER_ALL_USERS ${LANG_ALBANIAN} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_ALBANIAN} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_ALBANIAN} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_ARABIC
	...
	LangString MULTIUSER_ALL_USERS ${LANG_ARABIC} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_ARABIC} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_ARABIC} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_ARMENIAN
	...
	LangString MULTIUSER_ALL_USERS ${LANG_ARMENIAN} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_ARMENIAN} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_ARMENIAN} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_ASTURIAN
	...
	LangString MULTIUSER_ALL_USERS ${LANG_ASTURIAN} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_ASTURIAN} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_ASTURIAN} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_BASQUE
	...
	LangString MULTIUSER_ALL_USERS ${LANG_BASQUE} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_BASQUE} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_BASQUE} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_BELARUSIAN
	...
	LangString MULTIUSER_ALL_USERS ${LANG_BELARUSIAN} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_BELARUSIAN} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_BELARUSIAN} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_BOSNIAN
	...
	LangString MULTIUSER_ALL_USERS ${LANG_BOSNIAN} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_BOSNIAN} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_BOSNIAN} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_BRETON
	...
	LangString MULTIUSER_ALL_USERS ${LANG_BRETON} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_BRETON} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_BRETON} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_BULGARIAN
	...
	LangString MULTIUSER_ALL_USERS ${LANG_BULGARIAN} "За &всеки, който използва този компютър (всички потребители)$\r$\n(Забележка: Програмата за инсталиране ще се рестартира с повишени привилегии)"
	LangString MULTIUSER_CURRENT_USER ${LANG_BULGARIAN} "За &мен ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_BULGARIAN} "За всеки, който използва този компютър (всички потребители)$\r$\n(Забележка: Програмата за инсталиране ще се рестартира с повишени привилегии)"
...
!ifdef LANG_CATALAN
	...
	LangString MULTIUSER_ALL_USERS ${LANG_CATALAN} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_CATALAN} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_CATALAN} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_CORSICAN
	...
	LangString MULTIUSER_ALL_USERS ${LANG_CORSICAN} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_CORSICAN} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_CORSICAN} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_CROATIAN
	...
	LangString MULTIUSER_ALL_USERS ${LANG_CROATIAN} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_CROATIAN} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_CROATIAN} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_CZECH
	...
	LangString MULTIUSER_ALL_USERS ${LANG_CZECH} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_CZECH} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_CZECH} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_DANISH
	...
	LangString MULTIUSER_ALL_USERS ${LANG_DANISH} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_DANISH} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_DANISH} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_DUTCH
	...
	LangString MULTIUSER_ALL_USERS ${LANG_DUTCH} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_DUTCH} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_DUTCH} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_ESPERANTO
	...
	LangString MULTIUSER_ALL_USERS ${LANG_ESPERANTO} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_ESPERANTO} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_ESPERANTO} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_ESTONIAN
	...
	LangString MULTIUSER_ALL_USERS ${LANG_ESTONIAN} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_ESTONIAN} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_ESTONIAN} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_FARSI
	...
	LangString MULTIUSER_ALL_USERS ${LANG_FARSI} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_FARSI} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_FARSI} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_FINNISH
	...
	LangString MULTIUSER_ALL_USERS ${LANG_FINNISH} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_FINNISH} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_FINNISH} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_FRENCH
	...
	LangString MULTIUSER_ALL_USERS ${LANG_FRENCH} "For &anyone who uses this computer (all users)$\r$\n(Note: Le programme d'installation redémarrera avec des privilèges élevés)"
	LangString MULTIUSER_CURRENT_USER ${LANG_FRENCH} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_FRENCH} "For anyone who uses this computer (all users)$\r$\n(Note: Le programme d'installation redémarrera avec des privilèges élevés)"
...
!ifdef LANG_GALICIAN
	...
	LangString MULTIUSER_ALL_USERS ${LANG_GALICIAN} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_GALICIAN} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_GALICIAN} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_GEORGIAN
	...
	LangString MULTIUSER_ALL_USERS ${LANG_GEORGIAN} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_GEORGIAN} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_GEORGIAN} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_GERMAN
	...
	LangString MULTIUSER_ALL_USERS ${LANG_GERMAN} "Für &jeden, der diesen Computer benutzt (alle Benutzer)$\r$\n(Hinweis: Das Installationsprogramm wird mit erhöhten Rechten neu gestartet)"
	LangString MULTIUSER_CURRENT_USER ${LANG_GERMAN} "Für &mich ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_GERMAN} "Für jeden, der diesen Computer benutzt (alle Benutzer)$\r$\n(Hinweis: Das Installationsprogramm wird mit erhöhten Rechten neu gestartet)"
...
!ifdef LANG_GREEK
	...
	LangString MULTIUSER_ALL_USERS ${LANG_GREEK} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_GREEK} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_GREEK} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_HEBREW
	...
	LangString MULTIUSER_ALL_USERS ${LANG_HEBREW} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_HEBREW} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_HEBREW} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_HUNGARIAN
	...
	LangString MULTIUSER_ALL_USERS ${LANG_HUNGARIAN} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_ICELANDIC
	...
	LangString MULTIUSER_ALL_USERS ${LANG_ICELANDIC} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_ICELANDIC} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_ICELANDIC} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_INDONESIAN
	...
	LangString MULTIUSER_ALL_USERS ${LANG_INDONESIAN} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_INDONESIAN} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_INDONESIAN} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_IRISH
	...
	LangString MULTIUSER_ALL_USERS ${LANG_IRISH} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_IRISH} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_IRISH} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_ITALIAN
	...
	LangString MULTIUSER_ALL_USERS ${LANG_ITALIAN} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_JAPANESE
	...
	LangString MULTIUSER_ALL_USERS ${LANG_JAPANESE} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_JAPANESE} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_JAPANESE} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_KOREAN
	...
	LangString MULTIUSER_ALL_USERS ${LANG_KOREAN} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_KOREAN} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_KOREAN} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_KURDISH
	...
	LangString MULTIUSER_ALL_USERS ${LANG_KURDISH} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_KURDISH} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_KURDISH} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_LATVIAN
	...
	LangString MULTIUSER_ALL_USERS ${LANG_LATVIAN} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_LATVIAN} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_LATVIAN} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_LITHUANIAN
	...
	LangString MULTIUSER_ALL_USERS ${LANG_LITHUANIAN} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_LITHUANIAN} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_LITHUANIAN} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_LUXEMBOURGISH
	...
	LangString MULTIUSER_ALL_USERS ${LANG_LUXEMBOURGISH} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_LUXEMBOURGISH} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_LUXEMBOURGISH} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_MACEDONIAN
	...
	LangString MULTIUSER_ALL_USERS ${LANG_MACEDONIAN} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_MACEDONIAN} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_MACEDONIAN} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_MALAY
	...
	LangString MULTIUSER_ALL_USERS ${LANG_MALAY} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_MALAY} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_MALAY} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_MONGOLIAN
	...
	LangString MULTIUSER_ALL_USERS ${LANG_MONGOLIAN} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_MONGOLIAN} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_MONGOLIAN} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_NORWEGIAN
	...
	LangString MULTIUSER_ALL_USERS ${LANG_NORWEGIAN} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_NORWEGIAN} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_NORWEGIAN} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_NORWEGIANNYNORSK
	...
	LangString MULTIUSER_ALL_USERS ${LANG_NORWEGIANNYNORSK} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_NORWEGIANNYNORSK} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_NORWEGIANNYNORSK} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_PASHTO
	...
	LangString MULTIUSER_ALL_USERS ${LANG_PASHTO} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_PASHTO} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_PASHTO} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_POLISH
	...
	LangString MULTIUSER_ALL_USERS ${LANG_POLISH} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_POLISH} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_POLISH} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_PORTUGUESE
	...
	LangString MULTIUSER_ALL_USERS ${LANG_PORTUGUESE} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_PORTUGUESE} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_PORTUGUESE} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_PORTUGUESEBR
	...
	LangString MULTIUSER_ALL_USERS ${LANG_PORTUGUESEBR} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_PORTUGUESEBR} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_PORTUGUESEBR} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_ROMANIAN
	...
	LangString MULTIUSER_ALL_USERS ${LANG_ROMANIAN} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_ROMANIAN} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_ROMANIAN} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_RUSSIAN
	...
	LangString MULTIUSER_ALL_USERS ${LANG_RUSSIAN} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_RUSSIAN} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_RUSSIAN} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_SCOTSGAELIC
	...
	LangString MULTIUSER_ALL_USERS ${LANG_SCOTSGAELIC} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_SERBIAN
	...
	LangString MULTIUSER_ALL_USERS ${LANG_SERBIAN} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_SERBIAN} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_SERBIAN} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_SERBIANLATIN
	...
	LangString MULTIUSER_ALL_USERS ${LANG_SERBIANLATIN} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_SIMPCHINESE
	...
	LangString MULTIUSER_ALL_USERS ${LANG_SIMPCHINESE} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_SIMPCHINESE} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_SIMPCHINESE} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_SLOVAK
	...
	LangString MULTIUSER_ALL_USERS ${LANG_SLOVAK} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_SLOVAK} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_SLOVAK} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_SLOVENIAN
	...
	LangString MULTIUSER_ALL_USERS ${LANG_SLOVENIAN} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_SLOVENIAN} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_SLOVENIAN} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_SPANISH
	...
	LangString MULTIUSER_ALL_USERS ${LANG_SPANISH} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_SPANISH} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_SPANISH} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_SPANISHINTERNATIONAL
	...
	LangString MULTIUSER_ALL_USERS ${LANG_SPANISHINTERNATIONAL} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_SPANISHINTERNATIONAL} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_SPANISHINTERNATIONAL} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_SWEDISH
	...
	LangString MULTIUSER_ALL_USERS ${LANG_SWEDISH} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_SWEDISH} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_SWEDISH} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_TATAR
	...
	LangString MULTIUSER_ALL_USERS ${LANG_TATAR} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_TATAR} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_TATAR} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_THAI
	...
	LangString MULTIUSER_ALL_USERS ${LANG_THAI} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_THAI} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_THAI} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_TRADCHINESE
	...
	LangString MULTIUSER_ALL_USERS ${LANG_TRADCHINESE} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_TRADCHINESE} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_TRADCHINESE} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_TURKISH
	...
	LangString MULTIUSER_ALL_USERS ${LANG_TURKISH} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_TURKISH} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_TURKISH} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_UKRAINIAN
	...
	LangString MULTIUSER_ALL_USERS ${LANG_UKRAINIAN} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_UKRAINIAN} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_UKRAINIAN} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_UZBEK
	...
	LangString MULTIUSER_ALL_USERS ${LANG_UZBEK} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_UZBEK} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_UZBEK} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_VIETNAMESE
	...
	LangString MULTIUSER_ALL_USERS ${LANG_VIETNAMESE} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_VIETNAMESE} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_VIETNAMESE} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
...
!ifdef LANG_WELSH
	...
	LangString MULTIUSER_ALL_USERS ${LANG_WELSH} "For &anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
	LangString MULTIUSER_CURRENT_USER ${LANG_WELSH} "For &me ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_WELSH} "For anyone who uses this computer (all users)$\r$\n(Note: The installer will restart with elevated privileges)"
