...
#ifndef OPENMS_CONCEPT_FACTORYPRODUCT2_H
#define OPENMS_CONCEPT_FACTORYPRODUCT2_H
...
namespace OpenMS
{
  ...
  class FactoryProduct2
  	: public DefaultParamHandler
  {
		public:
			/// Constructor
			FactoryProduct2(const String& name);
			
			/// Copy constructor 
			FactoryProduct2(const FactoryProduct2& source);
			
			/// Assignment operator
			virtual FactoryProduct2& operator = (const FactoryProduct2& source);
			
			/// Equality operator
			virtual bool operator == (const FactoryProduct2& rhs) const;
...
#endif // OPENMS_CONCEPT_FACTORYPRODUCT2_H
