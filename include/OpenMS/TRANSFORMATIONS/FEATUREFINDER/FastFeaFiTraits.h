...
//
// --------------------------------------------------------------------------
// $Id: FastFeaFiTraits.h,v 1.6 2006/04/25 12:41:44 ole_st Exp $
// $Author: ole_st $
// $Maintainer: Ole Schulz-Trieglaff $
// --------------------------------------------------------------------------

#ifndef OPENMS_TRANSFORMATIONS_FEATUREFINDER_FASTFEAFITRAITS_H
#define OPENMS_TRANSFORMATIONS_FEATUREFINDER_FASTFEAFITRAITS_H
...
namespace OpenMS
{
	...
	/**
	  @brief Fast (!) implementation of the BaseFeaFiTraits class.	 
	  
	  NOTE: Do not use this class. Use SimpleFeaFiTraits or ExtendedFeaFiTraits
	  instead. Currently this implementation is not finished.
  ...
  public:
    ...
    /// destructor 
    virtual ~FastFeaFiTraits();

    /// add peak to internal datastructure 
    void addSinglePeak(const DRawDataPoint<2>& peak);
    
    /// set fill the internal data structure using an instance of MSExperiment.
    ...
    */
    ...
    {
      return new FastFeaFiTraits();
    }

    static const String getName()
    {
      return "FastFeaFiTraits";
    }
   
  protected:
  
  	/** @brief Sort the peaks according by their position.
	       ...
	       In 1D m/z, in the 2D case m/z and rt. That is,
	 			 ...
	 			 then sorted by m/z. In addition, we initialise 
	 			 the vector of scan indizes to quickly retrieve 
	 			 the scan number of a peak.
	 	*/
  	void sortData_();
...
#endif // OPENMS_TRANSFORMATIONS_FEATUREFINDER_FASTFEAFITRAITS_H
