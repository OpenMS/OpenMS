...
namespace OpenMS
{
  ...
  */
  ...
  private:
	...
	template<typename PeakType>
  void ExternalCalibration::calibrate(MSExperiment<RawDataPointType>& calib_spectra,MSExperiment<PeakType >& exp,
																			std::vector<double>& exp_masses)
	{
  ...
  template<typename PeakType>
  void ExternalCalibration::calibrate(MSExperiment<PickedPeakType>& calib_spectra,MSExperiment<PeakType >& exp,
																			std::vector<double>& exp_masses)
  {
