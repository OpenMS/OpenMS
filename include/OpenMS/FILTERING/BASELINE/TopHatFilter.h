...
public:
    ...
    void filter(InputPeakIterator first, InputPeakIterator last, OutputPeakContainer& baseline_filtered_container)
    {
        ...
        this->template erosion<InputPeakIterator>(first, last, erosion_result, struc_elem_number_of_points);
        // compute the dilation of erosion_result
        this->template dilatation<InputPeakIterator>(erosion_result.begin(),erosion_result.end(), baseline_filtered_container, struc_elem_number_of_points);
        // subtract the result from the original data
        this->template minusIntensities_<InputPeakIterator>(first,last,baseline_filtered_container);
    }
