...
namespace OpenMS
{
  ...
  void FeatureMapHandler<D,FeatureT>::endElement(const XMLCh* const /*uri*/, const XMLCh* const /*local_name*/, const XMLCh* const qname)
	{
  ...
  template <Size D, typename FeatureT>
  void FeatureMapHandler<D,FeatureT>::startElement(const XMLCh* const /*uri*/, const XMLCh* const /*local_name*/, const XMLCh* const qname, const xercesc::Attributes& attributes)
	{
		if (is_parser_in_tag_[DESCRIPTION])	// collect Experimental Settings
		{
			exp_sett_ << '<' << xercesc::XMLString::transcode(qname);
	...
	template <Size D, typename FeatureT>
  void FeatureMapHandler<D,FeatureT>::characters(const XMLCh* const chars, const unsigned int /*length*/)
  {
		if (is_parser_in_tag_[DESCRIPTION])	// collect Experimental Settings
		{
	...
	template <Size D, typename FeatureT>
 	void FeatureMapHandler<D,FeatureT>::writeTo(std::ostream& os)
	{
