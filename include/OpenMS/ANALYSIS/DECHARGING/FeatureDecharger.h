...
namespace OpenMS
{
  /** 
    ...
    are written in a feature file. Intensities of charge variants are summed up. The position of the zero charge
  ...
  class FeatureDecharger : public DefaultParamHandler
  {
    public:
      ...
      */
      ...
      {
        defaults_.setValue("cluster_RT_MZ_relation", 100); // factor*MZ equals MZ corrected space
