...
namespace OpenMS
{
  ...
  {
    Factory< BasePairwiseMapMatcher<PointMapType> >::registerProduct(GeomHashPairwiseMapMatcher<PointMapType>::getName(), &GeomHashPairwiseMapMatcher<PointMapType>::create);
  }
