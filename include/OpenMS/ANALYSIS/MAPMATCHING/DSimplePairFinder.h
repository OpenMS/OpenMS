...
//
// --------------------------------------------------------------------------
// $Id: DSimplePairFinder.h,v 1.6 2006/05/02 09:39:07 ole_st Exp $
// $Author: ole_st $
// $Maintainer: Eva Lange $
// --------------------------------------------------------------------------


#ifndef OPENMS_ANALYSIS_MAPMATCHING_DSIMPLEPAIRFINDER_H
#define OPENMS_ANALYSIS_MAPMATCHING_DSIMPLEPAIRPFINDER_H

#include <OpenMS/ANALYSIS/MAPMATCHING/DBasePairFinder.h>

#if defined OPENMS_DEBUG && ! defined V_DSimplePairFinder
#define V_DSimplePairFinder(bla) // std::cout << bla << std::endl;
#else
#define V_DSimplePairFinder(bla)
#endif
...
namespace OpenMS
{
  ...
  /**
     @brief This class implements a simple feature pair finding algorithm.
  ...
  **/
  ...
  class DSimplePairFinder : public DBasePairFinder<D,Traits,MapT>
  {
  public:
    ...
    /// Copy constructor
    DSimplePairFinder(const DSimplePairFinder& source)
        : Base(source),
    ...
    ///  Assignment operator
    virtual DSimplePairFinder& operator = (DSimplePairFinder source)
    {
    ...
    virtual void run()
    {
			...
			V_DSimplePairFinder("DSimplePairFinder::run(): parse parameters");
      ...
      transformed_positions_second_map_.resize(n);
			...
			V_DSimplePairFinder("DSimplePairFinder::run(): apply transformation");
			...
			V_DSimplePairFinder("DSimplePairFinder::run(): find feature pairs");
  ...
  protected:
    ...
    void parseParam_()
    {
#define V_parseParam_(bla) V_DSimplePairFinder(bla)
...
#undef V_parseParam_
    ...
    {
#define V_findFeaturePairs_(bla) V_DSimplePairFinder(bla)
...
#undef V_findFeaturePairs_
    ...
    */
    QualityType similarity_ ( FeatureType const & left, FeatureType const & right, const PositionType& new_position) const
    {
...
#endif  // OPENMS_ANALYSIS_MAPMATCHING_DSimplePairFinder_H
