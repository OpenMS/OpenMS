...
namespace OpenMS
{
	/**
	  @brief  run with CompNovoIonScoring
		...
		@ingroup Analysis_ID
	*/
	class CompNovoIonScoring : public CompNovoIonScoringBase
	{
		...
		public:
			 ...
			 */
			//@{
			void scoreSpectra(Map<double, IonScore>& CID_ion_scores, PeakSpectrum& CID_spec, PeakSpectrum& ETD_spec, double precursor_weight, UInt charge);
			//@}

		protected:

			void scoreETDFeatures_(int charge, double precursor_weight, Map<double, IonScore>& CID_nodes, const PeakSpectrum& CID_orig_spec, const PeakSpectrum& ETD_orig_spec);
