...
namespace OpenMS
{
  ...
  /**
  	...
  	- hide the derived class in the OpenMS documentation by using doxygen codition macros.
		...
		@todo Create infrastructure for command line arguments that are lists as soon as lists are implemented in Param, use the infrastructure in all TOPP tools that take lists as arguments e.g. file lists (Johannes)
  */
  class TOPPBase
  {
    public:
