...
int deprecated_gsl_multifit_fdfsolver_set ( 		deprecated_gsl_multifit_fdfsolver* s, 		deprecated_gsl_multifit_function_fdf* fdf, 		const deprecated_gsl_vector* x);
deprecated_gsl_multifit_function_fdf_ptr deprecated_wrapper_gsl_multifit_fdfsolver_lmsder_new(    int (* f) (const deprecated_gsl_vector * x, void * params, deprecated_gsl_vector * f),    int (* df) (const deprecated_gsl_vector * x, void * params, deprecated_gsl_matrix * df),    int (* fdf) (const deprecated_gsl_vector * x, void * params, deprecated_gsl_vector * f, deprecated_gsl_matrix *df),     size_t n,   /* number of functions */     size_t p,   /* number of independent variables */     void * params );
const deprecated_gsl_multifit_fdfsolver_type * deprecated_wrapper_get_multifit_fdfsolver_lmsder();
const deprecated_gsl_vector* deprecated_wrapper_gsl_vector_view_get_vector( deprecated_gsl_vector_view_ptr v );
deprecated_gsl_vector* deprecated_wrapper_gsl_multifit_fdfsolver_get_x( deprecated_gsl_multifit_fdfsolver* s );
deprecated_gsl_vector* deprecated_wrapper_gsl_multifit_fdfsolver_get_f( deprecated_gsl_multifit_fdfsolver* s );
deprecated_gsl_vector* deprecated_wrapper_gsl_multifit_fdfsolver_get_dx( deprecated_gsl_multifit_fdfsolver* s );
deprecated_gsl_matrix* deprecated_wrapper_gsl_multifit_fdfsolver_get_J( deprecated_gsl_multifit_fdfsolver* s );
...
//vector -> std or Eigen (depends on the usage)
...
size_t deprecated_wrapper_gsl_interp_type_get_min_size( const deprecated_gsl_interp_type * t );
const deprecated_gsl_interp_type * deprecated_wrapper_get_gsl_interp_linear();
const deprecated_gsl_interp_type * deprecated_wrapper_get_gsl_interp_polynomial();
const deprecated_gsl_interp_type * deprecated_wrapper_get_gsl_interp_cspline();
const deprecated_gsl_interp_type * deprecated_wrapper_get_gsl_interp_akima();
