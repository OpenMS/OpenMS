	...
	*/
		...
		: public Peak2D
	{
		...
		*/
		...
		inline const ModelDescription<2>& getModelDescription() const { return model_desc_; }
		/// Mutable access to the model description
		inline ModelDescription<2>& getModelDescription() { return model_desc_; }
		/// Set the model description
		inline void setModelDescription(const ModelDescription<2>& q) { model_desc_ = q; }
