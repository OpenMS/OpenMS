...
//
// --------------------------------------------------------------------------
// $Id: IndexSet.h,v 1.7 2006/03/06 18:47:49 marc_sturm Exp $
// $Author: marc_sturm $
...
namespace OpenMS
{
  ...
  public:   
    ...
    */
    IndexSet& add(UnsignedInt index);
    ...
    /** 
    	...
    	\return enables concatenation of multiple calls to add
    */
    IndexSet& add(UnsignedInt index_from, UnsignedInt index_to);
    ...
    */
    IndexSet& remove(UnsignedInt index);
    ...
    /** 
    	...
    	\return enables concatenation of multiple calls to remove
    */
    IndexSet& remove(UnsignedInt index_from, UnsignedInt index_to);
