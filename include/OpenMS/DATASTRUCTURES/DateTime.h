...
//
// --------------------------------------------------------------------------
// $Id: DateTime.h,v 1.1 2006/06/09 23:47:35 nicopfeifer Exp $
// $Author: nicopfeifer $
	...
	*/
	class DateTime : Date
	{
		public:
			...
			*/
			void set(UnsignedInt month, UnsignedInt day, UnsignedInt year,
			...
			*/
			void get(UnsignedInt& month, UnsignedInt& day, UnsignedInt& year,
