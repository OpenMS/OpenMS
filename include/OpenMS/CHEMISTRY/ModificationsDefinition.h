...
#ifndef OPENMS_CHEMISTRY_MODIFICATIONSDEFINITION_H
#define OPENMS_CHEMISTRY_MODIFICATIONSDEFINITION_H
...
namespace OpenMS
{
	...
	*/
	class ModificationsDefinition
	{
		public:
			...
			*/
			//@{
			/// default constructor
			ModificationsDefinition();

			/// copy constructor
			ModificationsDefinition(const ModificationsDefinition& element);

			/// detailed constructor
			ModificationsDefinition(const String& name,
							const String& symbol,
							UInt atomic_number,
			...
			/// destructor
			virtual ~ModificationsDefinition();
			//@}
			...
			*/
			//@{
			/// assignment operator
			ModificationsDefinition& operator = (const ModificationsDefinition& element);
			//@}
			...
			*/
			//@{
			/// equality operator
			bool operator == (const ModificationsDefinition& element) const;
			...
			friend std::ostream& operator << (std::ostream& os, const ModificationsDefinition& element);
	...
	std::ostream& operator << (std::ostream&, const ModificationsDefinition&);
