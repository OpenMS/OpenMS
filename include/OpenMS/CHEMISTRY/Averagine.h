...
class Averagine
{
	public:
		...
		static std::vector<RawDataPoint1D> getModel (const double mz_pos, const unsigned int charge, 
				std::pair<double, double>* pattern_extend=NULL, const double cut_off=0.01) throw ();
