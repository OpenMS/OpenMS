...
- [Build with vcpkg](https://abibuilder.cs.uni-tuebingen.de/archive/openms/Documentation/release/latest/html/install_vcpkg.html) - **Recommended**: Cross-platform build using vcpkg for dependency management.
