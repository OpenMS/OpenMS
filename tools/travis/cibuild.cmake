...
if("$ENV{ENABLE_STYLE_TESTING}" STREQUAL "OFF")
  if("$ENV{PYOPENMS}" STREQUAL "ON")
    ...
    ctest_build(BUILD "${CTEST_BINARY_DIRECTORY}" TARGET "TOPP" NUMBER_ERRORS _build_errors)
  endif()
else()
	set(_build_errors 0)
endif()
...
if("$ENV{PYOPENMS}" STREQUAL "ON")
  ctest_test(BUILD "${CTEST_BINARY_DIRECTORY}" INCLUDE "pyopenms" PARALLEL_LEVEL 2)
else()
  ctest_test(BUILD "${CTEST_BINARY_DIRECTORY}" INCLUDE "TOPP" PARALLEL_LEVEL 2)
endif()
## send to CDash
ctest_submit()
