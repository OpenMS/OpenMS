...
label: TOFCalibration
doc: Applies time of flight calibration.
inputs:
  in:
    doc: "input peak or raw data file "
    type: File
  out:
    doc: "output file "
    type: string
  ext_calibrants:
    ...
    type: File
  ref_masses:
    doc: input file containing reference masses of the external calibrant spectra (one per line)
    type: File
  tof_const:
    doc: "File containing TOF conversion constants. These can be either two or three constants\nper set, depending on the conversion type. Either one set for all calibrant spectra \n(tab separated), or one for each spectrum.\nFor a detailed description, please have a look at the doxygen documentation.(one set, tab separated, per line)"
    type: File
  peak_data:
    doc: set this flag, if you have peak data, not raw data (the picking parameters are accessible only from the INI file).
    type: boolean?
  log:
  ...
  test:
    ...
    type: boolean?
  algorithm__PeakPicker__signal_to_noise:
    doc: Minimal signal to noise ratio for a peak to be picked.
    type: double?
  algorithm__PeakPicker__centroid_percentage:
  ...
  algorithm__PeakPicker__fwhm_lower_bound_factor:
    ...
    type: double?
  algorithm__PeakPicker__fwhm_upper_bound_factor:
  ...
  algorithm__PeakPicker__wavelet_transform__spacing:
    ...
    type: double?
  algorithm__PeakPicker__optimization__type:
  ...
  algorithm__PeakPicker__optimization__penalties__left_width:
    ...
    type: double?
  algorithm__PeakPicker__optimization__penalties__right_width:
    ...
    type: double?
  algorithm__PeakPicker__optimization__penalties__height:
    ...
    type: double?
  algorithm__PeakPicker__optimization__2d__tolerance_mz:
    doc: mz tolerance for cluster construction
    type: double?
  algorithm__PeakPicker__optimization__2d__max_peak_distance:
    doc: maximal peak distance in mz in a cluster
    type: double?
  algorithm__PeakPicker__deconvolution__deconvolution:
    doc: If you want heavily overlapping peaks to be separated set this value to "true"
    type: boolean?
  algorithm__PeakPicker__deconvolution__asym_threshold:
  ...
  algorithm__PeakPicker__deconvolution__scaling:
    ...
    type: double?
  algorithm__PeakPicker__deconvolution__fitting__fwhm_threshold:
    ...
    type: double?
  algorithm__PeakPicker__deconvolution__fitting__eps_abs:
    doc: if the absolute error gets smaller than this value the fitting is stopped.
    type: double?
  algorithm__PeakPicker__deconvolution__fitting__eps_rel:
    doc: if the relative error gets smaller than this value the fitting is stopped.
    type: double?
  algorithm__PeakPicker__deconvolution__fitting__max_iteration:
    doc: maximal number of iterations for the fitting step
    type: long?
  algorithm__PeakPicker__deconvolution__fitting__penalties__position:
    ...
    type: double?
  algorithm__PeakPicker__deconvolution__fitting__penalties__height:
    doc: penalty term for the fitting of the intensity:If it gets negative during the fitting it can be penalized.
    type: double?
  algorithm__PeakPicker__deconvolution__fitting__penalties__left_width:
    ...
    type: double?
  algorithm__PeakPicker__deconvolution__fitting__penalties__right_width:
    ...
    type: double?
  algorithm__PeakPicker__SignalToNoiseEstimationParameter__max_intensity:
    ...
    type: long?
  algorithm__PeakPicker__SignalToNoiseEstimationParameter__auto_max_stdev_factor:
    doc: "parameter for 'max_intensity' estimation (if 'auto_mode' == 0): mean + 'auto_max_stdev_factor' * stdev"
    type: double?
  algorithm__PeakPicker__SignalToNoiseEstimationParameter__auto_max_percentile:
    doc: "parameter for 'max_intensity' estimation (if 'auto_mode' == 1): auto_max_percentile th percentile"
    type: long?
  algorithm__PeakPicker__SignalToNoiseEstimationParameter__auto_mode:
    ...
    type: long?
  algorithm__PeakPicker__SignalToNoiseEstimationParameter__win_len:
    doc: window length in Thomson
    type: double?
  algorithm__PeakPicker__SignalToNoiseEstimationParameter__bin_count:
    doc: number of bins for intensity values
    type: long?
  algorithm__PeakPicker__SignalToNoiseEstimationParameter__stdev_mp:
    doc: multiplier for stdev
    type: double?
  algorithm__PeakPicker__SignalToNoiseEstimationParameter__min_required_elements:
    doc: minimum number of elements required in a window (otherwise it is considered sparse)
    type: long?
  algorithm__PeakPicker__SignalToNoiseEstimationParameter__noise_for_empty_window:
