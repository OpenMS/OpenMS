inputs:
  ...
  cross_linker__residue2:
    ...
    type: string[]?
  cross_linker__mass_light:
    doc: Mass of the light cross-linker, linking two residues on one or two peptides
    type: double?
  cross_linker__mass_iso_shift:
    doc: Mass of the isotopic shift between the light and heavy linkers
    type: double?
...
label: OpenPepXL
doc: Tool for protein-protein cross-linking identification using labeled linkers.
cwlVersion: v1.2
