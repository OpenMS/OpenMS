...
-- 
-- Table structure for table `ID_DBSearch`
-- 

CREATE TABLE `ID_DBSearch` (
  `id` bigint(20) unsigned NOT NULL default '0',
  `fid_Spectrum` bigint(20) unsigned default NULL,
  `fid_File` bigint(20) unsigned default NULL,
  `fid_MetaInfo` bigint(20) unsigned default NULL,
...
-- 
-- Table structure for table `ID_DBSearchParameters`
-- 

CREATE TABLE `ID_DBSearchParameters` (
  `id` bigint(20) unsigned NOT NULL default '0',
  `fid_DBSearch` bigint(20) unsigned NOT NULL default '0',
...
CREATE TABLE `LINK_ExperimentGroup_MSExperiment` (
  `fid_DataSet` bigint(20) unsigned NOT NULL default '0',
  `fid_MSExperiment` bigint(20) unsigned NOT NULL default '0',
  PRIMARY KEY  (`fid_DataSet`,`fid_MSExperiment`),
  KEY `fid_MSExperiment` (`fid_MSExperiment`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
CREATE TABLE `META_MassAnalyzer` (
  ...
  `Type` enum('UNKNOWN','QUADRUPOLE','PAULIONTRAP','RADIALEJECTIONLINEARIONTRAP','AXIALEJECTIONLINEARIONTRAP','TOF','SECTOR','FOURIERTRANSFORM','IONSTORAGE') NOT NULL default 'UNKNOWN',
  PRIMARY KEY  (`id`),
  KEY `fid_MSInstrument` (`fid_MSInstrument`),
  KEY `fid_MetaInfo` (`fid_MetaInfo`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
ALTER TABLE `DATA_Spectrum`
  ...
  ADD CONSTRAINT `Spectrum_ibfk_3` FOREIGN KEY (`fid_Spectrum`) REFERENCES `DATA_Spectrum` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- 
-- Constraints for table `ID_DBSearch`
-- 
ALTER TABLE `ID_DBSearch`
  ADD CONSTRAINT `DBSearch_ibfk_1` FOREIGN KEY (`fid_Spectrum`) REFERENCES `DATA_Spectrum` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `DBSearch_ibfk_2` FOREIGN KEY (`fid_MetaInfo`) REFERENCES `META_MetaInfo` (`id`) ON DELETE SET NULL ON UPDATE SET NULL,
  ADD CONSTRAINT `ID_DBSearch_ibfk_1` FOREIGN KEY (`fid_File`) REFERENCES `META_File` (`id`) ON DELETE SET NULL ON UPDATE SET NULL;

-- 
-- Constraints for table `ID_DBSearchParameters`
-- 
ALTER TABLE `ID_DBSearchParameters`
  ADD CONSTRAINT `DBSearchParameters_ibfk_1` FOREIGN KEY (`fid_DBSearch`) REFERENCES `ID_DBSearch` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- 
-- Constraints for table `ID_PeptideHit`
-- 
ALTER TABLE `ID_PeptideHit`
  ADD CONSTRAINT `PeptideHit_ibfk_1` FOREIGN KEY (`fid_DBSearch`) REFERENCES `ID_DBSearch` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- 
-- Constraints for table `ID_ProteinHit`
-- 
ALTER TABLE `ID_ProteinHit`
  ADD CONSTRAINT `ProteinHit_ibfk_1` FOREIGN KEY (`fid_DBSearch`) REFERENCES `ID_DBSearch` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- 
-- Constraints for table `LINK_ExperimentGroup_MSExperiment`
-- 
ALTER TABLE `LINK_ExperimentGroup_MSExperiment`
  ADD CONSTRAINT `DataSet_Member_Ref_ibfk_1` FOREIGN KEY (`fid_DataSet`) REFERENCES `DATA_ExperimentGroup` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
