...
CHECK((void applyReduction(const ExperimentType& in, ExperimentType& out )))
  ...
  TEST_EQUAL(in.size(),3)
	...
	TEST_REAL_EQUAL(out[0].getContainer()[0].getPos()[0],5)
	TEST_REAL_EQUAL(out[0].getContainer()[1].getPos()[0],10)
	TEST_REAL_EQUAL(out[1].getContainer()[0].getPos()[0],6)
	TEST_REAL_EQUAL(out[1].getContainer()[1].getPos()[0],11)
	TEST_REAL_EQUAL(out[2].getContainer()[0].getPos()[0],12)
	TEST_REAL_EQUAL(out[2].getContainer()[1].getPos()[0],35)
...
// 	TEST_REAL_EQUAL(out[2].getContainer()[0].getPos()[0],7)
// 	TEST_REAL_EQUAL(out[2].getContainer()[1].getPos()[0],12)
// 	TEST_REAL_EQUAL(out[2].getContainer()[2].getPos()[0],20)
// 	TEST_REAL_EQUAL(out[2].getContainer()[3].getPos()[0],31)
// 	TEST_REAL_EQUAL(out[2].getContainer()[4].getPos()[0],35)
