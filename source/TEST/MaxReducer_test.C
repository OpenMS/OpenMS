...
CHECK((void applyReduction(const ExperimentType& in, ExperimentType& out )))
  ...
  maxreducer.applyReduction(in,out);
	...
	TEST_REAL_EQUAL(out[0].getContainer()[0].getPos()[0],3)
 	TEST_REAL_EQUAL(out[0].getContainer()[1].getPos()[0],6)
 	TEST_REAL_EQUAL(out[0].getContainer()[2].getPos()[0],9)
 	TEST_REAL_EQUAL(out[0].getContainer()[3].getPos()[0],10)

  TEST_REAL_EQUAL(out[1].getContainer()[0].getPos()[0],3)
 	TEST_REAL_EQUAL(out[1].getContainer()[1].getPos()[0],6)
 	TEST_REAL_EQUAL(out[1].getContainer()[2].getPos()[0],9)
 	TEST_REAL_EQUAL(out[1].getContainer()[3].getPos()[0],11)
  TEST_REAL_EQUAL(out[2].getContainer()[0].getPos()[0],3)
 	TEST_REAL_EQUAL(out[2].getContainer()[1].getPos()[0],6)
 	TEST_REAL_EQUAL(out[2].getContainer()[2].getPos()[0],9)
 	TEST_REAL_EQUAL(out[2].getContainer()[3].getPos()[0],12)
...
// 	TEST_REAL_EQUAL(out[0].getContainer()[0].getPos()[0],2)
// 	TEST_REAL_EQUAL(out[0].getContainer()[1].getPos()[0],4)
// 	TEST_REAL_EQUAL(out[0].getContainer()[2].getPos()[0],6)
// 	TEST_REAL_EQUAL(out[0].getContainer()[3].getPos()[0],8)
// 	TEST_REAL_EQUAL(out[0].getContainer()[4].getPos()[0],10)
	
// 	TEST_REAL_EQUAL(out[1].getContainer()[0].getPos()[0],2)
// 	TEST_REAL_EQUAL(out[1].getContainer()[1].getPos()[0],4)
// 	TEST_REAL_EQUAL(out[1].getContainer()[2].getPos()[0],6)
// 	TEST_REAL_EQUAL(out[1].getContainer()[3].getPos()[0],8)
// 	TEST_REAL_EQUAL(out[1].getContainer()[4].getPos()[0],10)
// 	TEST_REAL_EQUAL(out[1].getContainer()[5].getPos()[0],11)
	
// 	TEST_REAL_EQUAL(out[2].getContainer()[0].getPos()[0],2)
// 	TEST_REAL_EQUAL(out[2].getContainer()[1].getPos()[0],4)
// 	TEST_REAL_EQUAL(out[2].getContainer()[2].getPos()[0],6)
// 	TEST_REAL_EQUAL(out[2].getContainer()[3].getPos()[0],8)
// 	TEST_REAL_EQUAL(out[2].getContainer()[4].getPos()[0],10)
// 	TEST_REAL_EQUAL(out[2].getContainer()[5].getPos()[0],12)
