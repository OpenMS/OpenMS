...
CHECK(BinnedSumAgreeingIntensities())
{
...
CHECK((BinnedSumAgreeingIntensities(const BinnedSumAgreeingIntensities &source)))
{
...
CHECK((BinnedSumAgreeingIntensities& operator=(const BinnedSumAgreeingIntensities &source)))
{
...
CHECK((double operator()(const BinnedSpectrum &spec1, const BinnedSpectrum &spec2) const))
{
  ...
  TEST_REAL_EQUAL(score, 0.997576)
}
RESULT
