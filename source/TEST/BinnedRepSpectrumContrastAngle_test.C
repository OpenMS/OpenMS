...
START_TEST(BinnedRepSpectrumContrastAngle, "$Id$")

/////////////////////////////////////////////////////////////

BinnedRepSpectrumContrastAngle* e_ptr = 0;
CHECK(BinnedRepSpectrumContrastAngle())
	e_ptr = new BinnedRepSpectrumContrastAngle;
