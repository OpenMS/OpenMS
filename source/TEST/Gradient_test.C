...
//
// --------------------------------------------------------------------------
// $Id: Gradient_test.C,v 1.3 2006/05/30 15:46:43 marc_sturm Exp $
// $Author: marc_sturm $
...
START_TEST(Gradient, "$Id: Gradient_test.C,v 1.3 2006/05/30 15:46:43 marc_sturm Exp $")
...
CHECK(const std::vector< std::vector< SignedInt >& getPercentages() const)
  Gradient tmp;
  tmp.addTimepoint(5);
  tmp.addTimepoint(7);
  tmp.addEluent("A");
...
CHECK(void setPercentage(const String& eluent, SignedInt timepoint, SignedInt percentage) throw(Exception::InvalidValue))
  Gradient tmp;
  tmp.addTimepoint(5);
  tmp.addTimepoint(7);
  tmp.addEluent("A");
