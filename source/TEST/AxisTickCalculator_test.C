...
CHECK(std::vector<std::vector<double> > calcGridLines_(double x1, double x2, int level))
...
std::vector<std::vector<double> > vector1 = AxisTickCalculator::calcGridLines_(1.0,4.0,3);
...
CHECK(std::vector<std::vector<double> > calcLogGridLines_(double x1, double x2))
std::vector<std::vector<double> > vector;
...
std::vector<std::vector<double> > vector1 = AxisTickCalculator::calcLogGridLines_(log10(10.0),log10(100.0));
