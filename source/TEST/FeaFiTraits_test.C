...
CHECK(void addConvexHull(const IndexSet& set, Feature& f) const)
	...
	p.getPos()[0] = 1240.54;   p.getPos()[1] = 687.6;     peak_array.push_back(p);
	p.getPos()[0] = 1241.81;   p.getPos()[1] = 687.6;     peak_array.push_back(p);
	p.getPos()[0] = 1252.39;   p.getPos()[1] = 687.6;     peak_array.push_back(p);
	p.getPos()[0] = 1252.39;   p.getPos()[1] = 692.8;     peak_array.push_back(p);
	p.getPos()[0] = 1252.39;   p.getPos()[1] = 693.8;     peak_array.push_back(p);
	p.getPos()[0] = 1251.73;   p.getPos()[1] = 695.2;     peak_array.push_back(p);
	p.getPos()[0] = 1251.07;   p.getPos()[1] = 695.4;     peak_array.push_back(p);
	p.getPos()[0] = 1247.09;   p.getPos()[1] = 695.4;     peak_array.push_back(p);
	p.getPos()[0] = 1248.41;   p.getPos()[1] = 687.6;     peak_array.push_back(p);
	p.getPos()[0] = 1249.76;   p.getPos()[1] = 687.6;     peak_array.push_back(p);
	p.getPos()[0] = 1250.41;   p.getPos()[1] = 687.6;     peak_array.push_back(p);
	p.getPos()[0] = 1252.39;   p.getPos()[1] = 689.4;     peak_array.push_back(p);
	p.getPos()[0] = 1252.39;   p.getPos()[1] = 692.6;     peak_array.push_back(p);
	p.getPos()[0] = 1251.73;   p.getPos()[1] = 694.4;     peak_array.push_back(p);
	p.getPos()[0] = 1250.41;   p.getPos()[1] = 695.4;     peak_array.push_back(p);
	p.getPos()[0] = 1247.75;   p.getPos()[1] = 695.4;     peak_array.push_back(p);
	p.getPos()[0] = 1249.12;   p.getPos()[1] = 688;       peak_array.push_back(p);
	p.getPos()[0] = 1252.39;   p.getPos()[1] = 689.8;     peak_array.push_back(p);
	p.getPos()[0] = 1252.39;   p.getPos()[1] = 691;       peak_array.push_back(p);
	p.getPos()[0] = 1252.39;   p.getPos()[1] = 692.4;     peak_array.push_back(p);
	p.getPos()[0] = 1251.73;   p.getPos()[1] = 693.8;     peak_array.push_back(p);
	p.getPos()[0] = 1250.41;   p.getPos()[1] = 695.2;     peak_array.push_back(p);
	p.getPos()[0] = 1248.41;   p.getPos()[1] = 695.4;     peak_array.push_back(p);
	p.getPos()[0] = 1243.78;   p.getPos()[1] = 695.4;     peak_array.push_back(p);
	p.getPos()[0] = 1239.9;    p.getPos()[1] = 695.4;     peak_array.push_back(p);
	p.getPos()[0] = 1237.27;   p.getPos()[1] = 692;       peak_array.push_back(p);
	p.getPos()[0] = 1237.27;   p.getPos()[1] = 691;       peak_array.push_back(p);
	p.getPos()[0] = 1237.93;   p.getPos()[1] = 688.4;     peak_array.push_back(p);
