...
CHECK(const ConvexHullType& FeaFiTraits::calculateConvexHull(const IndexSet& set))
	...
	TEST_EQUAL(find(hull.getPoints().begin(), hull.getPoints().end(), DConvexHull<2>::PointType(61.14, 429.242)) != hull.getPoints().end(), true);
	TEST_EQUAL(find(hull.getPoints().begin(), hull.getPoints().end(), DConvexHull<2>::PointType(64.36, 429.242)) != hull.getPoints().end(), true);
	TEST_EQUAL(find(hull.getPoints().begin(), hull.getPoints().end(), DConvexHull<2>::PointType(64.36, 429.437)) != hull.getPoints().end(), true);
	TEST_EQUAL(find(hull.getPoints().begin(), hull.getPoints().end(), DConvexHull<2>::PointType(61.14, 429.315)) != hull.getPoints().end(), true);
RESULT
...
CHECK(const ConvexHullType& FeaFiTraits::calculateConvexHull(const IndexSet& set))
	...
	TEST_EQUAL(find(hull.getPoints().begin(), hull.getPoints().end(), DConvexHull<2>::PointType(51.51, 428.778)) != hull.getPoints().end(), true);
	TEST_EQUAL(find(hull.getPoints().begin(), hull.getPoints().end(), DConvexHull<2>::PointType(54.72, 428.729)) != hull.getPoints().end(), true);
	TEST_EQUAL(find(hull.getPoints().begin(), hull.getPoints().end(), DConvexHull<2>::PointType(57.93, 428.754)) != hull.getPoints().end(), true);
	TEST_EQUAL(find(hull.getPoints().begin(), hull.getPoints().end(), DConvexHull<2>::PointType(57.93, 428.9)) != hull.getPoints().end(), true);
	TEST_EQUAL(find(hull.getPoints().begin(), hull.getPoints().end(), DConvexHull<2>::PointType(54.72, 428.924)) != hull.getPoints().end(), true);
	TEST_EQUAL(find(hull.getPoints().begin(), hull.getPoints().end(), DConvexHull<2>::PointType(51.51, 428.9)) != hull.getPoints().end(), true);
RESULT
...
CHECK(const ConvexHullType& BaseFeaFiTraits::calculateConvexHull(const IndexSet& set))
	...
	TEST_EQUAL(find(hull.getPoints().begin(), hull.getPoints().end(), DConvexHull<2>::PointType(0.0, 1.0)) != hull.getPoints().end(), true);
	TEST_EQUAL(find(hull.getPoints().begin(), hull.getPoints().end(), DConvexHull<2>::PointType(1.0, 0.0)) != hull.getPoints().end(), true);
	TEST_EQUAL(find(hull.getPoints().begin(), hull.getPoints().end(), DConvexHull<2>::PointType(2.0, 0.0)) != hull.getPoints().end(), true);
	TEST_EQUAL(find(hull.getPoints().begin(), hull.getPoints().end(), DConvexHull<2>::PointType(2.0, 2.0)) != hull.getPoints().end(), true);
	TEST_EQUAL(find(hull.getPoints().begin(), hull.getPoints().end(), DConvexHull<2>::PointType(1.0, 3.0)) != hull.getPoints().end(), true);
RESULT
