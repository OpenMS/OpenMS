...
namespace OpenMS
{
	...
	void CompNovoIonScoringCID::scoreSpectrum(Map<double, IonScore>& ion_scores, PeakSpectrum& CID_spec, double precursor_weight, UInt charge)
	{
...
void CompNovoIonScoringCID::scoreWitnessSet_(UInt charge, double precursor_weight, Map<double, IonScore>& ion_scores, const PeakSpectrum& CID_spec)
{
