...
In this folder there are some useful tools for developers:


  create_test.php    -  Creates a test for a file/class using check_test.
  
  missing_tests.php  -  Reports missing tests, test that are not executed and test that probably are not complete.
