...
namespace OpenMS
{
	TOFCalibration::UnableToCalibrate::UnableToCalibrate(const char* file, int line, const char* function, const std::string& name , const std::string& message) throw()
  ...
  void TOFCalibration::calculateCalibCoeffs_(MSExperiment<PickedPeakType >& calib_spectra) throw (UnableToCalibrate)
  {
...
#define C(i) (gsl_vector_get(c,(i)))
  ...
  void TOFCalibration::matchMasses_(MSExperiment<PickedPeakType>& calib_peaks,
																				 std::vector<std::vector<unsigned int> >& monoiso_peaks,
  ...
  void TOFCalibration::getMonoisotopicPeaks_(MSExperiment<PickedPeakType >& calib_peaks,
																									std::vector<std::vector<unsigned int> >& monoiso_peaks)
  {
