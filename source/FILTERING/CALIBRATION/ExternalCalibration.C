...
#define C(i) (gsl_vector_get(c,(i)))
  ...
  void ExternalCalibration::averageCoefficients_()
  {
    a_ = 0;
    b_ = 0;
    c_ = 0;
  ...
  void ExternalCalibration::averageErrors_()
  {
  ...
  void ExternalCalibration::matchMasses_(MSExperiment<PickedPeakType>& calib_peaks,
																				 std::vector<std::vector<unsigned int> >& monoiso_peaks,
  ...
  void ExternalCalibration::getMonoisotopicPeaks_(MSExperiment<PickedPeakType >& calib_peaks,
																									std::vector<std::vector<unsigned int> >& monoiso_peaks)
  {
  ...
  void ExternalCalibration::applyTOFConversion_(MSExperiment<PickedPeakType>& calib_spectra)
  {
