...
namespace OpenMS
{
  ...
  SavitzkyGolaySVDFilter::SavitzkyGolaySVDFilter(const Param& parameters) throw (Exception::InvalidValue)
  {
    param_ = parameters;
  ...
  void SavitzkyGolaySVDFilter::setParam(const Param& param) throw (Exception::InvalidValue)
  {
  ...
  void SavitzkyGolaySVDFilter::computeCoeffs_()
  {
