	...
	ExitCodes main_(int , const char**)
	{
		...
		{	
						...
						++sit)
			{
				...
				Feature::CoordinateType mz_err = pow(10.0, 6.0) * (p_mz - sit->getPrecursor().getMZ()) / sit->getPrecursor().getMZ();
				...
				{			
					...
					{			
						...
						{				
							...
							points.push_back( DPosition<2>(sit->getRT(),sit->getPrecursor().getMZ()) );
							if (dump_profile)
							{
