      ...
      ~TOPPBase();
		...
		protected:
			...
			*/
			...
			/**
				@brief Return a value of param_ as a string or @p default when this value is not set.
			...
			*/
			...
			/**
				@brief Return a value of param_ as an integer or @p default when this value is not set.
