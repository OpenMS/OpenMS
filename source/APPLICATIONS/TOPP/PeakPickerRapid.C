...
<CENTER>
	<table>
      ...
      <td VALIGN="middle" ROWSPAN=4> \f$ \longrightarrow \f$ PeakPickerRapid \f$ \longrightarrow \f$</td>
...
protected:
    ...
    {
        return PeakPickerRapid().getDefaults();
    }
    ...
    ExitCodes main_(int , const char**)
    {
        ...
        writeDebug_("Parameters passed to PeakPickerRapid", pepi_param,3);
