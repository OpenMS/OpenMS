...
//
// --------------------------------------------------------------------------
// $Id: Template.C,v 1.3 2006/03/21 12:12:33 marc_sturm Exp $
// $Author: marc_sturm $
// $Maintainer: $
// --------------------------------------------------------------------------
...
/* replace '/*' by '/**' to activate it
	@page Template Template
	
	@brief Brief description of the Skeleton
...
{
	cerr << endl
       << tool_name << " -- do something or other. Explain what. Point to related" << endl
       << "  TOPP modules. Refer to papers, OpenMS classes containing relevant information." << endl
       << endl
       << "Usage:" << endl
...
{
	// instance specific location of settings in INI file (e.g. 'Template:1:')
	String ini_location;
	...
	{
		cout << "Error: Unexpected OpenMS error (" << e.what() <<")"<< endl;
		log << Date::now() << " " << ini_location << " Error: Unexpected OpenMS error (" << e.what() <<")"<< endl;
		return UNKNOWN_ERROR;
	}
  catch(...)
  {
		cout << "Error: Unexpected error"<< endl;
		log << Date::now() << " " << ini_location << " Error: Unexpected error"<< endl;
		return UNKNOWN_ERROR;
  }
