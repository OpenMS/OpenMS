...
//
// --------------------------------------------------------------------------
// $Id: FeatureMatcher.C,v 1.7 2006/05/30 15:46:38 marc_sturm Exp $
// $Author: marc_sturm $
// $Maintainer: Clemens Groepl $
// --------------------------------------------------------------------------

#include <OpenMS/ANALYSIS/MAPMATCHING/DGeomHashTranslationFeatureMatcher.h>
...
typedef DGeomHashTranslationFeatureMatcher<2,KernelTraits,Feature> FeatureMatcher;

//-------------------------------------------------------------
// command line name of this tool
//-------------------------------------------------------------
const char* tool_name = "FeatureMatcher";
...
int main( int argc, char ** argv )
{
	...
	try
	{
		...
		for ( Size index = 0; index < 2; ++index )
		{
			log << ini_location << " Reading input file " << index+1 << ", " << inputfile[index] << endl;
		...
		log << ini_location << "Writing results to " << outputfile << endl;
		...
		if ( !fm_p_d_dfi.isEmpty() )
		{
			...
			for ( Size index = 0; index < 2; ++index )
			{
				...
				dump_file << feature_matcher.getFeatureMap(index) << endl;
