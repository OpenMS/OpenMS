...
namespace OpenMS
{
  ...
  {
  	defaults_.setValue("thresholds:signal_to_noise",2.0,"Minimal signal to noise ratio for a peak to be picked.");
		defaults_.setMinFloat("thresholds:signal_to_noise",1.0);
