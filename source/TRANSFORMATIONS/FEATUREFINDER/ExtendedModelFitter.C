...
namespace OpenMS
{
		...
		last_mz_model_(0)
	{
		...
		defaults_.setValue("tolerance_stdev_bounding_box",3.0f,"standard deviation of bounding box");
		defaults_.setValue("feature_intensity_sum",1,"sum of feature intensities");
		defaults_.setValue("min_num_peaks:final",5,"threshold for final number of peaks");
		defaults_.setValue("min_num_peaks:extended",10,"threshold for number of peaks after extension");
		defaults_.setValue("intensity_cutoff_factor",0.05f,"cutoff for intensity after fitting");
		defaults_.setValue("feature_intensity_sum",1,"use sum of feature intensities yes/no");
		defaults_.setValue("rt:interpolation_step",0.2f,"interpolation step size for rt model");
		defaults_.setValue("rt:max_iteration",500,"max. number of iterations for rt fit");
		defaults_.setValue("rt:deltaAbsError",0.0001,"delta absolute error");
		defaults_.setValue("rt:deltaRelError",0.0001,"delta relative error");
		defaults_.setValue("rt:profile","EMG","type of rt model used");
		defaults_.setValue("mz:interpolation_step",0.03f,"interpolation step size for mz");
		defaults_.setValue("mz:model_type:first",0,"first mz model fitted");
		defaults_.setValue("mz:model_type:last",4,"last mz model fitted");
		defaults_.setValue("quality:type","Correlation","type of quality measurement used");
		defaults_.setValue("quality:minimum",0.65f,"minimum threshold for quality");
		defaults_.setValue("isotope_model:stdev:first",0.04f,"first std for isotope model");
		defaults_.setValue("isotope_model:stdev:last",0.12f,"last std for isotope model");
		defaults_.setValue("isotope_model:stdev:step",0.04f,"step size");
		defaults_.setValue("isotope_model:averagines:C",0.0443f,"number of C atoms in averagine");
		defaults_.setValue("isotope_model:averagines:H",0.0f,"numnber of H atoms in averagine");
		defaults_.setValue("isotope_model:averagines:N",0.0037f,"number of N atoms in averagine");
		defaults_.setValue("isotope_model:averagines:O",0.022f,"number of O atoms in averagine");
		defaults_.setValue("isotope_model:averagines:S",0.0f,"number of S atoms in averagine");
		defaults_.setValue("isotope_model:isotope:trim_right_cutoff",0.001f,"cutoff for isotope distribution");
		defaults_.setValue("isotope_model:isotope:maximum",1000000,"max isotopic peak");
