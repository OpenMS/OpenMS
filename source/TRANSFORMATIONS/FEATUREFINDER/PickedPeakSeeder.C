...
namespace OpenMS
{
    ...
    // charge 1
    defaults_.setValue("charge1_ub",1.6f,"Upper bound for distances between isotopic peaks (charge 1)");
    defaults_.setValue("charge1_lb",0.7f,"Lower bound for distances between isotopic peaks (charge 1)");
    // charge 2
    defaults_.setValue("charge2_ub",0.7f,"Upper bound for distances between isotopic peaks (charge 2)");
    defaults_.setValue("charge2_lb",0.4f,"Upper bound for distances between isotopic peaks (charge 2)");
    // charge 3
    defaults_.setValue("charge3_ub",0.4f,"Upper bound for distances between isotopic peaks (charge 3)");
    defaults_.setValue("charge3_lb",0.27f,"Upper bound for distances between isotopic peaks (charge 3)");
    // charge 4
    defaults_.setValue("charge4_ub",0.27f,"Upper bound for distances between isotopic peaks (charge 4)");
    defaults_.setValue("charge4_lb",0.24f,"Upper bound for distances between isotopic peaks (charge 4)");
    // charge 5
    defaults_.setValue("charge5_ub",0.24f,"Upper bound for distances between isotopic peaks (charge 5)");
    defaults_.setValue("charge5_lb",0.15f,"Upper bound for distances between isotopic peaks (charge 5)");
