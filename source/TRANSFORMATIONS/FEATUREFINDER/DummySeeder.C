...
namespace OpenMS
{
  ...
  DummySeeder& DummySeeder::operator= (const DummySeeder& rhs)
  {
	...
	DummySeeder::TableType::iterator DummySeeder::retrieveHashIter_(CoordinateType curr_mz, 
	...
	void DummySeeder::filterAndComputeLocalMax_(const SpectrumType & vec, 
