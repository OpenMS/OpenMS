...
namespace OpenMS
{
    ...
    : FactoryProduct("Fitter1D")
    {
      ...
      defaults_.setValue("statistics:mean",0.0,"Centroid position of the model", true);
      defaults_.setValue("statistics:variance",1.0,"variance", true);
      defaults_.setValue("tolerance_stdev_bounding_box",3.0,"ounding box has range [minimim of data, maximum of data] enlarged by tolerance_stdev_bounding_box times the standard deviation of the data", true);
