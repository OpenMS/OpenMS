...
namespace OpenMS
{
	...
	namespace Internal
	{
			...
			:PreferencesDialogPage(manager,parent)
		{
			...
			addWidget_(box->layout(),0,"Gradient:",dot_gradient_3d_);
			finish_(box->layout());
