...
**                                                                        **
**  EXCEPTION: This distribution of QCustomPlot may be linked against     **
**  OpenMS according to the terms of the following section                **
**  OpenMS Exception:                                                     **
**    You have permission to copy, modify, propagate, and distribute a    **
**    work formed by combining OpenMS with QCustomPlot, or a work         **
**    derivative of such a combination, even if such copying,             **
**    modification, propagation, or distribution would otherwise violate  **
**    the terms of the GPL. You must comply with the GPL in all respects  **
**    for all of the code used other than in combination with OpenMS or   **
**    its derivatives.                                                    **
** You may include this OpenMS Exception and its grant of permissions when**
** you distribute QCustomPlot.  Inclusion of this notice with such a      **
** distribution constitutes a grant of such permission.  If you do not    **
** wish to grant these permissions, remove this section entitled "OpenMS  **
...
#include "OpenMS/QCUSTOMPLOT/qcustomplot.h"
