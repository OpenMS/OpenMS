...
//
// --------------------------------------------------------------------------
// $Id: Outfile.C,v 1.0 2006/07/25 13:46:15 martinlangwisch Exp $
...
namespace OpenMS 
{
  ...
  void Outfile::setProteinIdentification(const ProteinIdentification& protein_ids)
  {
	...
	void Outfile::getACAndACType(String line, std::string& accession, std::string& accession_type) throw (Exception::ParseError)
	{
