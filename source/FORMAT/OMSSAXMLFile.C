...
namespace OpenMS 
{
  ...
  void OMSSAXMLFile::load(const String& filename, Identification& protein_identification, vector<PeptideIdentification>& id_data) const throw (Exception::FileNotFound, Exception::ParseError)
  {
  	//try to open file
