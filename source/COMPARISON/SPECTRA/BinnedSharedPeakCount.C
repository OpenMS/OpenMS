...
namespace OpenMS
{
	...
	double BinnedSharedPeakCount::operator () (const BinnedSpectrum& spec1, const BinnedSpectrum& spec2) const throw (BinnedSpectrumCompareFunctor::IncompatibleBinning)
	{
