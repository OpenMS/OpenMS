...
cdef class ClusteringGrid:
    ...
    """
    cdef shared_ptr[_ClusteringGrid] inst
...
cdef class CoarseIsotopePatternGenerator:
    ...
    """
    cdef shared_ptr[_CoarseIsotopePatternGenerator] inst
...
cdef class ConsensusMapNormalizerAlgorithmThreshold:
    ...
    """
    cdef shared_ptr[_ConsensusMapNormalizerAlgorithmThreshold] inst
...
cdef class DocumentIdentifier:
    ...
    """
    cdef shared_ptr[_DocumentIdentifier] inst
...
cdef class FineIsotopePatternGenerator:
    ...
    """
    cdef shared_ptr[_FineIsotopePatternGenerator] inst
...
cdef class Gradient:
    ...
    """
    cdef shared_ptr[_Gradient] inst
...
cdef class IsotopeDistribution:
    ...
    """
    cdef shared_ptr[_IsotopeDistribution] inst
...
cdef class MSDataSqlConsumer:
    ...
    """
    cdef shared_ptr[_MSDataSqlConsumer] inst
...
cdef class MzTabFile:
    ...
    """
    cdef shared_ptr[_MzTabFile] inst
...
cdef class StablePairFinder:
    ...
    """
    cdef shared_ptr[_StablePairFinder] inst
