...
cdef class CVTerm_ControlledVocabulary:
    ...
    """
    cdef shared_ptr[_CVTerm_ControlledVocabulary] inst
...
cdef class ControlledVocabulary:
    ...
    """
    cdef shared_ptr[_ControlledVocabulary] inst
...
cdef class FloatDataArray:
    ...
    """
    cdef shared_ptr[_FloatDataArray] inst
...
cdef class IDRipper:
    ...
    """
    cdef shared_ptr[_IDRipper] inst
...
cdef class IdentificationRuns:
    ...
    """
    cdef shared_ptr[_IdentificationRuns] inst
...
cdef class MRMFP_ComponentGroupParams:
    ...
    """
    cdef shared_ptr[_MRMFP_ComponentGroupParams] inst
...
cdef class MRMFP_ComponentParams:
    ...
    """
    cdef shared_ptr[_MRMFP_ComponentParams] inst
...
cdef class MRMFeaturePicker:
    ...
    """
    cdef shared_ptr[_MRMFeaturePicker] inst
...
cdef class MSNumpressCoder:
    ...
    """
    cdef shared_ptr[_MSNumpressCoder] inst
...
cdef class MSstatsFile:
    ...
    """
    cdef shared_ptr[_MSstatsFile] inst
...
cdef class NumpressConfig:
    ...
    """
    cdef shared_ptr[_NumpressConfig] inst
...
cdef class OPXLSpectrumProcessingAlgorithms:
    ...
    """
    cdef shared_ptr[_OPXLSpectrumProcessingAlgorithms] inst
...
cdef class OSBinaryDataArray:
    ...
    """
    cdef shared_ptr[_OSBinaryDataArray] inst
...
cdef class OSChromatogram:
    ...
    """
    cdef shared_ptr[_OSChromatogram] inst
...
cdef class OSSpectrum:
    ...
    """
    cdef shared_ptr[_OSSpectrum] inst
...
cdef class RipFileContent:
    ...
    """
    cdef shared_ptr[_RipFileContent] inst
...
cdef class RipFileIdentifier:
    ...
    """
    cdef shared_ptr[_RipFileIdentifier] inst
...
cdef class SpectrumAccessSqMass:
    ...
    """
    cdef shared_ptr[_SpectrumAccessSqMass] inst
...
cdef class SwathMapMassCorrection:
    ...
    """
    cdef shared_ptr[_SwathMapMassCorrection] inst
...
cdef class TransformationStatistics:
    ...
    """
    cdef shared_ptr[_TransformationStatistics] inst
