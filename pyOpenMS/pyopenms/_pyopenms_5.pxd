...
cdef extern from "autowrap_tools.hpp":
    void _iadd(_FeatureMap *, _FeatureMap *) 
...
cdef class CVMappingTerm:
    ...
    """
    cdef shared_ptr[_CVMappingTerm] inst
...
cdef class ConsensusIDAlgorithmAverage:
    ...
    """
    cdef shared_ptr[_ConsensusIDAlgorithmAverage] inst
...
cdef class ConsensusMapNormalizerAlgorithmMedian:
    ...
    """
    cdef shared_ptr[_ConsensusMapNormalizerAlgorithmMedian] inst
...
cdef class FeatureFinderAlgorithmMetaboIdent:
    ...
    Usage:
    """
    cdef shared_ptr[_FeatureFinderAlgorithmMetaboIdent] inst
...
cdef class FeatureFinderMetaboIdentCompound:
    ...
    """
    cdef shared_ptr[_FeatureFinderMetaboIdentCompound] inst
...
cdef class FeatureFinderMultiplexAlgorithm:
    ...
    Original C++ documentation is available `here <http://www.openms.de/current_doxygen/html/classOpenMS_1_1FeatureFinderMultiplexAlgorithm.html>`_
      -- Inherits from ['DefaultParamHandler']
    """
    cdef shared_ptr[_FeatureFinderMultiplexAlgorithm] inst
...
cdef class FeatureMap:
    ...
    """
    cdef shared_ptr[_FeatureMap] inst
...
cdef class GaussFilter:
    ...
    """
    cdef shared_ptr[_GaussFilter] inst
...
cdef class IndexedMzMLHandler:
    ...
    """
    cdef shared_ptr[_IndexedMzMLHandler] inst
...
cdef class MapConversion:
    ...
    """
    cdef shared_ptr[_MapConversion] inst
...
cdef class MetaboliteSpectralMatching:
    ...
    """
    cdef shared_ptr[_MetaboliteSpectralMatching] inst
...
cdef class ModificationDefinitionsSet:
    ...
    """
    cdef shared_ptr[_ModificationDefinitionsSet] inst
...
cdef class NoiseEstimator:
    ...
    """
    cdef shared_ptr[_NoiseEstimator] inst
...
cdef class SignalToNoiseEstimatorMedianRapid:
    ...
    """
    cdef shared_ptr[_SignalToNoiseEstimatorMedianRapid] inst
...
cdef class SpectraSTSimilarityScore:
    ...
    """
    cdef shared_ptr[_SpectraSTSimilarityScore] inst
...
cdef class SpectralMatch:
    ...
    """
    cdef shared_ptr[_SpectralMatch] inst
...
cdef class SqMassConfig:
    ...
    """
    cdef shared_ptr[_SqMassConfig] inst
...
cdef class SqMassFile:
    ...
    """
    cdef shared_ptr[_SqMassFile] inst
