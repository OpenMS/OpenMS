...
cdef class AQS_featureConcentration:
    ...
    """
    cdef shared_ptr[_AQS_featureConcentration] inst
...
cdef class AQS_runConcentration:
    ...
    """
    cdef shared_ptr[_AQS_runConcentration] inst
...
cdef class AbsoluteQuantitationStandards:
    ...
    """
    cdef shared_ptr[_AbsoluteQuantitationStandards] inst
...
cdef class ChromatogramRangeManager:
    ...
    """
    cdef shared_ptr[_ChromatogramRangeManager] inst
...
cdef class ColumnHeader:
    ...
    """
    cdef shared_ptr[_ColumnHeader] inst
...
cdef class DigestionEnzymeRNA:
    ...
    """
    cdef shared_ptr[_DigestionEnzymeRNA] inst
...
cdef class FeatureGroupingAlgorithmUnlabeled:
    ...
    """
    cdef shared_ptr[_FeatureGroupingAlgorithmUnlabeled] inst
...
cdef class IndexedMzMLFileLoader:
    ...
    """
    cdef shared_ptr[_IndexedMzMLFileLoader] inst
...
cdef class IsobaricChannelInformation:
    ...
    """
    cdef shared_ptr[_IsobaricChannelInformation] inst
...
cdef class ItraqFourPlexQuantitationMethod:
    ...
    """
    cdef shared_ptr[_ItraqFourPlexQuantitationMethod] inst
...
cdef class MSDataCachedConsumer:
    ...
    """
    cdef shared_ptr[_MSDataCachedConsumer] inst
...
cdef class NonNegativeLeastSquaresSolver:
    ...
    """
    cdef shared_ptr[_NonNegativeLeastSquaresSolver] inst
...
cdef class SplineInterpolatedPeaks:
    ...
    """
    cdef shared_ptr[_SplineInterpolatedPeaks] inst
...
cdef class SplineSpectrum_Navigator:
    ...
    """
    cdef shared_ptr[_SplineSpectrum_Navigator] inst
...
cdef class TraMLFile:
    ...
    """
    cdef shared_ptr[_TraMLFile] inst
