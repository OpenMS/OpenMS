...
cdef class AverageLinkage:
    ...
    """
    cdef shared_ptr[_AverageLinkage] inst
...
cdef class ChromatogramExtractorAlgorithm:
    ...
    """
    cdef shared_ptr[_ChromatogramExtractorAlgorithm] inst
...
cdef class ExtractionCoordinates:
    ...
    """
    cdef shared_ptr[_ExtractionCoordinates] inst
...
cdef class FeatureMapping:
    ...
    """
    cdef shared_ptr[_FeatureMapping] inst
...
cdef class FeatureMapping_FeatureMappingInfo:
    ...
    """
    cdef shared_ptr[_FeatureMapping_FeatureMappingInfo] inst
...
cdef class FeatureMapping_FeatureToMs2Indices:
    ...
    """
    cdef shared_ptr[_FeatureMapping_FeatureToMs2Indices] inst
...
cdef class GNPSQuantificationFile:
    ...
    """
    cdef shared_ptr[_GNPSQuantificationFile] inst
...
cdef class IDMapper_PeptideIdentificationListState:
    ...
    """
    cdef shared_ptr[_IDMapper_PeptideIdentificationListState] inst
...
cdef class IMSElement:
    ...
    """
    cdef shared_ptr[_IMSElement] inst
...
cdef class Instrument:
    ...
    """
    cdef shared_ptr[_Instrument] inst
...
cdef class IonSource:
    ...
    Original C++ documentation is available `here <http://www.openms.de/current_doxygen/html/classOpenMS_1_1IonSource.html>`_
      -- Inherits from ['MetaInfoInterface']
    """
    cdef shared_ptr[_IonSource] inst
...
cdef class OpenPepXLLFAlgorithm:
    ...
    """
    cdef shared_ptr[_OpenPepXLLFAlgorithm] inst
...
cdef class TraceInfo:
    ...
    """
    cdef shared_ptr[_TraceInfo] inst
...
cdef class XTandemXMLFile:
    ...
    """
    cdef shared_ptr[_XTandemXMLFile] inst
