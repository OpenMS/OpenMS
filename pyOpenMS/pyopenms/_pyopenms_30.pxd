...
cdef class Compomer:
    ...
    """
    cdef shared_ptr[_Compomer] inst
...
cdef class ConsensusIDAlgorithmBest:
    ...
    """
    cdef shared_ptr[_ConsensusIDAlgorithmBest] inst
...
cdef class IsotopeFitter1D:
    ...
    """
    cdef shared_ptr[_IsotopeFitter1D] inst
...
cdef class MetaInfoRegistry:
    ...
    13 - charge
    """
    cdef shared_ptr[_MetaInfoRegistry] inst
...
cdef class OPXLHelper:
    ...
    """
    cdef shared_ptr[_OPXLHelper] inst
...
cdef class PepXMLFileMascot:
    ...
    """
    cdef shared_ptr[_PepXMLFileMascot] inst
...
cdef class PosteriorErrorProbabilityModel:
    ...
    """
    cdef shared_ptr[_PosteriorErrorProbabilityModel] inst
...
cdef class RNaseDigestion:
    ...
    .. code-block:: python
          ...
          for fragment in result:
            print (fragment)
    """
    cdef shared_ptr[_RNaseDigestion] inst
...
cdef class TextFile:
    ...
    """
    cdef shared_ptr[_TextFile] inst
