...
cdef class AMSE_AdductInfo:
    ...
    """
    cdef shared_ptr[_AMSE_AdductInfo] inst
...
cdef class AbsoluteQuantitation:
    ...
    """
    cdef shared_ptr[_AbsoluteQuantitation] inst
...
cdef class ChromatogramSettings:
    ...
    """
    cdef shared_ptr[_ChromatogramSettings] inst
...
cdef class CubicSpline2d:
    ...
    """
    cdef shared_ptr[_CubicSpline2d] inst
...
cdef class __DigestionFilter:
    ...
    """
    cdef shared_ptr[_DigestionFilter] inst
...
cdef class DistanceMatrix:
    ...
    """
    cdef shared_ptr[_DistanceMatrix[float]] inst
...
cdef class ExperimentalSettings:
    ...
    """
    cdef shared_ptr[_ExperimentalSettings] inst
...
cdef class IDFilter:
    ...
    """
    cdef shared_ptr[_IDFilter] inst
...
cdef class Internal_MzMLValidator:
    ...
    """
    cdef shared_ptr[_Internal_MzMLValidator] inst
...
cdef class LinearResampler:
    ...
    """
    cdef shared_ptr[_LinearResampler] inst
...
cdef class MsInspectFile:
    ...
    """
    cdef shared_ptr[_MsInspectFile] inst
...
cdef class PepXMLFile:
    ...
    """
    cdef shared_ptr[_PepXMLFile] inst
...
cdef class SqrtScaler:
    ...
    """
    cdef shared_ptr[_SqrtScaler] inst
...
cdef class ThresholdMower:
    ...
    Original C++ documentation is available `here <http://www.openms.de/current_doxygen/html/classOpenMS_1_1ThresholdMower.html>`_
      -- Inherits from ['DefaultParamHandler']
    """
    cdef shared_ptr[_ThresholdMower] inst
