...
cdef extern from "autowrap_tools.hpp":
    void _iadd(_EmpiricalFormula *, _EmpiricalFormula *)
cdef extern from "autowrap_tools.hpp":
    void _isub(_EmpiricalFormula *, _EmpiricalFormula *) 
...
cdef class AnnotationStatistics:
    ...
    """
    cdef shared_ptr[_AnnotationStatistics] inst
...
cdef class CachedmzML:
    ...
    """
    cdef shared_ptr[_CachedmzML] inst
...
cdef class DecoyGenerator:
    ...
    """
    cdef shared_ptr[_DecoyGenerator] inst
...
cdef class EmpiricalFormula:
    ...
    """
    cdef shared_ptr[_EmpiricalFormula] inst
...
cdef class FeatureDistance:
    ...
    """
    cdef shared_ptr[_FeatureDistance] inst
...
cdef class FeatureGroupingAlgorithmKD:
    ...
    """
    cdef shared_ptr[_FeatureGroupingAlgorithmKD] inst
...
cdef class IsotopeLabelingMDVs:
    ...
    """
    cdef shared_ptr[_IsotopeLabelingMDVs] inst
...
cdef class Kernel_MassTrace:
    ...
    """
    cdef shared_ptr[_Kernel_MassTrace] inst
...
cdef class MSChromatogram:
    ...
    Usage:
    """
    cdef shared_ptr[_MSChromatogram] inst
...
cdef class OPXL_PreprocessedPairSpectra:
    ...
    """
    cdef shared_ptr[_OPXL_PreprocessedPairSpectra] inst
...
cdef class OpenSwathHelper:
    ...
    """
    cdef shared_ptr[_OpenSwathHelper] inst
...
cdef class PI_PeakArea:
    ...
    """
    cdef shared_ptr[_PI_PeakArea] inst
...
cdef class PI_PeakBackground:
    ...
    """
    cdef shared_ptr[_PI_PeakBackground] inst
...
cdef class PI_PeakShapeMetrics:
    ...
    """
    cdef shared_ptr[_PI_PeakShapeMetrics] inst
...
cdef class PeakIntegrator:
    ...
    """
    cdef shared_ptr[_PeakIntegrator] inst
