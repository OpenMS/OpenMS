...
cdef class AbsoluteQuantitationStandardsFile:
    ...
    """
    cdef shared_ptr[_AbsoluteQuantitationStandardsFile] inst
...
cdef class DBoundingBox2:
    ...
    """
    cdef shared_ptr[_DBoundingBox2] inst
...
cdef class DigestionEnzymeProtein:
    ...
    """
    cdef shared_ptr[_DigestionEnzymeProtein] inst
...
cdef class FIAMSScheduler:
    ...
    """
    cdef shared_ptr[_FIAMSScheduler] inst
...
cdef class FeatureGroupingAlgorithmLabeled:
    ...
    """
    cdef shared_ptr[_FeatureGroupingAlgorithmLabeled] inst
...
cdef class IsobaricQuantifier:
    ...
    """
    cdef shared_ptr[_IsobaricQuantifier] inst
...
cdef class ItraqConstants:
    ...
    """
    cdef shared_ptr[_ItraqConstants] inst
...
cdef class MRMFeature:
    ...
    """
    cdef shared_ptr[_MRMFeature] inst
...
cdef class MascotGenericFile:
    ...
    """
    cdef shared_ptr[_MascotGenericFile] inst
...
cdef class SeedListGenerator:
    ...
    """
    cdef shared_ptr[_SeedListGenerator] inst
...
cdef class SignalToNoiseEstimatorMedian:
    ...
    """
    cdef shared_ptr[_SignalToNoiseEstimatorMedian[_MSSpectrum]] inst
...
cdef class SiriusMSFile:
    ...
    """
    cdef shared_ptr[_SiriusMSFile] inst
...
cdef class SiriusMSFile_AccessionInfo:
    ...
    """
    cdef shared_ptr[_SiriusMSFile_AccessionInfo] inst
...
cdef class SiriusMSFile_CompoundInfo:
    ...
    """
    cdef shared_ptr[_SiriusMSFile_CompoundInfo] inst
...
cdef class SpectrumAccessOpenMSCached:
    ...
    """
    cdef shared_ptr[_SpectrumAccessOpenMSCached] inst
