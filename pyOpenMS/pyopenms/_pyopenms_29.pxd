...
cdef class BSpline2d:
    ...
    """
    cdef shared_ptr[_BSpline2d] inst
...
cdef class CVReference:
    ...
    """
    cdef shared_ptr[_CVReference] inst
...
cdef class ExperimentalDesign:
    ...
    """
    cdef shared_ptr[_ExperimentalDesign] inst
...
cdef class ExperimentalDesign_MSFileSectionEntry:
    ...
    """
    cdef shared_ptr[_ExperimentalDesign_MSFileSectionEntry] inst
...
cdef class ExperimentalDesign_SampleSection:
    ...
    """
    cdef shared_ptr[_ExperimentalDesign_SampleSection] inst
...
cdef class IMSIsotopeDistribution:
    ...
    """
    cdef shared_ptr[_IMSIsotopeDistribution] inst
...
cdef class IMSIsotopeDistribution_Peak:
    ...
    """
    cdef shared_ptr[_IMSIsotopeDistribution_Peak] inst
...
cdef class LinearInterpolation:
    ...
    """
    cdef shared_ptr[_LinearInterpolation[double,double]] inst
...
cdef class LinearResamplerAlign:
    ...
    """
    cdef shared_ptr[_LinearResamplerAlign] inst
...
cdef class MRMFeatureFinderScoring:
    ...
    """
    cdef shared_ptr[_MRMFeatureFinderScoring] inst
...
cdef class MZTrafoModel:
    ...
    """
    cdef shared_ptr[_MZTrafoModel] inst
...
cdef class MascotXMLFile:
    ...
    """
    cdef shared_ptr[_MascotXMLFile] inst
...
cdef class PeptideHit_AnalysisResult:
    ...
    """
    cdef shared_ptr[_PeptideHit_AnalysisResult] inst
...
cdef class PeptideHit_PeakAnnotation:
    ...
    """
    cdef shared_ptr[_PeptideHit_PeakAnnotation] inst
...
cdef class RANSAC:
    ...
    """
    cdef shared_ptr[_RANSAC[_RansacModelLinear]] inst
...
cdef class RANSACParam:
    ...
    """
    cdef shared_ptr[_RANSACParam] inst
...
cdef class RANSACQuadratic:
    ...
    """
    cdef shared_ptr[_RANSAC[_RansacModelQuadratic]] inst
