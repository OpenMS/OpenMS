...
cdef class CVMappings:
    ...
    """
    cdef shared_ptr[_CVMappings] inst
...
cdef class ChargePair:
    ...
    """
    cdef shared_ptr[_ChargePair] inst
...
cdef class MRMFeatureQCFile:
    ...
    """
    cdef shared_ptr[_MRMFeatureQCFile] inst
...
cdef class MultiplexIsotopicPeakPattern:
    ...
    """
    cdef shared_ptr[_MultiplexIsotopicPeakPattern] inst
...
cdef class NASequence:
    ...
    """
    cdef shared_ptr[_NASequence] inst
...
cdef class PeptideProteinResolution:
    ...
    groups to output
    """
    cdef shared_ptr[_PeptideProteinResolution] inst
...
cdef class PeptideProteinResolution_ConnectedComponent:
    ...
    """
    cdef shared_ptr[_PeptideProteinResolution_ConnectedComponent] inst
...
cdef class PercolatorOutfile:
    ...
    """
    cdef shared_ptr[_PercolatorOutfile] inst
...
cdef class QcMLFile:
    ...
    """
    cdef shared_ptr[_QcMLFile] inst
...
cdef class QualityParameter:
    ...
    """
    cdef shared_ptr[_QualityParameter] inst
...
cdef class SiriusFragmentAnnotation:
    ...
    """
    cdef shared_ptr[_SiriusFragmentAnnotation] inst
...
cdef class SiriusFragmentAnnotation_SiriusTargetDecoySpectra:
    ...
    """
    cdef shared_ptr[_SiriusFragmentAnnotation_SiriusTargetDecoySpectra] inst
...
cdef class SplinePackage:
    ...
    """
    cdef shared_ptr[_SplinePackage] inst
...
cdef class _Interfaces_BinaryDataArray:
    ...
    """
    cdef shared_ptr[_BinaryDataArray] inst
...
cdef class _Interfaces_Chromatogram:
    ...
    """
    cdef shared_ptr[_Chromatogram] inst
...
cdef class _Interfaces_Spectrum:
    ...
    """
    cdef shared_ptr[_Spectrum] inst
