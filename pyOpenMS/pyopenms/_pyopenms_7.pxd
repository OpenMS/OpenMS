...
cdef class BiGaussModel:
    ...
    """
    cdef shared_ptr[_BiGaussModel] inst
...
cdef class EmgFitter1D:
    ...
    """
    cdef shared_ptr[_EmgFitter1D] inst
...
cdef class GridBasedCluster:
    ...
    """
    cdef shared_ptr[_GridBasedCluster] inst
...
cdef class IDConflictResolverAlgorithm:
    ...
    """
    cdef shared_ptr[_IDConflictResolverAlgorithm] inst
...
cdef class MSExperiment:
    ...
    Usage:
    """
    cdef shared_ptr[_MSExperiment] inst
...
cdef class OSW_ChromExtractParams:
    ...
    """
    cdef shared_ptr[_OSW_ChromExtractParams] inst
...
cdef class OpenSwathOSWWriter:
    ...
    """
    cdef shared_ptr[_OpenSwathOSWWriter] inst
...
cdef class SequestInfile:
    ...
    """
    cdef shared_ptr[_SequestInfile] inst
...
cdef class TMTTenPlexQuantitationMethod:
    ...
    """
    cdef shared_ptr[_TMTTenPlexQuantitationMethod] inst
...
cdef class TheoreticalSpectrumGeneratorXLMS:
    ...
    """
    cdef shared_ptr[_TheoreticalSpectrumGeneratorXLMS] inst
