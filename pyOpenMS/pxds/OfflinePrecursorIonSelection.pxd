...
cdef extern from "<OpenMS/ANALYSIS/TARGETED/OfflinePrecursorIonSelection.h>" namespace "OpenMS":
    ...
    cdef cppclass OfflinePrecursorIonSelection(DefaultParamHandler) :
        ...
        # TEMPLATE # void getMassRanges(FeatureMap[Feature] & features, MSExperiment[ Peak1D, ChromatogramPeak ] & experiment, libcpp_vector[ libcpp_vector[ libcpp_pair[ Size, Size ] ] ] & indices) nogil except +
