...
cdef extern from "<OpenMS/ANALYSIS/TARGETED/PrecursorIonSelection.h>" namespace "OpenMS":
    ...
    cdef cppclass PrecursorIonSelection(DefaultParamHandler) :
        ...
        # NAMESPACE # void getNextPrecursors(libcpp_vector[ int ] & solution_indices, libcpp_vector[ PSLPFormulation::IndexTriple ] & variable_indices, libcpp_set[ int ] & measured_variables, FeatureMap[Feature] & features, FeatureMap[Feature] & new_features, UInt step_size, PSLPFormulation & ilp) nogil except +
        ...
        # NAMESPACE # void setLPSolver(LPWrapper::SOLVER solver) nogil except +
        # NAMESPACE # LPWrapper::SOLVER getLPSolver() nogil except +
        void reset() nogil except +
        # TODO nested STL # libcpp_map[ String, libcpp_set[ String ] ]  getPeptideProteinCounter() nogil except +
